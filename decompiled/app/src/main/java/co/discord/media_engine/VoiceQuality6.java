...
public final /* data */ class VoiceQuality6 {
    ...
    public int hashCode() {
        return (C0002b.m3a(this.packetsSent) * 31) + this.packetsLost;
    }

    public String toString() {
        StringBuilder sbM833U = outline.m833U("OutboundAudio(packetsSent=");
        sbM833U.append(this.packetsSent);
        sbM833U.append(", packetsLost=");
        return outline.m814B(sbM833U, this.packetsLost, ")");
    }
}
