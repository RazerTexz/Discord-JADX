...
public final class CurrentFrame2 extends Frame3 {
    ...
    public void mo10569b(int i, int i2, Symbol2 symbol2, SymbolTable2 symbolTable2) {
        ...
        m10578h(symbolTable2, frame3, 0);
        this.f26229b = frame3.f26229b;
        this.f26230c = frame3.f26230c;
        this.f26233f = (short) 0;
        this.f26231d = frame3.f26231d;
        this.f26232e = frame3.f26232e;
        this.f26234g = frame3.f26234g;
        this.f26235h = frame3.f26235h;
        this.f26236i = frame3.f26236i;
    }
}
