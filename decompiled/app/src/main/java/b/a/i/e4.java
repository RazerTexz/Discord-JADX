...
public final class e4 implements ViewBinding {
    ...
    public e4(@NonNull LinearLayout linearLayout, @NonNull ImageView imageView, @NonNull TextView textView, @NonNull TextView textView2, @NonNull LinearLayout linearLayout2) {
        this.a = linearLayout;
        ...
        if (imageView != null) {
            ...
            if (textView != null) {
                ...
                if (textView2 != null) {
                    ...
                    return new e4(linearLayout, imageView, textView, textView2, linearLayout);
                }
            }
        }
