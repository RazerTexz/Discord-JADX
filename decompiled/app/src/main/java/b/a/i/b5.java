...
public final class b5 implements ViewBinding {
    ...
    public b5(@NonNull SelectComponentView selectComponentView, @NonNull ImageView imageView, @NonNull TypingDots typingDots, @NonNull SimpleDraweeView simpleDraweeView, @NonNull MaterialTextView materialTextView, @NonNull FlexboxLayout flexboxLayout) {
                ...
                if (simpleDraweeView != null) {
                    ...
                    if (materialTextView != null) {
                        ...
                        if (flexboxLayout != null) {
                            return new b5((SelectComponentView) view, imageView, typingDots, simpleDraweeView, materialTextView, flexboxLayout);
                        }
                    }
                }
            }
