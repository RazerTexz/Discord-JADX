...
public final class b1 implements ViewBinding {
    ...
    public b1(@NonNull CardView cardView, @NonNull ImageView imageView, @NonNull CardView cardView2, @NonNull TextView textView, @NonNull TextInputLayout textInputLayout, @NonNull RecyclerView recyclerView, @NonNull TextView textView2) {
        this.a = cardView;
        this.f82b = imageView;
        this.c = cardView2;
        this.d = textView;
    ...
    @NonNull
    public static b1 a(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z2) {
            ...
            if (textView != null) {
                ...
                if (textInputLayout != null) {
                    ...
                    if (recyclerView != null) {
                        ...
                        if (textView2 != null) {
                            return new b1(cardView, imageView, cardView, textView, textInputLayout, recyclerView, textView2);
                        }
                    }
                }
            }
