...
public final class a extends FrameLayout implements f {
    ...
    public a(Context context) throws Resources.NotFoundException {
        super(context);
        ...
        if (imageView != null) {
            ...
            if (frameLayout != null) {
                ...
                if (frameLayout2 != null) {
                    ...
                    animatorSet.addListener(new C0037a());
                    this.l = animatorSet;
    ...
    public void a(OverlayBubbleWrap overlayBubbleWrap) {
        if (overlayBubbleWrap != null) {
            ...
            m.checkNotNullExpressionValue(this.j.c, "binding.trashWrapTargetContainer");
