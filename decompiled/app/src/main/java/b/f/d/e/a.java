...
public class a {
    ...
    public static void b(Class<?> cls, String str, Throwable th) {
        String strY = b.d.b.a.a.y(EnvironmentCompat.MEDIA_UNKNOWN, ":", cls.getSimpleName());
    ...
    public static void d(Class<?> cls, Throwable th, String str, Object... objArr) {
        ...
        String strY = b.d.b.a.a.y(EnvironmentCompat.MEDIA_UNKNOWN, ":", simpleName);
        StringBuilder sb = new StringBuilder();
        sb.append(strG);
        sb.append('\n');
        StringWriter stringWriter = new StringWriter();
    ...
    public static void f(String str, String str2, Throwable th) {
        String string;
        String strY = b.d.b.a.a.y(EnvironmentCompat.MEDIA_UNKNOWN, ":", str);
        StringBuilder sb = new StringBuilder();
        sb.append(str2);
        sb.append('\n');
        if (th == null) {
