...
public class d {
    ...
    public static void J(long j, b.i.a.c.f3.x xVar, b.i.a.c.x2.w[] wVarArr) {
        while (true) {
            ...
            int iI1 = I1(xVar);
            int iI12 = I1(xVar);
            int i = xVar.f984b + iI12;
            if (iI12 == -1 || iI12 > xVar.a()) {
    ...
    public static long K1(b.i.a.c.f3.x xVar, int i, int i2) {
        ...
        if (((iF & 32) != 0) && xVar.t() >= 7 && xVar.a() >= 7) {
            if ((xVar.t() & 16) == 16) {
                System.arraycopy(xVar.a, xVar.f984b, new byte[6], 0, 6);
                xVar.f984b += 6;
    ...
    */
    ...
    public static void O1(b.C0093b c0093b) {
        c0093b.k = -3.4028235E38f;
        c0093b.j = Integer.MIN_VALUE;
        CharSequence charSequence = c0093b.a;
        if (charSequence instanceof Spanned) {
            if (!(charSequence instanceof Spannable)) {
                c0093b.a = SpannableString.valueOf(charSequence);
            }
            CharSequence charSequence2 = c0093b.a;
    ...
    public static boolean S0(int i, int i2, b.f.j.d.e eVar) {
        return eVar == null ? ((float) o0(i)) >= 2048.0f && o0(i2) >= 2048 : o0(i) >= eVar.a && o0(i2) >= eVar.f566b;
    }
    ...
    public static <TInput, TResult, TException extends Throwable> TResult V1(int i, TInput tinput, b.i.a.b.i.b<TInput, TResult, TException> bVar, b.i.a.b.j.s.a<TInput, TResult> aVar) throws Throwable {
        ...
        do {
            ...
            if (url != null) {
                ...
                tinput = (TInput) new d.a(bVar2.f746b, aVar2.f745b, aVar2.c);
            } else {
                tinput = 0;
            }
            if (tinput == 0) {
                                ...
                                if (i6 < iF4) {
                                    ...
                                    while (i12 < iG2) {
                                        ...
                                        if (iG5 <= 128000) {
                                            ...
                                            bVarArr[i12] = new h.b(iG3, fArr3, fArr4, iG4);
                                            i12++;
                                            i3 = i;
                                            iG2 = iG2;
                                            i11 = 32;
