...
public final class d extends c {
        ...
        do {
            ...
            if (I == 3) {
                ...
                if (I == 4) {
                    i--;
                    if (i < 0) {
                        StringBuilder sbU = b.d.b.a.a.U("Expected a value but was ");
                        sbU.append(u());
                        sbU.append(" at path ");
                        sbU.append(getPath());
                        throw new a(sbU.toString());
                    ...
                    i--;
                    if (i < 0) {
                        StringBuilder sbU2 = b.d.b.a.a.U("Expected a value but was ");
                        sbU2.append(u());
                        sbU2.append(" at path ");
                        sbU2.append(getPath());
                        throw new a(sbU2.toString());
                    }
                    this.k--;
                } else if (I == 14 || I == 10) {
                    U();
                    ...
                    StringBuilder sbU3 = b.d.b.a.a.U("Expected a value but was ");
                    sbU3.append(u());
                    sbU3.append(" at path ");
                    sbU3.append(getPath());
                    throw new a(sbU3.toString());
                }
                this.v = 0;
            }
            i++;
    ...
    */
    ...
    public final char S() throws IOException {
        ...
        if (b2 != 117) {
            StringBuilder sbU = b.d.b.a.a.U("Invalid escape sequence: \\");
            sbU.append((char) b2);
            D(sbU.toString());
            throw null;
        }
        if (!this.t.j(4L)) {
            StringBuilder sbU2 = b.d.b.a.a.U("Unterminated escape sequence at path ");
            sbU2.append(getPath());
        ...
        for (int i3 = 0; i3 < 4; i3++) {
            ...
            if (bQ < 48 || bQ > 57) {
                if (bQ >= 97 && bQ <= 102) {
                    ...
                    if (bQ < 65 || bQ > 70) {
                        StringBuilder sbU3 = b.d.b.a.a.U("\\u");
    ...
    public double n() throws IOException {
        ...
        try {
            ...
            StringBuilder sbU2 = b.d.b.a.a.U("Expected a double but was ");
    ...
    public int q() throws IOException {
        ...
        try {
            ...
            StringBuilder sbU4 = b.d.b.a.a.U("Expected an int but was ");
            sbU4.append(this.f337y);
            sbU4.append(" at path ");
            sbU4.append(getPath());
            throw new a(sbU4.toString());
        }
    }
    ...
    public String toString() {
        StringBuilder sbU = b.d.b.a.a.U("JsonReader(");
        sbU.append(this.t);
        sbU.append(")");
        return sbU.toString();
    }
