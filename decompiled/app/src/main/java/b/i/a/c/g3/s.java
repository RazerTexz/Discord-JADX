...
public final class s extends GLSurfaceView implements t {
    ...
    public static final class a implements GLSurfaceView.Renderer {
        ...
        public final AtomicReference<b.i.a.c.v2.i> t = new AtomicReference<>();
        public final FloatBuffer[] u = new FloatBuffer[3];
        public GlUtil.a v;
        public int w;

        /* renamed from: x, reason: collision with root package name */
        public b.i.a.c.v2.i f992x;
        ...
        public void onDrawFrame(GL10 gl10) {
            b.i.a.c.v2.i andSet = this.t.getAndSet(null);
            if (andSet == null && this.f992x == null) {
                return;
            }
            if (andSet != null) {
                b.i.a.c.v2.i iVar = this.f992x;
                if (iVar != null) {
