...
public final class x {
    ...
    public void D(int i) {
        b.c.a.a0.d.j(i >= 0 && i <= this.a.length);
        this.c = i;
    }

    public void E(int i) {
        b.c.a.a0.d.j(i >= 0 && i <= this.c);
        this.f984b = i;
    }
    ...
    public String g() {
        ...
        byte[] bArr2 = this.a;
        int i4 = this.f984b;
        String strM = e0.m(bArr2, i4, i - i4);
        this.f984b = i;
        int i5 = this.c;
        if (i == i5) {
            return strM;
    ...
    public int k() {
        ...
        throw new IllegalStateException(b.d.b.a.a.g(29, "Top bit not zero: ", iH));
    }
    ...
    public String o(int i) {
        ...
        int i2 = this.f984b;
        int i3 = (i2 + i) - 1;
        String strM = e0.m(this.a, i2, (i3 >= this.c || this.a[i3] != 0) ? i : i - 1);
        this.f984b += i;
        return strM;
    }
    ...
    public int w() {
        ...
        throw new IllegalStateException(b.d.b.a.a.g(29, "Top bit not zero: ", iF));
    }
