...
public final class c extends e {
    ...
    public static final class a {
        ...
        public static class C0094a {
            ...
            public C0094a(int i, boolean z2, int i2) {
                this.a = i;
                this.f852b = z2;
                this.c = i2;
            }
        ...
        public b.i.a.c.b3.b c(int i) {
            ...
            return new b.i.a.c.b3.b(spannableStringBuilder, Layout.Alignment.ALIGN_NORMAL, null, null, i9, 1, Integer.MIN_VALUE, f, i8, Integer.MIN_VALUE, -3.4028235E38f, -3.4028235E38f, -3.4028235E38f, false, ViewCompat.MEASURED_STATE_MASK, Integer.MIN_VALUE, 0.0f, null);
        }
                                                ...
                                                if (i5 == 17 && (b3 & 240) == 48) {
                                                    ...
                                                    if (i6 == 18 && (b3 & 224) == 32) {
                                                        ...
                                                        if (i5 == 17 && (b3 & 240) == 32) {
                                                            ...
                                                            boolean z6 = (b3 & 1) == 1;
                                                            a aVar = this.u;
                                                            aVar.a.add(new a.C0094a((b3 >> 1) & 7, z6, aVar.c.length()));
                                                        } else {
                                                            if ((b2 & 240) == 16 && (b3 & 192) == 64) {
                                                                ...
                                                                int i8 = (b3 >> 1) & 7;
                                                                a aVar4 = this.u;
                                                                aVar4.a.add(new a.C0094a(z7 ? 8 : i8, z8, aVar4.c.length()));
                                                                if (z7) {
                                                                    this.u.e = h[i8];
                                                                }
                                                            } else {
