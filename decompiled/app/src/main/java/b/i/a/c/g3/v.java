    ...
    */
    public v(@Nullable Context context) {
        ...
        if (context != null) {
            ...
            dVar = (e0.a < 17 || (displayManager = (DisplayManager) applicationContext.getSystemService("display")) == null) ? null : new d(displayManager);
            if (dVar == null) {
    ...
    */
    public final void c() {
        ...
        if (this.a.a()) {
            p pVar = this.a;
            if (pVar.a()) {
                f = (float) (1.0E9d / (pVar.a.e != 0 ? r0.f / r5 : 0L));
            } else {
                f = -1.0f;
            }
        } else {
        ...
        if (f == -1.0f || f2 == -1.0f) {
            ...
            p pVar2 = this.a;
            boolean z3 = (pVar2.a() ? pVar2.a.f : -9223372036854775807L) >= 5000000000L;
