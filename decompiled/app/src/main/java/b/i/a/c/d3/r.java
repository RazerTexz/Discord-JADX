...
public final class r extends FrameLayout implements SubtitleView.a {
    ...
    */
    public final void e() {
        ...
        k kVar = rVar.m;
        int i6 = kVar.e;
        objArr[3] = i6 != 1 ? i6 != 2 ? i6 != 3 ? i6 != 4 ? "unset" : e0.k("-0.05em -0.05em 0.15em %s", b.c.a.a0.d.f2(kVar.f)) : e0.k("0.06em 0.08em 0.15em %s", b.c.a.a0.d.f2(kVar.f)) : e0.k("0.1em 0.12em 0.15em %s", b.c.a.a0.d.f2(kVar.f)) : e0.k("1px 1px 0 %1$s, 1px -1px 0 %1$s, -1px 1px 0 %1$s, -1px -1px 0 %1$s", b.c.a.a0.d.f2(kVar.f));
        ...
        while (i7 < rVar.l.size()) {
            b.i.a.c.b3.b bVar2 = rVar.l.get(i7);
            float f4 = bVar2.f838s;
            ...
            if (f6 == -3.4028235E38f) {
                ...
                strK = e0.k("%.2f%%", objArr2);
                c2 = 0;
                iB = -100;
            } else if (bVar2.q != i5) {
                Object[] objArr3 = new Object[i5];
                objArr3[c2] = Float.valueOf(f6 * 100.0f);
                strK = e0.k("%.2f%%", objArr3);
                c = 0;
                iB = bVar2.A == i5 ? -b(bVar2.r) : b(bVar2.r);
            } else {
                if (f6 >= 0.0f) {
            ...
            if (f7 != -3.4028235E38f) {
                ...
                strK2 = e0.k("%.2f%%", objArr6);
            } else {
                i = iB2;
                strK2 = "fit-content";
            }
            String strC = c(bVar2.m);
            int i8 = bVar2.A;
            String str19 = i8 != i5 ? i8 != 2 ? "horizontal-tb" : "vertical-lr" : "vertical-rl";
            String strD = rVar.d(bVar2.f840y, bVar2.f841z);
            String strF2 = b.c.a.a0.d.f2(bVar2.w ? bVar2.f839x : rVar.m.d);
            int i9 = bVar2.A;
            String str20 = "right";
            String str21 = "left";
            String str22 = str17;
            ...
            if (charSequence == null) {
                ...
                for (Iterator it = hashSet.iterator(); it.hasNext(); it = it) {
                    ...
                    map2.put(b.c.a.a0.d.W(sb3.toString()), e0.k(str18, b.c.a.a0.d.f2(iIntValue)));
                }
                ...
                while (i12 < length2) {
                    ...
                    if (z2) {
                        ...
                        if (obj instanceof ForegroundColorSpan) {
                            str12 = strC;
                            strK3 = e0.k("<span style='color:%s;'>", b.c.a.a0.d.f2(((ForegroundColorSpan) obj).getForegroundColor()));
                        } else {
                            str12 = strC;
                            if (obj instanceof BackgroundColorSpan) {
                                strK3 = e0.k("<span class='bg_%s'>", Integer.valueOf(((BackgroundColorSpan) obj).getBackgroundColor()));
                            } else if (obj instanceof b.i.a.c.b3.q.a) {
                                strK3 = "<span style='text-combine-upright:all;'>";
                            } else if (obj instanceof AbsoluteSizeSpan) {
                                strK3 = e0.k("<span style='font-size:%.2fpx;'>", Float.valueOf(((AbsoluteSizeSpan) obj).getDip() ? r6.getSize() : r6.getSize() / f8));
                            } else {
                                if (obj instanceof RelativeSizeSpan) {
                                    strK3 = e0.k("<span style='font-size:%.2f%%;'>", Float.valueOf(((RelativeSizeSpan) obj).getSizeChange() * 100.0f));
                                } else if (obj instanceof TypefaceSpan) {
                                    String family = ((TypefaceSpan) obj).getFamily();
                                    strK3 = family != null ? e0.k("<span style='font-family:\"%s\";'>", family) : null;
                                    ...
                                    int i14 = ((b.i.a.c.b3.q.c) obj).f872b;
                                    if (i14 == -1) {
                                    ...
                                    strK3 = e0.k("<span style='-webkit-text-emphasis-style:%1$s;text-emphasis-style:%1$s;-webkit-text-emphasis-position:%2$s;text-emphasis-position:%2$s;display:inline-block;'>", sb4.toString(), dVar.c != 2 ? "over right" : "under left");
                                } else {
                                    str14 = str2;
                                    f = f8;
                                    str13 = strK2;
                    ...
                    String str23 = strK3;
                    if (z2 || (obj instanceof ForegroundColorSpan) || (obj instanceof BackgroundColorSpan) || (obj instanceof b.i.a.c.b3.q.a) || (obj instanceof AbsoluteSizeSpan) || (obj instanceof RelativeSizeSpan) || (obj instanceof b.i.a.c.b3.q.d)) {
                        str15 = "</span>";
                    } else {
                        if (!(obj instanceof TypefaceSpan)) {
                            if (obj instanceof StyleSpan) {
                                ...
                                if (obj instanceof b.i.a.c.b3.q.c) {
                                    String strA = m.a(((b.i.a.c.b3.q.c) obj).a);
                                    strK4 = b.d.b.a.a.k(b.d.b.a.a.b(strA, 16), "<rt>", strA, "</rt></ruby>");
                                } else if (obj instanceof UnderlineSpan) {
                                    strK4 = "</u>";
                                }
                                str15 = strK4;
                    ...
                    if (str23 != null) {
                        ...
                        m.c cVar = new m.c(spanStart, spanEnd, str23, str15, null);
                        m.d dVar2 = (m.d) sparseArray.get(spanStart);
                        if (dVar2 == null) {
                            dVar2 = new m.d();
                            sparseArray.put(spanStart, dVar2);
                        }
                        dVar2.a.add(cVar);
                        m.d dVar3 = (m.d) sparseArray.get(spanEnd);
                        if (dVar3 == null) {
                            dVar3 = new m.d();
                            sparseArray.put(spanEnd, dVar3);
                        }
                        dVar3.f917b.add(cVar);
                    }
                    i12++;
                    length2 = i13;
                    spans = objArr7;
                ...
                while (i17 < sparseArray.size()) {
                    ...
                    sb5.append(m.a(spanned.subSequence(i18, iKeyAt)));
                    m.d dVar4 = (m.d) sparseArray.get(iKeyAt);
                    Collections.sort(dVar4.f917b, f.j);
                    Iterator<m.c> it2 = dVar4.f917b.iterator();
                    while (it2.hasNext()) {
                        sb5.append(it2.next().d);
                    }
                    Collections.sort(dVar4.a, e.j);
                    Iterator<m.c> it3 = dVar4.a.iterator();
                    while (it3.hasNext()) {
                ...
                sb5.append(m.a(spanned.subSequence(i18, spanned.length())));
                bVar = new m.b(sb5.toString(), map2, null);
                for (String str24 : map.keySet()) {
                    String str25 = (String) map.put(str24, (String) map.get(str24));
                    b.c.a.a0.d.D(str25 == null || str25.equals(map.get(str24)));
                }
                ...
                if (f2 == 0.0f) {
                    int i19 = bVar2.A;
                    i4 = 1;
                    strK5 = e0.k("%s(%.2fdeg)", (i19 == 2 || i19 == 1) ? "skewY" : "skewX", Float.valueOf(f2));
                } else {
                    i4 = 1;
                    strK5 = str3;
                }
                ...
                str3 = "";
                bVar = new m.b(m.a(charSequence), i0.m, null);
            }
            str7 = str2;
            str8 = str19;
            str6 = str18;
            ...
            objArr82[13] = strK5;
            sb = sb2;
            sb.append(e0.k("<div style='position:absolute;z-index:%s;%s:%.2f%%;%s:%s;%s:%s;text-align:%s;writing-mode:%s;font-size:%s;background-color:%s;transform:translate(%s%%,%s%%)%s;'>", objArr82));
            Object[] objArr92 = new Object[i4];
            objArr92[0] = str22;
            sb.append(e0.k("<span class='%s'>", objArr92));
            alignment = bVar2.n;
            if (alignment == null) {
            }
            sb.append(str16);
