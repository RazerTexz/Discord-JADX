...
public final class a extends f {
    ...
    */
    public g j(byte[] bArr, int i, boolean z2) {
                ...
                if (strG2.length() != 0) {
                    ...
                    if (strG == null) {
                        ...
                        if (matcher.matches()) {
                            ...
                            aVar.p.setLength(i3);
                            aVar.q.clear();
                            for (String strG3 = xVar3.g(); !TextUtils.isEmpty(strG3); strG3 = xVar3.g()) {
                                if (aVar.p.length() > 0) {
                                    aVar.p.append("<br>");
                                }
                            ...
                            Spanned spannedFromHtml = Html.fromHtml(aVar.p.toString());
                            String str = null;
                            int i8 = 0;
                            while (true) {
                                if (i8 < aVar.q.size()) {
                            ...
                            if (str == null) {
                                ...
                                bVar = new b.i.a.c.b3.b(spannedFromHtml, null, null, null, k(i10), 0, i10, k(i9), i9, Integer.MIN_VALUE, -3.4028235E38f, -3.4028235E38f, -3.4028235E38f, false, ViewCompat.MEASURED_STATE_MASK, Integer.MIN_VALUE, 0.0f, null);
                            }
                            arrayList.add(bVar);
        ...
        return new b((b.i.a.c.b3.b[]) arrayList.toArray(new b.i.a.c.b3.b[0]), Arrays.copyOf(jArrCopyOf, i4));
    }
}
