...
public final class e0 {
    ...
    static {
        ...
        d = str3;
        StringBuilder sbS = b.d.b.a.a.S(b.d.b.a.a.b(str2, b.d.b.a.a.b(str3, b.d.b.a.a.b(str, 17))), str, ", ", str3, ", ");
        sbS.append(str2);
        sbS.append(", ");
        sbS.append(i2);
        e = sbS.toString();
    ...
    public static int c(r rVar, long j2, boolean z2, boolean z3) {
        int i2;
        int i3 = rVar.a - 1;
        int i4 = 0;
        while (i4 <= i3) {
        ...
        if (z2 && (i2 = i3 + 1) < rVar.a && rVar.b(i2) == j2) {
            return i2;
        }
        if (z3 && i3 == -1) {
            return 0;
    ...
    public static String l(byte[] bArr) {
        return new String(bArr, b.i.b.a.c.c);
    }

    public static String m(byte[] bArr, int i2, int i3) {
        return new String(bArr, i2, i3, b.i.b.a.c.c);
    }
    ...
    public static String v(String str) {
        try {
            ...
            q.b("Util", str.length() != 0 ? "Failed to read system property ".concat(str) : new String("Failed to read system property "), e2);
            return null;
        }
    }

    public static byte[] w(String str) {
        return str.getBytes(b.i.b.a.c.c);
    }

    public static boolean x(x xVar, x xVar2, @Nullable Inflater inflater) {
        if (xVar.a() <= 0) {
            return false;
        }
        if (xVar2.a.length < xVar.a()) {
            xVar2.b(xVar.a() * 2);
        }
        if (inflater == null) {
            inflater = new Inflater();
        }
        inflater.setInput(xVar.a, xVar.f984b, xVar.a());
        int iInflate = 0;
        while (true) {
            try {
                byte[] bArr = xVar2.a;
