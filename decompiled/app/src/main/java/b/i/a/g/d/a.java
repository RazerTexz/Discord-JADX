...
public final class a {
    ...
    public a(ColorStateList colorStateList, ColorStateList colorStateList2, ColorStateList colorStateList3, int i, ShapeAppearanceModel shapeAppearanceModel, @NonNull Rect rect) {
    ...
    @NonNull
    public static a a(@NonNull Context context, @StyleRes int i) throws Resources.NotFoundException {
        ...
        return new a(colorStateList, colorStateList2, colorStateList3, dimensionPixelSize, shapeAppearanceModelBuild, rect);
    }
