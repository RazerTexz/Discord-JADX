...
public final class s extends h {
    ...
    */
    public static s g(File file, long j, long j2, j jVar) throws NumberFormatException {
        File file2;
        long j3;
        String strGroup;
        File fileH;
        ...
        if (name.endsWith(".v3.exo")) {
            ...
            if (matcher.matches()) {
                ...
                if (i2 != 0) {
                    ...
                    Matcher matcher2 = e0.g.matcher(strGroup);
                ...
                if (strGroup != null) {
                    ...
                    b.c.a.a0.d.H(parentFile);
                    int i5 = jVar.d(strGroup).a;
        ...
        String str = jVar.f932b.get(Integer.parseInt(strGroup5));
        if (str == null) {
            return null;
        }
        ...
        return new s(str, j5, length2, j3, file2);
    }
