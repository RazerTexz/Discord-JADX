...
public final class b extends g {
    ...
    public static final class C0106b {
        ...
        public C0106b(int i, boolean z2, int i2) {
            this.a = i;
            this.f1325b = z2;
            this.c = i2;
        }
    ...
    public static ChapterFrame g(x xVar, int i, int i2, boolean z2, int i3, @Nullable a aVar) throws UnsupportedEncodingException {
        ...
        int i5 = i4 + i;
        while (xVar.f984b < i5) {
            Id3Frame id3FrameJ = j(i2, xVar, z2, i3, aVar);
            if (id3FrameJ != null) {
    ...
    */
    public static Id3Frame j(int i, x xVar, boolean z2, int i2, @Nullable a aVar) {
        int iW;
        String str;
        int i3;
        int i4;
        ...
        try {
            try {
                if (iT == 84 && iT2 == 88 && iT3 == 88 && (i == 2 || iT4 == 88)) {
                    ...
                    id3FrameI = o(xVar, iX, u(i, iT, iT2, iT3, iT4));
                } else if (iT == 87 && iT2 == 88 && iT3 == 88 && (i == 2 || iT4 == 88)) {
                    id3FrameI = r(xVar, iX);
                } else if (iT == 87) {
                    id3FrameI = q(xVar, iX, u(i, iT, iT2, iT3, iT4));
                    ...
                    if (iT == 80 && iT2 == 73 && iT3 == 67) {
                        id3FrameI = e(xVar, iX, i);
                    }
                    id3FrameI = (iT != 67 && iT2 == 79 && iT3 == 77 && (iT4 == 77 || i == 2)) ? i(xVar, iX) : (iT != 67 && iT2 == 72 && iT3 == 65 && iT4 == 80) ? g(xVar, iX, i, z2, i2, aVar) : (iT != 67 && iT2 == 84 && iT3 == 79 && iT4 == 67) ? h(xVar, iX, i, z2, i2, aVar) : (iT != 77 && iT2 == 76 && iT3 == 76 && iT4 == 84) ? l(xVar, iX) : f(xVar, iX, u(i, iT, iT2, iT3, iT4));
        ...
        if (xVar.a() < 10) {
            ...
            if (iV == 4801587) {
                ...
                if (iT == 2) {
                    ...
                    c0106b = new C0106b(iT, iT >= 4 && (iT2 & 128) != 0, iS);
                } else {
                    if (iT == 3) {
                        if ((iT2 & 64) != 0) {
                            int iF = xVar.f();
                ...
                int i2 = xVar.f984b;
                int i3 = c0106b.a == 2 ? 6 : 10;
                int iX = c0106b.c;
                if (c0106b.f1325b) {
                    iX = x(xVar, iX);
                }
                xVar.D(i2 + iX);
                if (!y(xVar, c0106b.a, i3, false)) {
                    if (c0106b.a != 4 || !y(xVar, 4, i3, true)) {
                        b.d.b.a.a.g0(56, "Failed to validate ID3 tag with majorVersion=", c0106b.a, "Id3Decoder");
                        return null;
                    }
                    z2 = true;
                }
                while (xVar.a() >= i3) {
                    Id3Frame id3FrameJ = j(c0106b.a, xVar, z2, i3, this.f1324b);
                    if (id3FrameJ != null) {
                        arrayList.add(id3FrameJ);
                    }
                }
