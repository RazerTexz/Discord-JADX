...
public abstract class b implements j {
    ...
    public class a extends Property<ExtendedFloatingActionButton, Float> {
        ...
        public Float get(ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            return Float.valueOf(AnimationUtils.lerp(0.0f, 1.0f, (Color.alpha(extendedFloatingActionButton2.getCurrentTextColor()) / 255.0f) / Color.alpha(extendedFloatingActionButton2.originalTextCsl.getColorForState(extendedFloatingActionButton2.getDrawableState(), b.this.f1611b.originalTextCsl.getDefaultColor()))));
        }
        ...
        public void set(ExtendedFloatingActionButton extendedFloatingActionButton, Float f) {
            ExtendedFloatingActionButton extendedFloatingActionButton2 = extendedFloatingActionButton;
            Float f2 = f;
            int colorForState = extendedFloatingActionButton2.originalTextCsl.getColorForState(extendedFloatingActionButton2.getDrawableState(), b.this.f1611b.originalTextCsl.getDefaultColor());
    ...
    public b(@NonNull ExtendedFloatingActionButton extendedFloatingActionButton, b.i.a.g.e.a aVar) {
