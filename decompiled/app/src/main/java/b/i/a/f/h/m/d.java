    ...
    public final zzgp createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < iM2) {
            ...
            if (c != 1) {
                switch (c) {
                    case 4:
                        parcelUuid = (ParcelUuid) b.c.a.a0.d.Q(parcel, i, ParcelUuid.CREATOR);
                        break;
                    case 5:
                        parcelUuid2 = (ParcelUuid) b.c.a.a0.d.Q(parcel, i, ParcelUuid.CREATOR);
                        break;
                    case 6:
                        parcelUuid3 = (ParcelUuid) b.c.a.a0.d.Q(parcel, i, ParcelUuid.CREATOR);
                        break;
                    case 7:
                        bArrN = b.c.a.a0.d.N(parcel, i);
                        break;
                    case '\b':
                        bArrN2 = b.c.a.a0.d.N(parcel, i);
                        break;
                    case '\t':
                        iG12 = b.c.a.a0.d.G1(parcel, i);
                        break;
                    case '\n':
                        bArrN3 = b.c.a.a0.d.N(parcel, i);
                        break;
                    case 11:
                        bArrN4 = b.c.a.a0.d.N(parcel, i);
                        break;
                    default:
