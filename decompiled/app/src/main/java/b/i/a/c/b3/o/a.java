...
public final class a extends f {
    ...
    public a(List<byte[]> list) {
        ...
        int i4 = i2 + 1;
        this.n = new b(i3, (bArr[i4] & 255) | ((bArr[i2] & 255) << 8));
    }
    ...
    public b.i.a.c.b3.g j(byte[] r48, int r49, boolean r50) {
        /*
            Method dump skipped, instruction units count: 1070
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: b.i.a.c.b3.o.a.j(byte[], int, boolean):b.i.a.c.b3.g");
    }
}
