...
public final class h {
    ...
    public static CommentFrame a(int i, x xVar) {
        ...
        if (xVar.f() == 1684108385) {
            xVar.F(8);
            String strO = xVar.o(iF - 16);
            return new CommentFrame("und", strO, strO);
        }
        String strValueOf = String.valueOf(d.a(i));
    ...
    public static ApicFrame b(x xVar) {
        ...
        int iF2 = xVar.f() & ViewCompat.MEASURED_SIZE_MASK;
        String str = iF2 == 13 ? "image/jpeg" : iF2 == 14 ? "image/png" : null;
        if (str == null) {
            b.d.b.a.a.g0(41, "Unrecognized cover art flags: ", iF2, "MetadataUtil");
            return null;
        }
        xVar.F(4);
        int i = iF - 16;
    ...
    public static TextInformationFrame c(int i, String str, x xVar) {
        ...
        String strValueOf2 = String.valueOf(d.a(i));
    ...
    public static TextInformationFrame d(int i, String str, x xVar) {
        ...
        if (xVar.f() == 1684108385) {
            xVar.F(8);
            return new TextInformationFrame(str, null, xVar.o(iF - 16));
        }
        String strValueOf = String.valueOf(d.a(i));
