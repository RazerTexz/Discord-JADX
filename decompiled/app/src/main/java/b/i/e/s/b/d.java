...
public final class d {
    ...
    */
    public static void a(b.i.e.n.c cVar, StringBuilder sb, int i, boolean z2) throws FormatException {
        while (i > 1) {
            if (cVar.a() < 11) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static void b(b.i.e.n.c cVar, StringBuilder sb, int i, b.i.e.n.d dVar, Collection<byte[]> collection, Map<b.i.e.d, ?> map) throws FormatException {
        byte[] bArr;
        String strName;
        byte[] bArr2;
        if ((i << 3) > cVar.a()) {
        ...
        if (dVar == null) {
            String str = b.i.e.n.j.a;
            if (map != null) {
                b.i.e.d dVar2 = b.i.e.d.CHARACTER_SET;
                if (map.containsKey(dVar2)) {
                    strName = map.get(dVar2).toString();
                    bArr = bArr3;
                } else {
                    boolean z2 = true;
                    ...
                    if (!z5 || (!z3 && i8 + i9 + i10 <= 0)) {
                        if (!z6 || (!b.i.e.n.j.f1839b && i11 < 3 && i2 < 3)) {
                            if (!z2 || !z6) {
                                strName = z2 ? "ISO8859_1" : z6 ? "SJIS" : z5 ? "UTF8" : b.i.e.n.j.a;
    ...
    public static void c(b.i.e.n.c cVar, StringBuilder sb, int i) throws FormatException {
        if (i * 13 > cVar.a()) {
            throw FormatException.a();
        }
    ...
    public static void d(b.i.e.n.c cVar, StringBuilder sb, int i) throws FormatException {
        if (i * 13 > cVar.a()) {
            throw FormatException.a();
        }
        byte[] bArr = new byte[i * 2];
    ...
    public static void e(b.i.e.n.c cVar, StringBuilder sb, int i) throws FormatException {
        while (i >= 3) {
            if (cVar.a() < 10) {
                throw FormatException.a();
            }
