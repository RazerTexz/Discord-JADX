...
public final class b extends k {
    ...
    */
    public Result b(int i, b.i.e.n.a aVar, Map<b.i.e.d, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        int i2 = 1;
        ?? r3 = 0;
        boolean z4 = map != null && map.containsKey(b.i.e.d.ASSUME_GS1);
        int i3 = aVar.k;
        int iF = aVar.f(0);
        int i4 = 6;
        int[] iArr = new int[6];
        ...
        while (iF < i3) {
            if (aVar.b(iF) != z5) {
                ...
                if (i6 == 5) {
                    ...
                    if (i8 >= 0 && aVar.h(Math.max((int) r3, i5 - ((iF - i5) / 2)), i5, r3)) {
                        int[] iArr2 = new int[3];
                        iArr2[r3] = i5;
                        iArr2[i2] = iF;
                        iArr2[2] = i8;
                        ...
                        while (!z7) {
                            ...
                            while (true) {
                                int[][] iArr4 = a;
                                if (i18 < iArr4.length) {
                                    float fD2 = k.d(iArr3, iArr4[i18], f);
                                    if (fD2 < f3) {
                                        f3 = fD2;
                                        i17 = i18;
                                    }
                        ...
                        int i22 = i16 - i15;
                        int iG = aVar.g(i16);
                        if (!aVar.h(iG, Math.min(aVar.k, ((iG - i15) / 2) + iG), false)) {
                            throw NotFoundException.l;
                        }
                        int i23 = i14;
                        ...
                        float f6 = i;
                        return new Result(sb.toString(), bArr, new b.i.e.k[]{new b.i.e.k(f4, f6), new b.i.e.k(f5, f6)}, b.i.e.a.CODE_128);
                    }
                    i5 += iArr[0] + iArr[1];
                    int i25 = i6 - 1;
