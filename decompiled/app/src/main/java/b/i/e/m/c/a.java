        ...
        while (true) {
            ...
            while (i15 < i12) {
                ...
                while (i17 < i5) {
                    ...
                    int i20 = i14 - i17;
                    zArr[(i12 * 2) + i11 + i16 + i17] = bVar.f(iArr[i19], iArr[i20]);
                    int i21 = i14 - i15;
                    zArr[(i12 * 4) + i11 + i16 + i17] = bVar.f(iArr[i20], iArr[i21]);
                    zArr[(i12 * 6) + i11 + i16 + i17] = bVar.f(iArr[i21], iArr[i18]);
                    i17++;
                    z2 = z2;
                    i2 = i2;
                    i5 = 2;
