...
public final class d {
    ...
    */
    public b.i.e.n.e a(b.i.e.n.b bVar) throws ChecksumException, FormatException {
        ...
        e.c cVar = eVar.g;
        e.b[] bVarArr = cVar.f1849b;
        int i52 = 0;
        for (e.b bVar3 : bVarArr) {
            i52 += bVar3.a;
        }
        b[] bVarArr2 = new b[i52];
        int i53 = 0;
        for (e.b bVar4 : bVarArr) {
            int i54 = 0;
            while (i54 < bVar4.a) {
                int i55 = bVar4.f1848b;
                bVarArr2[i53] = new b(i55, new byte[cVar.a + i55]);
                i54++;
                i53++;
            }
        }
        int length = bVarArr2[0].f1845b.length - cVar.a;
        int i56 = length - 1;
        int i57 = 0;
        for (int i58 = 0; i58 < i56; i58++) {
            int i59 = 0;
            while (i59 < i53) {
                bVarArr2[i59].f1845b[i58] = bArr[i57];
                i59++;
                i57++;
            }
        }
        ...
        int i62 = 0;
        while (i62 < i61) {
            bVarArr2[i62].f1845b[i56] = bArr[i57];
            i62++;
            i57++;
        }
        int length2 = bVarArr2[0].f1845b.length;
        while (length < length2) {
            int i63 = 0;
            while (i63 < i53) {
                int i64 = z11 ? (i63 + 8) % i53 : i63;
                bVarArr2[i64].f1845b[(!z11 || i64 <= 7) ? length : length - 1] = bArr[i57];
                i63++;
                i57++;
            }
            length++;
        ...
        for (int i67 = 0; i67 < i52; i67++) {
            b bVar5 = bVarArr2[i67];
            byte[] bArr3 = bVar5.f1845b;
            int i68 = bVar5.a;
        ...
        while (true) {
            ...
            if (i72 == 2) {
                ...
                if (iH == 2) {
                    ...
                    boolean z13 = false;
                    int i75 = 0;
                    while (cVar2.a() != 8 && (iB = cVar2.b(8)) != 254) {
                        c.a(iB, cVar2.b(8), iArr2);
                        int i76 = 0;
                        int i77 = 3;
                        while (i76 < i77) {
                            int i78 = iArr2[i76];
                    ...
                    int i80 = 0;
                    boolean z14 = false;
                    for (int i81 = 254; cVar2.a() != i60 && (iB2 = cVar2.b(i60)) != i81; i81 = 254) {
                        c.a(iB2, cVar2.b(i60), iArr3);
                        boolean z15 = z14;
                        int i82 = 0;
                        while (i82 < i79) {
                            int i83 = iArr3[i82];
                    ...
                    int i84 = 3;
                    int[] iArr4 = new int[3];
                    while (cVar2.a() != i60 && (iB3 = cVar2.b(i60)) != 254) {
                        c.a(iB3, cVar2.b(i60), iArr4);
                        int i85 = 0;
                        while (i85 < i84) {
                            int i86 = iArr4[i85];
                            if (i86 == 0) {
                    ...
                    int i89 = cVar2.f1830b + 1;
                    int i90 = i89 + 1;
                    int iB6 = c.b(cVar2.b(i60), i89);
                    if (iB6 == 0) {
                        iB6 = cVar2.a() / i60;
                    } else if (iB6 >= 250) {
                        iB6 = ((iB6 - 249) * 250) + c.b(cVar2.b(i60), i90);
                        i90++;
                    }
                    if (iB6 < 0) {
                        throw FormatException.a();
                    ...
                    while (i91 < iB6) {
                        ...
                        bArr4[i91] = (byte) c.b(cVar2.b(i60), i90);
                        i91++;
                        i90++;
                    }
                    arrayList.add(bArr4);
