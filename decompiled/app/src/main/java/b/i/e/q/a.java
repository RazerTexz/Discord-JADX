                ...
                if (i4 == 1 || this.e[i4 - 1] >= i6 / 2) {
                    ...
                    loop8: while (true) {
                        ...
                        if (i23 >= length) {
                            ...
                            if (map == null || !map.containsKey(b.i.e.d.RETURN_CODABAR_START_END)) {
                            ...
                            float f3 = i;
                            return new Result(this.d.toString(), null, new b.i.e.k[]{new b.i.e.k(f2, f3), new b.i.e.k(i28, f3)}, b.i.e.a.CODABAR);
                        }
                        i22 += 8;
                        i23++;
                    }
