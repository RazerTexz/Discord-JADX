...
public final class q extends p {
    ...
    @Override // b.i.e.q.p
    public int[] i(b.i.e.n.a aVar, int i2) throws NotFoundException {
        int[] iArr = h;
        return p.l(aVar, i2, true, iArr, new int[iArr.length]);
    }
