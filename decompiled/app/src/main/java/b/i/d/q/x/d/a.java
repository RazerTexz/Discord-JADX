    ...
    */
    public static Date b(String str, ParsePosition parsePosition) throws ParseException {
        ...
        try {
            ...
            if (zA) {
                ...
                int i7 = i6 + 2;
                iC4 = c(str, i6, i7);
                if (a(str, i7, MentionUtilsKt.EMOJIS_AND_STICKERS_CHAR)) {
                    i7++;
                }
                int i8 = i7 + 2;
                iC = c(str, i7, i8);
                if (a(str, i8, MentionUtilsKt.EMOJIS_AND_STICKERS_CHAR)) {
                    i8++;
                }
    ...
    public static int c(String str, int i, int i2) throws NumberFormatException {
        ...
        if (i < i2) {
            ...
            if (iDigit < 0) {
                StringBuilder sbU = b.d.b.a.a.U("Invalid number: ");
        ...
        while (i4 < i2) {
            ...
            if (iDigit2 < 0) {
                StringBuilder sbU2 = b.d.b.a.a.U("Invalid number: ");
