...
public class v<K, V, E extends i<K, V, E>, S extends n<K, V, E, S>> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
                ...
                if (eA != null) {
                    ...
                    if (iVarA == null) {
                        ...
                        while (eA != iVar) {
                            ...
                            i iVarA2 = this.map.n.a(l(), eA, (i) dVar.get(iC3));
                            if (iVarA2 != null) {
                                dVar.set(iC3, iVarA2);
                            } else {
                                i--;
    ...
    public final class C0134v extends AbstractCollection<V> {
        public C0134v() {
        }
    ...
    public V get(@NullableDecl Object obj) {
        ...
        try {
            ...
            if (iVarE != null && (v = (V) iVarE.getValue()) == null) {
                nVarC.n();
            }
            return v;
        } finally {
