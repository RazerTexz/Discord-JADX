...
public class d extends b {
    ...
    public static final char[] f672x = (char[]) b.g.a.b.p.a.a.clone();
    public char[] A;
    public int B;
    public int C;
    public int D;
    ...
    public d(b.g.a.b.p.c cVar, int i, i iVar, Writer writer, char c) {
        int[] iArr;
        super(cVar, i, iVar);
        this.f673y = writer;
        if (cVar.e != null) {
        ...
        if (c != '\"') {
            if (c == '\"') {
                ...
                a.C0080a c0080a = a.C0080a.a;
                int[] iArrCopyOf = c0080a.f665b[c];
                if (iArrCopyOf == null) {
                    iArrCopyOf = Arrays.copyOf(b.g.a.b.p.a.f, 128);
                    if (iArrCopyOf[c] == 0) {
                        iArrCopyOf[c] = -1;
                    }
                    c0080a.f665b[c] = iArrCopyOf;
                }
                iArr = iArrCopyOf;
            }
            this.t = iArr;
    ...
    public final int F0(b.g.a.b.a aVar, InputStream inputStream, byte[] bArr) throws IOException {
        int i = this.D - 6;
        int i2 = 2;
        int iD = aVar.d() >> 2;
        int i3 = -3;
        ...
        while (true) {
            ...
            i4 = i8 + 1;
            i5 += 3;
            int iB = aVar.b((((bArr[i6] & 255) | i7) << 8) | (bArr[i8] & 255), this.A, this.C);
            this.C = iB;
            iD--;
            if (iD <= 0) {
                char[] cArr = this.A;
    ...
    public final int G0(b.g.a.b.a aVar, InputStream inputStream, byte[] bArr, int i) throws IOException {
        int iE0;
        int i2 = this.D - 6;
        int i3 = 2;
        int iD = aVar.d() >> 2;
    ...
    */
    ...
    public void close() throws IOException {
        ...
        this.C = 0;
        if (this.f673y != null) {
            if (this.f671s.f666b || d(d.a.AUTO_CLOSE_TARGET)) {
                this.f673y.close();
    ...
    @Override // b.g.a.b.d
    public int f(b.g.a.b.a aVar, InputStream inputStream, int i) throws IOException {
        ...
        try {
            if (i < 0) {
                ...
                int iG0 = G0(aVar, inputStream, andSet, i);
                if (iG0 > 0) {
    ...
    public void flush() throws IOException {
        B0();
        if (this.f673y == null || !d(d.a.FLUSH_PASSED_TO_STREAM)) {
            return;
        }
        this.f673y.flush();
    }
    ...
    */
    ...
    public void n(b.g.a.b.a aVar, byte[] bArr, int i, int i2) throws IOException {
        ...
        while (i <= i5) {
            ...
            int i10 = i8 + 1;
            int iB = aVar.b(i9 | (bArr[i8] & 255), this.A, this.C);
            this.C = iB;
            iD--;
            if (iD <= 0) {
                char[] cArr2 = this.A;
        ...
        if (i12 > 0) {
            ...
            this.C = aVar.c(i14, i12, this.A, this.C);
        }
        if (this.C >= this.D) {
            B0();
        }
    ...
    public void t() throws IOException {
        if (!this.q.b()) {
            StringBuilder sbU = b.d.b.a.a.U("Current context not Array but ");
            sbU.append(this.q.e());
            throw new JsonGenerationException(sbU.toString(), this);
        }
        j jVar = this.l;
        if (jVar != null) {
            jVar.j(this, this.q.f661b + 1);
        } else {
            if (this.C >= this.D) {
                B0();
            }
    ...
    public void u() throws IOException {
        if (!this.q.c()) {
            StringBuilder sbU = b.d.b.a.a.U("Current context not Object but ");
            sbU.append(this.q.e());
            throw new JsonGenerationException(sbU.toString(), this);
        }
        j jVar = this.l;
        if (jVar != null) {
            jVar.f(this, this.q.f661b + 1);
        } else {
            if (this.C >= this.D) {
                B0();
            }
