...
public abstract class Flow2<T> implements Flow3<T> {
    ...
    public static final class a extends ContinuationImpl3 {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return Flow2.this.mo11246a(null, this);
        }
    }
    ...
    */
    public final Object mo11246a(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        a aVar;
        Throwable th;
        ...
        try {
            ...
            aVar.label = 1;
            if (mo11247b(safeCollector32, aVar) == coroutine_suspended) {
