    ...
    public static abstract class a extends Binder implements ITrustedWebActivityService {
        ...
        public static class C13359a implements ITrustedWebActivityService {
            ...
            public C13359a(IBinder iBinder) {
                this.f27940b = iBinder;
            }

            @Override // p668x.p669a.p670a.p671d.ITrustedWebActivityService
            public Bundle areNotificationsEnabled(Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f27940b.transact(6, parcelObtain, parcelObtain2, 0) && a.getDefaultImpl() != null) {
            ...
            public void cancelNotification(Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f27940b.transact(3, parcelObtain, parcelObtain2, 0) || a.getDefaultImpl() == null) {
                        parcelObtain2.readException();
                    } else {
            ...
            public Bundle extraCommand(String str, Bundle bundle, IBinder iBinder) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f27940b.transact(9, parcelObtain, parcelObtain2, 0) && a.getDefaultImpl() != null) {
            ...
            public Bundle getActiveNotifications() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(a.DESCRIPTOR);
                    if (!this.f27940b.transact(5, parcelObtain, parcelObtain2, 0) && a.getDefaultImpl() != null) {
            ...
            public Bundle getSmallIconBitmap() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(a.DESCRIPTOR);
                    if (!this.f27940b.transact(7, parcelObtain, parcelObtain2, 0) && a.getDefaultImpl() != null) {
            ...
            public int getSmallIconId() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken(a.DESCRIPTOR);
                    if (!this.f27940b.transact(4, parcelObtain, parcelObtain2, 0) && a.getDefaultImpl() != null) {
            ...
            public Bundle notifyNotificationWithChannel(Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f27940b.transact(2, parcelObtain, parcelObtain2, 0) && a.getDefaultImpl() != null) {
        ...
        public static ITrustedWebActivityService asInterface(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ITrustedWebActivityService)) ? new C13359a(iBinder) : (ITrustedWebActivityService) iInterfaceQueryLocalInterface;
        }

        public static ITrustedWebActivityService getDefaultImpl() {
            return C13359a.f27939a;
        }

        public static boolean setDefaultImpl(ITrustedWebActivityService iTrustedWebActivityService) {
            if (C13359a.f27939a != null) {
                throw new IllegalStateException("setDefaultImpl() called twice");
            }
            if (iTrustedWebActivityService == null) {
                return false;
            }
            C13359a.f27939a = iTrustedWebActivityService;
            return true;
        }
