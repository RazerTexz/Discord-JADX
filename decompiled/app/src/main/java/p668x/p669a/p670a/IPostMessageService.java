...
public interface IPostMessageService extends IInterface {
    ...
    public static abstract class a extends Binder implements IPostMessageService {
        ...
        public static IPostMessageService asInterface(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IPostMessageService)) ? new C13357a(iBinder) : (IPostMessageService) iInterfaceQueryLocalInterface;
        }
        ...
        public static boolean setDefaultImpl(IPostMessageService iPostMessageService) {
            ...
            C13357a.f27935a = iPostMessageService;
            return true;
        }
