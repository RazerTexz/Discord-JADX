...
public interface ICustomTabsService extends IInterface {
    ...
    public static abstract class a extends Binder implements ICustomTabsService {
        ...
        public static ICustomTabsService asInterface(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ICustomTabsService)) ? new C13356a(iBinder) : (ICustomTabsService) iInterfaceQueryLocalInterface;
        }
        ...
        public static boolean setDefaultImpl(ICustomTabsService iCustomTabsService) {
            ...
            C13356a.f27933a = iCustomTabsService;
            return true;
        }
