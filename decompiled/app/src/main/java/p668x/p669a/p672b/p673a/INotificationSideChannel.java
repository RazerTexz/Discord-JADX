...
public interface INotificationSideChannel extends IInterface {
    ...
    public static abstract class a extends Binder implements INotificationSideChannel {
        ...
        public static INotificationSideChannel asInterface(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof INotificationSideChannel)) ? new C13360a(iBinder) : (INotificationSideChannel) iInterfaceQueryLocalInterface;
        }
        ...
        public static boolean setDefaultImpl(INotificationSideChannel iNotificationSideChannel) {
            ...
            C13360a.f27941a = iNotificationSideChannel;
            return true;
        }
