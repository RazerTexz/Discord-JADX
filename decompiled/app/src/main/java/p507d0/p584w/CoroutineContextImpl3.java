...
public final class CoroutineContextImpl3 implements CoroutineContext, Serializable {
    ...
    public static final class a implements Serializable {
        ...
        private final Object readResolve() {
            ...
            CoroutineContext coroutineContextPlus = CoroutineContextImpl4.f25237j;
    ...
    public boolean equals(Object obj) {
        ...
        if (this != obj) {
            ...
            if (coroutineContextImpl3.m10083c() != m10083c()) {
                return false;
            }
    ...
    public CoroutineContext minusKey(CoroutineContext.Key<?> key) {
        ...
        return coroutineContextMinusKey == this.left ? this : coroutineContextMinusKey == CoroutineContextImpl4.f25237j ? this.element : new CoroutineContextImpl3(coroutineContextMinusKey, this.element);
    }
    ...
    public String toString() {
        return outline.m822J(outline.m833U("["), (String) fold("", b.f25234j), "]");
    }
}
