...
public abstract class ContinuationImpl implements Continuation<Object>, CoroutineStackFrame, Serializable {
    ...
    public final void resumeWith(Object obj) {
        ...
        while (true) {
            ...
            try {
                ...
                obj = Result2.m11474constructorimpl(Result3.createFailure(th));
            }
            if (objInvokeSuspend == Intrinsics2.getCOROUTINE_SUSPENDED()) {
                return;
            }
            Result2.a aVar2 = Result2.f25169j;
            obj = Result2.m11474constructorimpl(objInvokeSuspend);
    ...
    public String toString() {
        StringBuilder sbM833U = outline.m833U("Continuation at ");
