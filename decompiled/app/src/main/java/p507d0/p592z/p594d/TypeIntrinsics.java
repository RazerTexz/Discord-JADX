...
public class TypeIntrinsics {
    ...
    public static boolean isFunctionOfArity(Object obj, int i) {
        return (obj instanceof p507d0.Function3) && getFunctionArity(obj) == i;
    }

    public static boolean isMutableList(Object obj) {
        return (obj instanceof List) && (!(obj instanceof KMarkers) || (obj instanceof KMarkers3));
    }

    public static boolean isMutableMap(Object obj) {
        return (obj instanceof Map) && (!(obj instanceof KMarkers) || (obj instanceof KMarkers4));
    }

    public static ClassCastException throwCce(ClassCastException classCastException) {
        Intrinsics3.m10093b(classCastException, TypeIntrinsics.class.getName());
