...
public enum PrimitiveType {
    ...
    public static final class b extends Lambda implements Function0<FqName> {
        ...
        public final FqName invoke() {
            FqName fqNameChild = StandardNames.f22499l.child(PrimitiveType.this.getArrayTypeName());
    ...
    public static final class c extends Lambda implements Function0<FqName> {
        ...
        @Override // kotlin.jvm.functions.Function0
        public final FqName invoke() {
            FqName fqNameChild = StandardNames.f22499l.child(PrimitiveType.this.getTypeName());
    ...
    static {
        ...
        new a(null);
        f22472j = Sets5.setOf((Object[]) new PrimitiveType[]{primitiveType, primitiveType2, primitiveType3, primitiveType4, primitiveType5, primitiveType6, primitiveType7});
    }
