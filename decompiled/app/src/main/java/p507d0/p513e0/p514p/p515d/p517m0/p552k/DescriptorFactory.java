...
import p507d0.p513e0.p514p.p515d.p517m0.p521c.p524i1.ReceiverParameterDescriptorImpl;
...
public class DescriptorFactory {
    ...
    public static class a extends ClassConstructorDescriptorImpl {
        ...
        public a(ClassDescriptor classDescriptor, SourceElement sourceElement, boolean z2) {
            super(classDescriptor, null, Annotations4.f22735f.getEMPTY(), true, CallableMemberDescriptor.a.DECLARATION, sourceElement);
    ...
    public static SimpleFunctionDescriptor createEnumValueOfMethod(ClassDescriptor classDescriptor) {
        ...
        SimpleFunctionDescriptorImpl simpleFunctionDescriptorImplCreate = SimpleFunctionDescriptorImpl.create(classDescriptor, aVar.getEMPTY(), StandardNames.f22490c, CallableMemberDescriptor.a.SYNTHESIZED, classDescriptor.getSource());
    ...
    public static SimpleFunctionDescriptor createEnumValuesMethod(ClassDescriptor classDescriptor) {
        ...
        SimpleFunctionDescriptorImpl simpleFunctionDescriptorImplInitialize = SimpleFunctionDescriptorImpl.create(classDescriptor, Annotations4.f22735f.getEMPTY(), StandardNames.f22489b, CallableMemberDescriptor.a.SYNTHESIZED, classDescriptor.getSource()).initialize((ReceiverParameterDescriptor) null, (ReceiverParameterDescriptor) null, Collections.emptyList(), Collections.emptyList(), (KotlinType) DescriptorUtils2.getBuiltIns(classDescriptor).getArrayType(Variance.INVARIANT, classDescriptor.getDefaultType()), Modality.FINAL, DescriptorVisibilities.f23087e);
        if (simpleFunctionDescriptorImplInitialize != null) {
            return simpleFunctionDescriptorImplInitialize;
        }
        m9920a(23);
    ...
    public static boolean isEnumValueOfMethod(FunctionDescriptor functionDescriptor) {
        if (functionDescriptor != null) {
            return functionDescriptor.getName().equals(StandardNames.f22490c) && m9921b(functionDescriptor);
        }
        m9920a(27);
        throw null;
    }
    ...
    public static boolean isEnumValuesMethod(FunctionDescriptor functionDescriptor) {
        if (functionDescriptor != null) {
            return functionDescriptor.getName().equals(StandardNames.f22489b) && m9921b(functionDescriptor);
        }
        m9920a(26);
        throw null;
    }
