...
import p507d0.p513e0.p514p.p515d.p517m0.p573o.OperatorNameConventions;
...
public final class FunctionInvokeDescriptor extends SimpleFunctionDescriptorImpl {
    ...
    public static final class a {
        ...
        public final FunctionInvokeDescriptor create(FunctionClassDescriptor functionClassDescriptor, boolean z2) {
            ...
            functionInvokeDescriptor.initialize((ReceiverParameterDescriptor) null, thisAsReceiverParameter, listEmptyList, (List<ValueParameterDescriptor>) arrayList2, (KotlinType) ((TypeParameterDescriptor) _Collections.last((List) declaredTypeParameters)).getDefaultType(), Modality.ABSTRACT, DescriptorVisibilities.f23087e);
    ...
    public FunctionInvokeDescriptor(DeclarationDescriptor declarationDescriptor, FunctionInvokeDescriptor functionInvokeDescriptor, CallableMemberDescriptor.a aVar, boolean z2) {
        super(declarationDescriptor, functionInvokeDescriptor, Annotations4.f22735f.getEMPTY(), OperatorNameConventions.f24936g, aVar, SourceElement.f23099a);
        setOperator(true);
        setSuspend(z2);
    ...
    public FunctionDescriptor mo9374c(FunctionDescriptorImpl.c cVar) {
        ...
        FunctionInvokeDescriptor functionInvokeDescriptor = (FunctionInvokeDescriptor) super.mo9374c(cVar);
        ...
        FunctionDescriptorImpl.c cVarM9425d = functionInvokeDescriptor.m9425d(TypeSubstitutor2.f24745a);
        ...
        FunctionDescriptorImpl.c original = cVarM9425d.setHasSynthesizedParameterNames(z3).setValueParameters((List<ValueParameterDescriptor>) arrayList2).setOriginal((CallableMemberDescriptor) functionInvokeDescriptor.getOriginal());
        Intrinsics3.checkNotNullExpressionValue(original, "newCopyBuilder(TypeSubstitutor.EMPTY)\n                .setHasSynthesizedParameterNames(parameterNames.any { it == null })\n                .setValueParameters(newValueParameters)\n                .setOriginal(original)");
        FunctionDescriptor functionDescriptorMo9374c = super.mo9374c(original);
        Intrinsics3.checkNotNull(functionDescriptorMo9374c);
        return functionDescriptorMo9374c;
    }
