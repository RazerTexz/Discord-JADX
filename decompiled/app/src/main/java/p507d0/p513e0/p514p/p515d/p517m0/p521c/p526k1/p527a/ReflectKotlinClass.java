...
public final class ReflectKotlinClass {
    ...
    public final ClassLiteralValue m9432a(Class<?> cls) {
        ...
        if (Intrinsics3.areEqual(cls, Void.TYPE)) {
            ClassId classId2 = ClassId.topLevel(StandardNames.a.f22538e.toSafe());
        ...
        while (i < length) {
            ...
            try {
                ...
                if (Intrinsics3.areEqual(enclosingClass, Class.class)) {
                    aVar.visitClassLiteral(nameIdentifier, m9432a((Class) objInvoke));
                } else if (ReflectKotlinClass3.m11463access$getTYPES_ELIGIBLE_FOR_SIMPLE_VISIT$p$s1934497501().contains(enclosingClass)) {
    ...
    public final void visitMembers(Class<?> cls, KotlinJvmBinaryClass.d dVar) {
        ...
        while (true) {
            ...
            Name nameIdentifier = Name.identifier(method.getName());
            Intrinsics3.checkNotNullExpressionValue(nameIdentifier, "identifier(method.name)");
            ReflectKotlinClass4 reflectKotlinClass4 = ReflectKotlinClass4.f23027a;
        ...
        while (i11 < length5) {
            ...
            ReflectKotlinClass4 reflectKotlinClass42 = ReflectKotlinClass4.f23027a;
        ...
        while (i21 < length10) {
            ...
            ReflectKotlinClass4 reflectKotlinClass43 = ReflectKotlinClass4.f23027a;
