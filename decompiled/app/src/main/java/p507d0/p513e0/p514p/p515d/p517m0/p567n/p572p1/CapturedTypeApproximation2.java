...
public final class CapturedTypeApproximation2 {
    ...
    */
    public static final KotlinType m10023a(KotlinType kotlinType, List<CapturedTypeApproximation4> list) {
    ...
    public static final CapturedTypeApproximation<KotlinType> approximateCapturedTypes(KotlinType kotlinType) {
        ...
        if (z2) {
            objM10023a = TypeUtils2.getBuiltIns(kotlinType).getNothingType();
            Intrinsics3.checkNotNullExpressionValue(objM10023a, "type.builtIns.nothingType");
        } else {
            objM10023a = m10023a(kotlinType, arrayList);
        }
        return new CapturedTypeApproximation<>(objM10023a, m10023a(kotlinType, arrayList2));
    }
    ...
    public static final TypeProjection approximateCapturedTypesIfNecessary(TypeProjection typeProjection, boolean z2) {
        ...
        Intrinsics3.checkNotNullExpressionValue(type, "typeProjection.type");
        if (!TypeUtils.contains(type, a.f24858j)) {
            return typeProjection;
        }
