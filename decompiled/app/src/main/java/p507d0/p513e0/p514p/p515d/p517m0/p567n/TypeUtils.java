...
public class TypeUtils {
    ...
    */
    ...
    public static boolean m10009b(KotlinType kotlinType, Function1<KotlinType3, Boolean> function1, SmartSet<KotlinType> smartSet) {
        ...
        if (kotlinType6 != null && (m10009b(kotlinType6.getLowerBound(), function1, smartSet) || m10009b(kotlinType6.getUpperBound(), function1, smartSet))) {
            return true;
        }
        if ((kotlinType3Unwrap instanceof SpecialTypes3) && m10009b(((SpecialTypes3) kotlinType3Unwrap).getOriginal(), function1, smartSet)) {
            return true;
        }
        ...
        if (constructor instanceof IntersectionTypeConstructor) {
            ...
            while (it.hasNext()) {
                if (m10009b(it.next(), function1, smartSet)) {
                    return true;
                }
            }
            return false;
        ...
        for (TypeProjection typeProjection : kotlinType.getArguments()) {
            if (!typeProjection.isStarProjection()) {
                if (m10009b(typeProjection.getType(), function1, smartSet)) {
                    return true;
                }
            }
        }
    ...
    public static boolean contains(KotlinType kotlinType, Function1<KotlinType3, Boolean> function1) {
        if (function1 != null) {
            return m10009b(kotlinType, function1, null);
        }
        m10008a(43);
        throw null;
    }
    ...
    public static boolean isDontCarePlaceholder(KotlinType kotlinType) {
        return kotlinType != null && kotlinType.getConstructor() == f24753a.getConstructor();
    }
    ...
    public static boolean noExpectedType(KotlinType kotlinType) {
        if (kotlinType != null) {
            return kotlinType == f24755c || kotlinType == f24756d;
        }
        m10008a(0);
        throw null;
    }
    ...
    public static KotlinType4 makeUnsubstitutedType(TypeConstructor typeConstructor, MemberScope3 memberScope3, Function1<KotlinTypeRefiner, KotlinType4> function1) {
        ...
        if (function1 != null) {
            KotlinType4 kotlinType4SimpleTypeWithNonTrivialMemberScope = KotlinTypeFactory.simpleTypeWithNonTrivialMemberScope(Annotations4.f22735f.getEMPTY(), typeConstructor, getDefaultTypeProjections(typeConstructor.getParameters()), false, memberScope3, function1);
