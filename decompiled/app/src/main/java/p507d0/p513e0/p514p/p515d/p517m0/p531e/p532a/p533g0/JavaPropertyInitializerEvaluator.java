...
public interface JavaPropertyInitializerEvaluator {
    ...
    public static final class a implements JavaPropertyInitializerEvaluator {
        ...
        @Override // p507d0.p513e0.p514p.p515d.p517m0.p531e.p532a.p533g0.JavaPropertyInitializerEvaluator
        public AbstractC11815g<?> getInitializerConstant(InterfaceC11581n interfaceC11581n, PropertyDescriptor propertyDescriptor) {
            Intrinsics3.checkNotNullParameter(interfaceC11581n, "field");
            Intrinsics3.checkNotNullParameter(propertyDescriptor, "descriptor");
            return null;
        }
    }

    AbstractC11815g<?> getInitializerConstant(InterfaceC11581n interfaceC11581n, PropertyDescriptor propertyDescriptor);
}
