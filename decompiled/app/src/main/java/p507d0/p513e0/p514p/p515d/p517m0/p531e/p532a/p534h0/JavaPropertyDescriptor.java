...
import p507d0.p513e0.p514p.p515d.p517m0.p521c.ConstUtil;
...
import p507d0.p513e0.p514p.p515d.p517m0.p531e.p532a.p540l0.typeEnhancement6;
...
public class JavaPropertyDescriptor extends PropertyDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    public PropertyDescriptorImpl mo9394b(DeclarationDescriptor declarationDescriptor, Modality modality, DescriptorVisibility2 descriptorVisibility2, PropertyDescriptor propertyDescriptor, CallableMemberDescriptor.a aVar, Name name, SourceElement sourceElement) {
        ...
        if (name != null) {
            return new JavaPropertyDescriptor(declarationDescriptor, getAnnotations(), modality, descriptorVisibility2, isVar(), name, sourceElement, propertyDescriptor, aVar, this.f23270J, this.f23271K);
        }
        m9459a(17);
        throw null;
    }
    ...
    public JavaCallableMemberDescriptor enhance(KotlinType kotlinType, List<util4> list, KotlinType kotlinType2, Tuples2<CallableDescriptor.a<?>, ?> tuples2) {
        ...
        JavaPropertyDescriptor javaPropertyDescriptor = new JavaPropertyDescriptor(getContainingDeclaration(), getAnnotations(), getModality(), getVisibility(), isVar(), getName(), getSource(), original, getKind(), this.f23270J, tuples2);
        ...
        javaPropertyDescriptor.setType(kotlinType2, getTypeParameters(), getDispatchReceiverParameter(), kotlinType == null ? null : DescriptorFactory.createExtensionReceiverParameterForCallable(this, kotlinType, Annotations4.f22735f.getEMPTY()));
    ...
    @Override // p507d0.p513e0.p514p.p515d.p517m0.p521c.p524i1.PropertyDescriptorImpl, p507d0.p513e0.p514p.p515d.p517m0.p521c.VariableDescriptor
    public boolean isConst() {
        KotlinType type = getType();
        return this.f23270J && ConstUtil.canBeUsedForConstVal(type) && (!typeEnhancement6.hasEnhancedNullability(type) || KotlinBuiltIns.isString(type));
    }
}
