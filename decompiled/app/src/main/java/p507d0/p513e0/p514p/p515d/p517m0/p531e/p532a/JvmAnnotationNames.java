...
public final class JvmAnnotationNames {
    ...
    static {
        ...
        f23148b = Name.identifier("value");
        f23149c = new FqName(Target.class.getCanonicalName());
        f23150d = new FqName(Retention.class.getCanonicalName());
        f23151e = new FqName(Deprecated.class.getCanonicalName());
        f23152f = new FqName(Documented.class.getCanonicalName());
        f23153g = new FqName("java.lang.annotation.Repeatable");
        f23154h = new FqName("org.jetbrains.annotations.NotNull");
        f23155i = new FqName("org.jetbrains.annotations.Nullable");
        f23156j = new FqName("org.jetbrains.annotations.Mutable");
        f23157k = new FqName("org.jetbrains.annotations.ReadOnly");
        f23158l = new FqName("kotlin.annotations.jvm.ReadOnly");
        f23159m = new FqName("kotlin.annotations.jvm.Mutable");
        f23160n = new FqName("kotlin.jvm.PurelyImplements");
        new FqName("kotlin.jvm.internal");
        f23161o = new FqName("kotlin.jvm.internal.EnhancedNullability");
        f23162p = new FqName("kotlin.jvm.internal.EnhancedMutability");
        f23163q = new FqName("kotlin.annotations.jvm.internal.ParameterName");
        f23164r = new FqName("kotlin.annotations.jvm.internal.DefaultValue");
        f23165s = new FqName("kotlin.annotations.jvm.internal.DefaultNull");
    }
}
