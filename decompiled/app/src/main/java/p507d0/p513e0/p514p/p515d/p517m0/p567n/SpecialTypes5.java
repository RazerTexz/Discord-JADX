...
/* JADX INFO: renamed from: d0.e0.p.d.m0.n.m0, reason: use source file name */
/* JADX INFO: compiled from: SpecialTypes.kt */
/* JADX INFO: loaded from: classes3.dex */
public final class SpecialTypes5 {
    /* JADX INFO: renamed from: a */
    public static final KotlinType4 m10019a(KotlinType kotlinType) {
    ...
    public static final KotlinType3 makeDefinitelyNotNullOrNotNull(KotlinType3 kotlinType3, boolean z2) {
        ...
        SpecialTypes3 specialTypes3MakeDefinitelyNotNull$descriptors = SpecialTypes3.f24788k.makeDefinitelyNotNull$descriptors(kotlinType3, z2);
        if (specialTypes3MakeDefinitelyNotNull$descriptors != null) {
            return specialTypes3MakeDefinitelyNotNull$descriptors;
        }
        KotlinType4 kotlinType4M10019a = m10019a(kotlinType3);
        return kotlinType4M10019a == null ? kotlinType3.makeNullableAsSpecified(false) : kotlinType4M10019a;
    }
    ...
    public static final KotlinType4 makeSimpleTypeDefinitelyNotNullOrNotNull(KotlinType4 kotlinType4, boolean z2) {
        ...
        SpecialTypes3 specialTypes3MakeDefinitelyNotNull$descriptors = SpecialTypes3.f24788k.makeDefinitelyNotNull$descriptors(kotlinType4, z2);
        if (specialTypes3MakeDefinitelyNotNull$descriptors != null) {
            return specialTypes3MakeDefinitelyNotNull$descriptors;
        }
        KotlinType4 kotlinType4M10019a = m10019a(kotlinType4);
        return kotlinType4M10019a == null ? kotlinType4.makeNullableAsSpecified(false) : kotlinType4M10019a;
    }
