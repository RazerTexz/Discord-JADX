...
import p507d0.p513e0.p514p.p515d.FunctionWithAllInvokes;
import p507d0.p513e0.p514p.p515d.ReflectProperties;
import p507d0.p513e0.p514p.p515d.RuntimeTypeMapper;
import p507d0.p513e0.p514p.p515d.p516l0.AnnotationConstructorCaller;
import p507d0.p513e0.p514p.p515d.p516l0.Caller2;
import p507d0.p513e0.p514p.p515d.p516l0.Caller3;
...
import p507d0.p513e0.p514p.p515d.p517m0.p552k.p560y.inlineClassManglingRules;
...
public final class KFunctionImpl extends KCallableImpl<Object> implements FunctionBase<Object>, KFunction<Object>, FunctionWithAllInvokes {
    ...
    public static final class a extends Lambda implements Function0<Caller2<? extends Member>> {
        ...
        public final Caller2<? extends Member> invoke() throws SecurityException {
            ...
            RuntimeTypeMapper runtimeTypeMapperMapSignature = RuntimeTypeMapper3.f22358b.mapSignature(KFunctionImpl.this.getDescriptor());
            if (runtimeTypeMapperMapSignature instanceof RuntimeTypeMapper.d) {
                if (KFunctionImpl.this.m9337b()) {
            ...
            if (constructor instanceof Constructor) {
                ...
                if (!(constructor instanceof Method)) {
                    StringBuilder sbM833U = outline.m833U("Could not compute caller for function: ");
                    sbM833U.append(KFunctionImpl.this.getDescriptor());
        ...
        */
        public final Caller2<? extends Member> invoke() {
            ...
            if (runtimeTypeMapperMapSignature instanceof RuntimeTypeMapper.e) {
                ...
                Intrinsics3.checkNotNull(KFunctionImpl.this.getCaller().mo11457getMember());
    ...
    public KFunctionImpl(KDeclarationContainerImpl kDeclarationContainerImpl, String str, String str2, FunctionDescriptor functionDescriptor, Object obj) {
        this.f22394r = kDeclarationContainerImpl;
        this.f22395s = str2;
        this.f22396t = obj;
        this.f22391o = ReflectProperties.lazySoft(functionDescriptor, new c(str));
        this.f22392p = ReflectProperties.lazy(new a());
        this.f22393q = ReflectProperties.lazy(new b());
    }
    ...
    public final Object getBoundReceiver() {
        return InlineClassAwareCaller2.coerceToExpectedReceiverType(this.f22396t, getDescriptor());
    }

    @Override // p507d0.p513e0.p514p.p515d.KCallableImpl
    public Caller2<?> getCaller() {
        return (Caller2) this.f22392p.getValue(this, f22390n[1]);
    }
    ...
    public Caller2<?> getDefaultCaller() {
        return (Caller2) this.f22393q.getValue(this, f22390n[2]);
    }
    ...
    public FunctionDescriptor getDescriptor() {
        return (FunctionDescriptor) this.f22391o.getValue(this, f22390n[0]);
    }
    ...
    public boolean isBound() {
        return !Intrinsics3.areEqual(this.f22396t, CallableReference.NO_RECEIVER);
    }
    ...
    public String toString() {
        return ReflectionObjectRenderer.f22349b.renderFunction(getDescriptor());
    }
    ...
    public KFunctionImpl(KDeclarationContainerImpl kDeclarationContainerImpl, FunctionDescriptor functionDescriptor) {
        ...
        Intrinsics3.checkNotNullExpressionValue(strAsString, "descriptor.name.asString()");
        this(kDeclarationContainerImpl, strAsString, RuntimeTypeMapper3.f22358b.mapSignature(functionDescriptor).asString(), functionDescriptor, CallableReference.NO_RECEIVER);
    }
