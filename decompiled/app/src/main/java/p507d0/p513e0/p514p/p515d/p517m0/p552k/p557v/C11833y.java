...
/* renamed from: d0.e0.p.d.m0.k.v.y */
...
public final class C11833y extends AbstractC11810b0<Integer> {
    ...
    public KotlinType getType(ModuleDescriptor2 moduleDescriptor2) {
        ...
        ClassDescriptor classDescriptorFindClassAcrossModuleDependencies = findClassInModule.findClassAcrossModuleDependencies(moduleDescriptor2, StandardNames.a.f22543g0);
