...
public class Strings4 extends StringsJVM {
    ...
    public static final Tuples2 access$findAnyOf(CharSequence charSequence, Collection collection, int i, boolean z2, boolean z3) {
        ...
        if (!z2 && collection.size() == 1) {
            ...
            return Tuples.m10073to(Integer.valueOf(iIndexOf$default), str);
        }
        ...
        if (charSequence instanceof String) {
            ...
            while (true) {
                ...
                if (str3 != null) {
                    return Tuples.m10073to(Integer.valueOf(first), str3);
                }
                if (first == last) {
                    return null;
                }
            ...
            while (true) {
                ...
                if (str5 != null) {
                    return Tuples.m10073to(Integer.valueOf(first2), str5);
                }
                if (first2 == last2) {
                    return null;
                }
    ...
    public static final String replaceAfterLast(String str, char c, String str2, String str3) {
        outline.m872q0(str, "$this$replaceAfterLast", str2, "replacement", str3, "missingDelimiterValue");
    ...
    public static final void requireNonNegativeLimit(int i) {
        if (!(i >= 0)) {
            throw new IllegalArgumentException(outline.m871q("Limit must be non-negative, but was ", i).toString());
        }
    }
    ...
    public static final List<String> split(CharSequence charSequence, String[] strArr, boolean z2, int i) {
        ...
        Iterable iterableAsIterable = _Sequences2.asIterable(m10071d(charSequence, strArr, 0, z2, i, 2));
    ...
    public static final Sequence<String> splitToSequence(CharSequence charSequence, String[] strArr, boolean z2, int i) {
        ...
        Intrinsics3.checkNotNullParameter(strArr, "delimiters");
        return _Sequences2.map(m10071d(charSequence, strArr, 0, z2, i, 2), new a(charSequence));
    }
    ...
    public static final String substringAfter(String str, String str2, String str3) {
        outline.m872q0(str, "$this$substringAfter", str2, "delimiter", str3, "missingDelimiterValue");
    ...
    public static final String substringBefore(String str, String str2, String str3) {
        outline.m872q0(str, "$this$substringBefore", str2, "delimiter", str3, "missingDelimiterValue");
        int iIndexOf$default = indexOf$default((CharSequence) str, str2, 0, false, 6, (Object) null);
        if (iIndexOf$default == -1) {
            return str3;
        }
    ...
    public static final String substringBeforeLast(String str, String str2, String str3) {
        outline.m872q0(str, "$this$substringBeforeLast", str2, "delimiter", str3, "missingDelimiterValue");
