...
public final class LazyJVM2<T> implements Lazy<T>, Serializable {
    ...
    static {
        new a(null);
        f25170j = AtomicReferenceFieldUpdater.newUpdater(LazyJVM2.class, Object.class, "_value");
    }

    public LazyJVM2(Function0<? extends T> function0) {
        Intrinsics3.checkNotNullParameter(function0, "initializer");
        this.initializer = function0;
        Lazy6 lazy6 = Lazy6.f25171a;
        this._value = lazy6;
        this.f28003final = lazy6;
    }
    ...
    public T getValue() {
        ...
        if (function0 != null) {
            ...
            if (f25170j.compareAndSet(this, lazy6, tInvoke)) {
    ...
    public boolean isInitialized() {
        return this._value != Lazy6.f25171a;
    }
