...
public class n extends m {
    ...
    /* JADX INFO: Add missing generic type declarations: [T] */
    /* compiled from: Sequences.kt */
    public static final class b<T> extends d0.z.d.o implements Function1<Sequence<? extends T>, Iterator<? extends T>> {
    ...
    /* JADX INFO: Add missing generic type declarations: [T] */
    /* compiled from: Sequences.kt */
    public static final class c<T> extends d0.z.d.o implements Function1<Iterable<? extends T>, Iterator<? extends T>> {
    ...
    /* JADX INFO: Add missing generic type declarations: [T] */
    /* compiled from: Sequences.kt */
    public static final class d<T> extends d0.z.d.o implements Function1<T, T> {
    ...
    /* JADX INFO: Add missing generic type declarations: [T] */
    /* compiled from: Sequences.kt */
    public static final class e<T> extends d0.z.d.o implements Function0<T> {
