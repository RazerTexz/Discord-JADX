...
public final class d {
    ...
    public c readBytes() throws IOException {
        ...
        if (rawVarint32 > i - i2 || rawVarint32 <= 0) {
            return rawVarint32 == 0 ? c.j : new m(a(rawVarint32));
        }
        boolean z2 = this.f3426b;
        c cVarCopyFrom = c.copyFrom(this.a, i2, rawVarint32);
        this.e += rawVarint32;
        return cVarCopyFrom;
    }
    ...
    */
    ...
    public String readStringRequireUtf8() throws IOException {
        ...
        if (v.isValidUtf8(bArrA, i, i + rawVarint32)) {
    ...
    public int readTag() throws IOException {
        ...
        int rawVarint32 = readRawVarint32();
        this.g = rawVarint32;
        if (w.getTagFieldNumber(rawVarint32) != 0) {
            return this.g;
        }
    ...
    public <T extends n> T readMessage(p<T> pVar, e eVar) throws IOException {
        ...
        if (this.j < 64) {
            int iPushLimit = pushLimit(rawVarint32);
            this.j++;
            T partialFrom = pVar.parsePartialFrom(this, eVar);
            checkLastTagWas(0);
            this.j--;
            popLimit(iPushLimit);
            return partialFrom;
