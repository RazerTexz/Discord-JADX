...
public final class w {
    ...
    /* compiled from: SignatureBuildingComponents.kt */
    public static final class a extends d0.z.d.o implements Function1<String, CharSequence> {
        public a() {
            super(1);
        }
        ...
        public final CharSequence invoke2(String str) {
            ...
            return w.access$escapeClassName(w.this, str);
        }
    ...
    public final String jvmDescriptor(String str, List<String> list, String str2) {
        ...
        return str + '(' + d0.t.u.joinToString$default(list, "", null, null, 0, null, new a(), 30, null) + ')' + a(str2);
    }
