...
public class f implements d0.e0.p.d.m0.m.o {
    ...
    public static final d0.e0.p.d.m0.m.o f3514b = new a("NO_LOCKS", InterfaceC0578f.a, d0.e0.p.d.m0.m.e.f3513b);
    public final d0.e0.p.d.m0.m.l c;
    public final InterfaceC0578f d;
    public final String e;

    /* compiled from: LockBasedStorageManager.java */
    public static class a extends f {
        public a(String str, InterfaceC0578f interfaceC0578f, d0.e0.p.d.m0.m.l lVar) {
            super(str, interfaceC0578f, lVar);
        }
    ...
    public interface InterfaceC0578f {
        public static final InterfaceC0578f a = new a();

        /* compiled from: LockBasedStorageManager.java */
        /* renamed from: d0.e0.p.d.m0.m.f$f$a */
        public static class a implements InterfaceC0578f {
                    ...
                    if (!oVarC.isFallThrough()) {
                        ...
                        if (oVarC2.isFallThrough()) {
                            ...
                            try {
                                ...
                                throw ((InterfaceC0578f.a) this.j.d).handleException(th);
                            }
                        } else {
    ...
    public f(String str, InterfaceC0578f interfaceC0578f, d0.e0.p.d.m0.m.l lVar) {
        if (str == null) {
            a(4);
            throw null;
        }
    ...
    */
    ...
    public <K, V> o<V> c(String str, K k2) {
        ...
        sbX.append(k2 == null ? "" : b.d.b.a.a.v("on input: ", k2));
        sbX.append(" under ");
        sbX.append(this);
    ...
    public <K, V> d0.e0.p.d.m0.m.h<K, V> createMemoizedFunction(Function1<? super K, ? extends V> function1) {
        ...
        d0.e0.p.d.m0.m.h<K, V> hVarCreateMemoizedFunction = createMemoizedFunction(function1, b());
    ...
    public <K, V> d0.e0.p.d.m0.m.i<K, V> createMemoizedFunctionWithNullableValues(Function1<? super K, ? extends V> function1) {
        ...
        d0.e0.p.d.m0.m.i<K, V> iVarCreateMemoizedFunctionWithNullableValues = createMemoizedFunctionWithNullableValues(function1, b());
    ...
    public f(String str, Runnable runnable, Function1<InterruptedException, Unit> function1) {
        InterfaceC0578f interfaceC0578f = InterfaceC0578f.a;
        int i2 = d0.e0.p.d.m0.m.l.a;
        this(str, interfaceC0578f, l.a.a.simpleLock(runnable, function1));
    }
}
