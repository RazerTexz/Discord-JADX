...
public class s extends r {
    public static final Byte toByteOrNull(String str, int i) {
        int iIntValue;
        d0.z.d.m.checkNotNullParameter(str, "$this$toByteOrNull");
    ...
    public static final Integer toIntOrNull(String str) {
        d0.z.d.m.checkNotNullParameter(str, "$this$toIntOrNull");
        return toIntOrNull(str, 10);
    }

    public static final Long toLongOrNull(String str) {
        d0.z.d.m.checkNotNullParameter(str, "$this$toLongOrNull");
        return toLongOrNull(str, 10);
    }

    public static final Short toShortOrNull(String str, int i) {
        int iIntValue;
        d0.z.d.m.checkNotNullParameter(str, "$this$toShortOrNull");
        Integer intOrNull = toIntOrNull(str, i);
    ...
    public static final Integer toIntOrNull(String str, int i) {
        ...
        int i4 = -2147483647;
        int i5 = 1;
        if (d0.z.d.m.compare(cCharAt, 48) >= 0) {
            z2 = false;
            i5 = 0;
        } else {
            if (length == 1) {
        ...
        int i6 = -59652323;
        while (i5 < length) {
            int iDigitOf = a.digitOf(str.charAt(i5), i);
            if (iDigitOf < 0) {
                return null;
            }
    ...
    public static final Long toLongOrNull(String str, int i) {
        ...
        while (i2 < length) {
            int iDigitOf = a.digitOf(str.charAt(i2), i);
            if (iDigitOf < 0) {
                return null;
            }
            if (j3 < j4) {
