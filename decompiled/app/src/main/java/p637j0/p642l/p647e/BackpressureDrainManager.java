...
public final class BackpressureDrainManager extends AtomicLong implements Producer {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x002a, code lost:
        ...
        r1 = r14.exception;
        r5 = (p637j0.p642l.p643a.OperatorOnBackpressureBuffer.a) r5;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x0030, code lost:
        ...
        r5.f26730l.onError(r1);
     */
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0036, code lost:
    
        r5.f26730l.onCompleted();
     */
            ...
            loop0: while (true) {
                ...
                while (true) {
                    ...
                    if (!z4) {
                        ...
                        Object objPoll = aVar2.f26728j.poll();
                        AtomicLong atomicLong = aVar2.f26729k;
                        ...
                        if (NotificationLite.m10744a(((OperatorOnBackpressureBuffer.a) aVar).f26730l, objPoll)) {
                            return;
                        }
                        j--;
                        i++;
                    } else if (((OperatorOnBackpressureBuffer.a) aVar).f26728j.peek() == null) {
                        try {
                            break loop0;
                        } catch (Throwable th3) {
                            th = th3;
                ...
                synchronized (this) {
                    try {
                        z4 = this.terminated;
                        boolean z5 = ((OperatorOnBackpressureBuffer.a) aVar).f26728j.peek() != null;
                        try {
