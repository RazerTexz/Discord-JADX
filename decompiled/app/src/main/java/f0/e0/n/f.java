...
public final class f {
    ...
    public boolean equals(Object obj) {
        ...
        f fVar = (f) obj;
        return this.a == fVar.a && m.areEqual(this.f3664b, fVar.f3664b) && this.c == fVar.c && m.areEqual(this.d, fVar.d) && this.e == fVar.e && this.f == fVar.f;
    }
    ...
    public String toString() {
        StringBuilder sbU = b.d.b.a.a.U("WebSocketExtensions(perMessageDeflate=");
        sbU.append(this.a);
