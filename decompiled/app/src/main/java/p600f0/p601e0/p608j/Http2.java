...
public final class Http2 {
    ...
    static {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            strArr[i] = StringsJVM.replace$default(Util7.m10129j("%8s", binaryString), ' ', '0', false, 4, (Object) null);
        }
        f25613d = strArr;
        ...
        for (int i4 = 0; i4 < 3; i4++) {
            ...
            for (int i6 = 0; i6 < 1; i6++) {
                ...
                sb.append("|");
                strArr5[i8 | 8] = outline.m822J(sb, strArr5[i5], "|PADDED");
            }
        }
    ...
    */
    public final String m10257b(boolean z2, int i, int i2, int i3, int i4) {
        ...
        return Util7.m10129j("%s 0x%08x %5d %-13s %s", z2 ? "<<" : ">>", Integer.valueOf(i), Integer.valueOf(i2), strM10256a, strReplace$default);
    }
}
