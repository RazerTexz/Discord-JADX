    ...
    public static final class a<T> extends Subscriber<T> implements Action0 {
        ...
        public class C0623a implements Producer {
            ...
            public class C0624a implements Action0 {
                ...
                public void call() {
                    C0623a.this.j.j(this.j);
                }
            }

            public C0623a(Producer producer) {
                this.j = producer;
            }
        ...
        public void setProducer(Producer producer) {
            this.j.setProducer(new C0623a(producer));
        }
    }
