    ...
    public static final class e<T> extends Subscriber<Observable<? extends T>> {
        ...
        */
                ...
                if (queue != null) {
                    ...
                    while (true) {
                        ...
                        while (true) {
                            ...
                            try {
                                subscriber.onNext((Object) j0.l.a.e.b(objPoll));
                            } catch (Throwable th2) {
                                if (!this.l) {
                    ...
                    while (true) {
                        ...
                        while (true) {
                            ...
                            while (jA > 0) {
                                ...
                                j0.l.e.i iVar = cVar.n;
                                if (iVar != null && (objC = iVar.c()) != null) {
                                    try {
                                        try {
                                            subscriber.onNext((Object) j0.l.a.e.b(objC));
                                            jA--;
                                            i7++;
                                        } catch (Throwable th3) {
                                            b.i.a.f.e.o.f.o1(th3);
        ...
        public void e(T t) throws Throwable {
            Queue<Object> nVar = this.o;
            if (nVar == null) {
                int i = this.m;
                if (i == Integer.MAX_VALUE) {
                    nVar = new j0.l.e.n.g<>(j0.l.e.i.j);
                } else {
                    nVar = ((i + (-1)) & i) == 0 ? j0.l.e.o.y.b() ? new j0.l.e.o.n<>(i) : new j0.l.e.n.c<>(i) : new j0.l.e.n.d<>(i);
                }
                this.o = nVar;
            }
            if (nVar.offer(t == null ? j0.l.a.e.f3771b : t)) {
                return;
            }
            unsubscribe();
