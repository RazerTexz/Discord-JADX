...
public class HandlerExecutorServiceImpl extends AbstractExecutorService implements ScheduledExecutorService {
    ...
    public RunnableFuture newTaskFor(Runnable runnable, Object obj) {
        return new ScheduledFutureImpl(this.f3088j, runnable, obj);
    }

    @Override // java.util.concurrent.ScheduledExecutorService
    public ScheduledFuture<?> schedule(Runnable runnable, long j, TimeUnit timeUnit) {
        ScheduledFutureImpl scheduledFutureImpl = new ScheduledFutureImpl(this.f3088j, runnable, null);
        this.f3088j.postDelayed(scheduledFutureImpl, timeUnit.toMillis(j));
    ...
    public RunnableFuture newTaskFor(Callable callable) {
        return new ScheduledFutureImpl(this.f3088j, callable);
    }

    @Override // java.util.concurrent.ScheduledExecutorService
    public <V> ScheduledFuture<V> schedule(Callable<V> callable, long j, TimeUnit timeUnit) {
        ScheduledFutureImpl scheduledFutureImpl = new ScheduledFutureImpl(this.f3088j, callable);
        this.f3088j.postDelayed(scheduledFutureImpl, timeUnit.toMillis(j));
        return scheduledFutureImpl;
    }
    ...
    public Future submit(Runnable runnable, Object obj) {
        Objects.requireNonNull(runnable);
        ScheduledFutureImpl scheduledFutureImpl = new ScheduledFutureImpl(this.f3088j, runnable, obj);
        execute(scheduledFutureImpl);
        return scheduledFutureImpl;
    }
