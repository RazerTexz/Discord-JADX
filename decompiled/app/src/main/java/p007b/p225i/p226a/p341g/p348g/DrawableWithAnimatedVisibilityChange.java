...
public abstract class DrawableWithAnimatedVisibilityChange extends Drawable implements Animatable2Compat {
    ...
    public void setGrowFraction(@FloatRange(from = 0.0d, m75to = 1.0d) float f) {
    ...
    @VisibleForTesting
    public void setMockHideAnimationRunning(boolean z2, @FloatRange(from = 0.0d, m75to = 1.0d) float f) {
        this.mockHideAnimationRunning = z2;
        this.mockGrowFraction = f;
    }

    @VisibleForTesting
    public void setMockShowAnimationRunning(boolean z2, @FloatRange(from = 0.0d, m75to = 1.0d) float f) {
