...
public final class DvbDecoder extends SimpleSubtitleDecoder2 {
    ...
    public DvbDecoder(List<byte[]> list) {
        ...
        int i4 = i2 + 1;
        this.f5915n = new DvbParser(i3, (bArr[i4] & 255) | ((bArr[i2] & 255) << 8));
    }
    ...
    public p007b.p225i.p226a.p242c.p245b3.Subtitle mo2617j(byte[] r48, int r49, boolean r50) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p007b.p225i.p226a.p242c.p245b3.p247o.DvbDecoder.mo2617j(byte[], int, boolean):b.i.a.c.b3.g");
    }
}
