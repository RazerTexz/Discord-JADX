...
public final class C3991ba extends AbstractC4074i9 {
    ...
    */
    public final List<C3899y0> m5517t(String str, List<C3579a1> list, List<C3691i1> list2, Long l, Long l2) throws Throwable {
        ...
        this.f10577g = l;
        this.f10578h = l2;
        Iterator<C3579a1> it5 = list.iterator();
        while (true) {
            i = 1;
            i2 = 0;
            if (!it5.hasNext()) {
        ...
        if (z2) {
            ...
            try {
                ...
                c4040gM5686q.mo5726g().f11141f.m5862c("Error resetting session-scoped event counts. appId", C4157q3.m5788s(str6), e);
        ...
        if (z5 && z4) {
            ...
            Objects.requireNonNull(c4040gM5686q2);
            AnimatableValueParser.m583w(str7);
            ArrayMap arrayMap4 = new ArrayMap();
            try {
                try {
                    cursorQuery2 = c4040gM5686q2.m5640t().query("event_filters", new String[]{"audience_id", "data"}, "app_id=?", new String[]{str7}, null, null, null);
                    try {
                    } catch (SQLiteException e2) {
                        e = e2;
                        c4040gM5686q2.mo5726g().f11141f.m5862c("Database error querying filters. appId", C4157q3.m5788s(str7), e);
                ...
                while (true) {
                    try {
                        ...
                        if (c3730l0.m5037C()) {
                            ...
                            List arrayList = (List) arrayMap4.get(Integer.valueOf(i3));
                            if (arrayList == null) {
                                arrayList = new ArrayList();
                                arrayMap4.put(Integer.valueOf(i3), arrayList);
                            }
                            arrayList.add(c3730l0);
                        }
                    } catch (IOException e4) {
                        c4040gM5686q2.mo5726g().f11141f.m5862c("Failed to merge filter. appId", C4157q3.m5788s(str7), e4);
                    }
        ...
        String str8 = this.f10574d;
        c4040gM5686q3.m5684n();
        c4040gM5686q3.mo5848b();
        AnimatableValueParser.m583w(str8);
        try {
            try {
                cursorQuery = c4040gM5686q3.m5640t().query("audience_filter_values", new String[]{"audience_id", "current_results"}, "app_id=?", new String[]{str8}, null, null, null);
                try {
                } catch (SQLiteException e5) {
                    e = e5;
                    c4040gM5686q3.mo5726g().f11141f.m5862c("Database error querying filter results. appId", C4157q3.m5788s(str8), e);
                    if (!C3739l9.m5058b() || !c4040gM5686q3.f11202a.f11260h.m5532u(str8, C4142p.f11031F0)) {
                        if (cursorQuery != null) {
                            cursorQuery.close();
                        }
                        map2 = null;
                        ...
                        String str9 = "Skipping failed audience ID";
                        if (!list.isEmpty()) {
                        }
                        if (!list2.isEmpty()) {
                        }
        ...
        if (cursorQuery.moveToFirst()) {
            ...
            while (true) {
                ...
                try {
                    ...
                    arrayMap3 = arrayMap5;
                    c4040gM5686q3.mo5726g().f11141f.m5863d("Failed to merge filter results. appId, audienceId, error", C4157q3.m5788s(str8), Integer.valueOf(i5), e7);
                }
            ...
            String str92 = "Skipping failed audience ID";
            if (!list.isEmpty()) {
            }
            if (!list2.isEmpty()) {
            }
        ...
        if (C3739l9.m5058b() && c4040gM5686q3.f11202a.f11260h.m5532u(str8, C4142p.f11031F0)) {
            ...
            String str922 = "Skipping failed audience ID";
            if (!list.isEmpty()) {
            }
            if (!list2.isEmpty()) {
            }
        ...
        if (((!C3739l9.m5058b() && this.f11202a.f11260h.m5532u(this.f10574d, C4142p.f11031F0)) || map2 != null) && !map2.isEmpty()) {
            ...
            if (z2) {
                ...
                AnimatableValueParser.m583w(str10);
                ...
                if (map2.isEmpty()) {
                    ...
                    try {
                        cursorRawQuery = sQLiteDatabaseM5640t2.rawQuery("select audience_id, filter_id from event_filters where app_id = ? and session_scoped = 1 UNION select audience_id, filter_id from property_filters where app_id = ? and session_scoped = 1;", new String[]{str10, str10});
                        try {
                            if (cursorRawQuery.moveToFirst()) {
                                do {
                                    ...
                                    try {
                                        ...
                                        e = e8;
                                        c4040gM5686q4.mo5726g().f11141f.m5862c("Database error querying scoped filters. appId", C4157q3.m5788s(str10), e);
                                        if (C3739l9.m5058b() && c4040gM5686q4.f11202a.f11260h.m5532u(str10, C4142p.f11031F0)) {
            ...
            while (it7.hasNext()) {
                ...
                if (z5 && z4 && (list3 = (List) map6.get(Integer.valueOf(iIntValue2))) != null && this.f10578h != null && this.f10577g != null) {
        ...
        String str9222 = "Skipping failed audience ID";
        if (!list.isEmpty()) {
            ...
            while (it8.hasNext()) {
                ...
                if (c3579a1M5561a != null) {
                    ...
                    C4098l c4098lM5646z = c4040gM5686q5.m5646z(str11, next.m4533F());
                    if (c4098lM5646z == null) {
                        c4040gM5686q5.mo5726g().f11144i.m5862c("Event aggregate wasn't created during raw event logging. appId, event", C4157q3.m5788s(str11), c4040gM5686q5.m5865d().m5766u(strM4533F));
                        c4098l = new C4098l(str11, next.m4533F(), 1L, 1L, 1L, next.m4535H(), 0L, null, null, null, null);
                    } else {
                ...
                while (true) {
                    if (it11.hasNext()) {
                        ...
                        if (this.f10575e.contains(Integer.valueOf(iIntValue4))) {
                            mo5726g().f11149n.m5861b(str9222, Integer.valueOf(iIntValue4));
                            break;
                        }
        ...
        while (it.hasNext()) {
            ...
            try {
                if (c4040gM5686q6.m5640t().insertWithOnConflict("audience_filter_values", null, contentValues2, 5) == -1) {
                    c4040gM5686q6.mo5726g().f11141f.m5861b("Failed to insert filter results (got -1). appId", C4157q3.m5788s(str12));
                }
            } catch (SQLiteException e12) {
                e = e12;
                c4040gM5686q6.mo5726g().f11141f.m5862c("Error storing filter results. appId", C4157q3.m5788s(str12), e);
            }
        }
