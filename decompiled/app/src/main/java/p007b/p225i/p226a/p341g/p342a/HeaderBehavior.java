...
public abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    public class a implements Runnable {
        ...
        public a(CoordinatorLayout coordinatorLayout, V v) {
            this.f11527j = coordinatorLayout;
            this.f11528k = v;
        }
        ...
        public void run() {
            ...
            if (this.f11528k == null || (overScroller = HeaderBehavior.this.scroller) == null) {
                return;
            }
            if (!overScroller.computeScrollOffset()) {
                HeaderBehavior.this.onFlingFinished(this.f11527j, this.f11528k);
                return;
            }
            HeaderBehavior headerBehavior = HeaderBehavior.this;
            headerBehavior.setHeaderTopBottomOffset(this.f11527j, this.f11528k, headerBehavior.scroller.getCurrY());
            ViewCompat.postOnAnimation(this.f11528k, this);
        }
    }
