    ...
    public final int mo5055a(int i, byte[] bArr, int i2, int i3) {
        ...
        while (i2 < i3) {
            ...
            if (b2 < 0) {
                ...
                if (b2 < -16) {
                    if (i4 >= i3 - 1) {
                        return C3724k7.m5024d(bArr, i4, i3);
                    }
                    int i5 = i4 + 1;
                    byte b3 = bArr[i4];
            ...
            if (C3404f.m4302i2(b3)) {
                ...
                if (!(b3 < -32)) {
                    if (b3 < -16) {
                        ...
                        int i8 = i6 + 1;
                        C3404f.m4274b2(b3, bArr[i6], bArr[i8], cArr, i5);
                        i = i8 + 1;
                        i5++;
                    } else {
                        if (i6 >= i3 - 2) {
                        ...
                        byte b5 = bArr[i6];
                        int i10 = i9 + 1;
                        C3404f.m4270a2(b3, b5, bArr[i9], bArr[i10], cArr, i5);
                        i5 = i5 + 1 + 1;
                        i = i10 + 1;
                    }
                } else {
                    ...
                    C3404f.m4278c2(b3, bArr[i6], cArr, i5);
                    i = i6 + 1;
                    i5++;
                }
            }
