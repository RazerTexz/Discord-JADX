...
public final class DecodedBitStreamParser4 {
    ...
    */
    public static void m7091a(BitSource bitSource, StringBuilder sb, int i, boolean z2) throws FormatException {
        while (i > 1) {
            if (bitSource.m6948a() < 11) {
                throw FormatException.m9260a();
            }
            int iM6949b = bitSource.m6949b(11);
            sb.append(m7096f(iM6949b / 45));
            sb.append(m7096f(iM6949b % 45));
            i -= 2;
        }
        if (i == 1) {
            if (bitSource.m6948a() < 6) {
                throw FormatException.m9260a();
            }
            sb.append(m7096f(bitSource.m6949b(6)));
        }
        if (z2) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static void m7092b(BitSource bitSource, StringBuilder sb, int i, CharacterSetECI characterSetECI, Collection<byte[]> collection, Map<DecodeHintType, ?> map) throws FormatException {
        byte[] bArr;
        String strName;
        byte[] bArr2;
        if ((i << 3) > bitSource.m6948a()) {
            throw FormatException.m9260a();
        }
        byte[] bArr3 = new byte[i];
        int i2 = 0;
        for (int i3 = 0; i3 < i; i3++) {
            bArr3[i3] = (byte) bitSource.m6949b(8);
        }
        if (characterSetECI == null) {
            String str = StringUtils.f13290a;
            if (map != null) {
                ...
                if (map.containsKey(decodeHintType)) {
                    ...
                    if (!z5 || (!z3 && i8 + i9 + i10 <= 0)) {
                        if (!z6 || (!StringUtils.f13291b && i11 < 3 && i2 < 3)) {
                            if (!z2 || !z6) {
                                strName = z2 ? "ISO8859_1" : z6 ? "SJIS" : z5 ? "UTF8" : StringUtils.f13290a;
    ...
    public static void m7093c(BitSource bitSource, StringBuilder sb, int i) throws FormatException {
        ...
        int i2 = 0;
        while (i > 0) {
            int iM6949b = bitSource.m6949b(13);
    ...
    public static void m7095e(BitSource bitSource, StringBuilder sb, int i) throws FormatException {
        while (i >= 3) {
            ...
            int iM6949b = bitSource.m6949b(10);
            if (iM6949b >= 1000) {
                throw FormatException.m9260a();
            }
        ...
        if (i == 2) {
            if (bitSource.m6948a() < 7) {
                throw FormatException.m9260a();
            }
            int iM6949b2 = bitSource.m6949b(7);
            if (iM6949b2 >= 100) {
                throw FormatException.m9260a();
            }
        ...
        if (i == 1) {
            if (bitSource.m6948a() < 4) {
                throw FormatException.m9260a();
            }
            int iM6949b3 = bitSource.m6949b(4);
            if (iM6949b3 >= 10) {
                throw FormatException.m9260a();
            }
