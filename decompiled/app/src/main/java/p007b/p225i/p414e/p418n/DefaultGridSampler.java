...
public final class DefaultGridSampler {
    ...
    */
    public BitMatrix m6951a(BitMatrix bitMatrix, int i, int i2, PerspectiveTransform perspectiveTransform) throws NotFoundException {
        int i3 = i2;
        if (i <= 0 || i3 <= 0) {
        ...
        while (i5 < i3) {
            ...
            float f2 = perspectiveTransform.f13281a;
            float f3 = perspectiveTransform.f13282b;
            float f4 = perspectiveTransform.f13283c;
            float f5 = perspectiveTransform.f13284d;
            float f6 = perspectiveTransform.f13285e;
            float f7 = perspectiveTransform.f13286f;
            float f8 = perspectiveTransform.f13287g;
            float f9 = perspectiveTransform.f13288h;
            float f10 = perspectiveTransform.f13289i;
            ...
            int i9 = bitMatrix.f13229j;
            int i10 = bitMatrix.f13230k;
            boolean z2 = true;
            ...
            for (int i19 = 0; i19 < i4; i19 += 2) {
                try {
                    if (bitMatrix.m6942f((int) fArr[i19], (int) fArr[i19 + 1])) {
                        bitMatrix2.m6946j(i19 / 2, i5);
                    }
