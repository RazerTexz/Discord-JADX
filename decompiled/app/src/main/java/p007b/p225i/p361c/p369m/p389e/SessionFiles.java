...
public final class SessionFiles {
    ...
    public SessionFiles(b bVar, a aVar) {
        this.f12791a = bVar.f12797a;
        this.f12792b = bVar.f12798b;
        this.f12793c = bVar.f12799c;
        this.f12794d = bVar.f12800d;
        this.f12795e = bVar.f12801e;
        this.f12796f = bVar.f12802f;
    }
}
