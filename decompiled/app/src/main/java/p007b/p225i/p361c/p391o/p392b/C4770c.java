...
public final class C4770c extends C3267b<C3266a.d.c> {
    ...
    static {
        C3266a.g<C4771d> gVar = new C3266a.g<>();
        f12805j = gVar;
        C4769b c4769b = new C4769b();
        f12806k = c4769b;
        f12807l = new C3266a<>("DynamicLinks.API", c4769b, gVar);
    }

    public C4770c(@NonNull Context context) {
        super(context, f12807l, (C3266a.d) null, C3267b.a.f9335a);
    }
}
