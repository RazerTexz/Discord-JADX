    ...
    */
    public Unit invoke() {
        ...
        for (Payloads.Stream stream2 : arrayList) {
            ...
            arrayList2.add(new MediaSinkWantsManager.C5603b(mediaSinkWantsManager9, jIntValue, videoMetadata));
        }
        ...
        this.this$0.m8456d(arrayList2.isEmpty() ? Collections2.emptyList() : CollectionsJVM.listOf(String.valueOf(this.$userId)));
        return Unit.f27425a;
    }
}
