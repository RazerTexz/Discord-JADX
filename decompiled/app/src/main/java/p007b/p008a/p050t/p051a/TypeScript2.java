...
public final class TypeScript2 {
    ...
    public static final class a<RC> extends Node.C5655a<RC> {
        ...
        public a(String str, String str2, String str3, CodeStyleProviders<RC> codeStyleProviders) {
            ...
            nodeArr[1] = new StyleNode.C5657b(str2, codeStyleProviders.f1912g);
            nodeArr[2] = str3 != null ? new StyleNode.C5657b(str3, codeStyleProviders.f1912g) : null;
            super(nodeArr);
        }
    }
    ...
    public static final class d<RC> extends Node.C5655a<RC> {
        ...
        public d(String str, String str2, String str3, String str4, CodeStyleProviders<RC> codeStyleProviders) {
            ...
            nodeArr[0] = new StyleNode.C5657b(str, codeStyleProviders.f1906a);
            nodeArr[1] = str2 != null ? new StyleNode.C5657b(str2, codeStyleProviders.f1909d) : null;
            nodeArr[2] = new StyleNode.C5657b(str3, codeStyleProviders.f1910e);
            nodeArr[3] = new StyleNode.C5657b(str4, codeStyleProviders.f1906a);
            super(nodeArr);
        }
    }
}
