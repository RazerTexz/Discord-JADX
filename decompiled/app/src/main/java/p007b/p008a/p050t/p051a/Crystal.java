...
public final class Crystal<RC, S> extends Rule<RC, Node<RC>, S> {
    ...
    public Crystal(Crystal2.a.C13213a c13213a, CodeStyleProviders codeStyleProviders, Pattern pattern) {
        super(pattern);
        this.f1915a = codeStyleProviders;
    }
    ...
    public ParseSpec<RC, S> parse(Matcher matcher, Parser<RC, ? super Node<RC>, S> parser, S s2) {
        ...
        Crystal2.a aVar = new Crystal2.a(strGroup, strGroup2, strGroup3, this.f1915a);
