...
/* JADX INFO: renamed from: b.a.t.a.j, reason: use source file name */
/* JADX INFO: compiled from: JavaScript.kt */
/* JADX INFO: loaded from: classes.dex */
public final class JavaScript<RC, S> extends Rule<RC, Node<RC>, S> {

    /* JADX INFO: renamed from: a */
    public final /* synthetic */ CodeStyleProviders f1926a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public JavaScript(JavaScript2.a.C13214a c13214a, CodeStyleProviders codeStyleProviders, Pattern pattern) {
        super(pattern);
        this.f1926a = codeStyleProviders;
    }
    ...
    public ParseSpec<RC, S> parse(Matcher matcher, Parser<RC, ? super Node<RC>, S> parser, S s2) {
        ...
        JavaScript2.a aVar = new JavaScript2.a(strGroup, strGroup2, this.f1926a);
