...
public @interface JsonInclude {
    ...
    public static class b implements Serializable {
        ...
        static {
            ...
            f4436j = new b(aVar, aVar, null, null);
        }
        ...
        public Object readResolve() {
            ...
            return (aVar == aVar2 && this._contentInclusion == aVar2 && this._valueFilter == null && this._contentFilter == null) ? f4436j : this;
        }
        ...
        public String toString() {
            ...
            if (this._valueFilter != null) {
                ...
                outline.m860k0(this._valueFilter, sb, ".class");
            }
            if (this._contentFilter != null) {
                sb.append(",contentFilter=");
                outline.m860k0(this._contentFilter, sb, ".class");
            }
            sb.append(')');
            return sb.toString();
        }
