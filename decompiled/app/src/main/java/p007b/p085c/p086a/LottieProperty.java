...
public interface LottieProperty {
    ...
    static {
        ...
        f2432j = new PointF();
        f2433k = new ScaleXY();
        f2434l = Float.valueOf(1.0f);
        f2435m = fValueOf;
        f2436n = fValueOf;
        f2437o = Float.valueOf(2.0f);
        f2438p = Float.valueOf(3.0f);
        f2439q = Float.valueOf(4.0f);
        f2440r = Float.valueOf(5.0f);
        f2441s = Float.valueOf(6.0f);
        f2442t = Float.valueOf(7.0f);
        f2443u = Float.valueOf(8.0f);
        f2444v = Float.valueOf(9.0f);
        f2445w = Float.valueOf(10.0f);
        f2446x = Float.valueOf(11.0f);
        f2447y = Float.valueOf(12.0f);
        f2448z = Float.valueOf(12.1f);
        f2419A = Float.valueOf(13.0f);
        f2420B = Float.valueOf(14.0f);
        f2421C = new ColorFilter();
        f2422D = new Integer[0];
    }
}
