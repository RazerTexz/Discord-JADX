...
public class m {
            ...
            if (cCharAt != 'I') {
                ...
                if (cCharAt != 'Z') {
                    if (cCharAt == '[') {
                        ...
                        if (cCharAt2 != 'F') {
                            if (cCharAt2 == 'L') {
                                iN = vVar.n(str.substring(i2 + 1, str.length() - 1)) | 33554432;
                            } else if (cCharAt2 == 'S') {
                                iN = 16777228;
                            } else if (cCharAt2 == 'Z') {
                                iN = 16777225;
                    ...
                    if (aVarQ == null) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                int iN2 = vVar.n(strReplace);
                                v.a aVar = new v.a(vVar.k, 130, j, iR);
                                vVar.v(aVar);
                                aVar.g = iN2;
                                i3 = iN2;
    ...
    */
    public void b(int i, int i2, u uVar, v vVar) {
        switch (i) {
            case 0:
                return;
            case 1:
            ...
            case 18:
                ...
                switch (i3) {
                    ...
                    case 6:
                        ...
                        return;
                    case 7:
                        l(vVar.n("java/lang/Class") | 33554432);
                        return;
                    case 8:
                        l(vVar.n("java/lang/String") | 33554432);
                        return;
                    default:
                        switch (i3) {
                            case 15:
                                l(vVar.n("java/lang/invoke/MethodHandle") | 33554432);
                                return;
                            case 16:
                                l(vVar.n("java/lang/invoke/MethodType") | 33554432);
                                return;
                            case 17:
                                m(vVar, uVar.e);
                                return;
    ...
    */
    public final boolean h(v vVar, m mVar, int i) {
        ...
        while (i5 < length) {
            ...
            zG |= g(vVar, iE, mVar.f3711b, i5);
            i5++;
        }
        if (i > 0) {
            for (int i8 = 0; i8 < length; i8++) {
                zG |= g(vVar, this.f3711b[i8], mVar.f3711b, i8);
            }
            if (mVar.c == null) {
                mVar.c = new int[1];
                z2 = true;
            ...
            return g(vVar, i, mVar.c, 0) | z2;
        }
        int length3 = this.c.length + this.f;
        if (mVar.c == null) {
            mVar.c = new int[this.g + length3];
            zG2 = true;
        } else {
            zG2 = zG;
        }
        ...
        for (int i10 = 0; i10 < this.g; i10++) {
            ...
            zG2 |= g(vVar, iE3, mVar.c, length3 + i10);
        }
        return zG2;
    }
    ...
    public final void m(v vVar, String str) {
        int iD = d(vVar, str, str.charAt(0) == '(' ? str.indexOf(41) + 1 : 0);
        if (iD != 0) {
            l(iD);
