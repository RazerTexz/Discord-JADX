...
public class NetworkMonitorAutoDetect extends BroadcastReceiver implements NetworkChangeDetector {
    ...
    public class SimpleNetworkCallback extends ConnectivityManager.NetworkCallback {
        ...
        private void onNetworkChanged(Network network) {
            NetworkChangeDetector.NetworkInformation networkInformationAccess$300 = ConnectivityManagerDelegate.access$300(NetworkMonitorAutoDetect.access$200(NetworkMonitorAutoDetect.this), network);
            if (networkInformationAccess$300 != null) {
                NetworkMonitorAutoDetect.access$100(NetworkMonitorAutoDetect.this).onNetworkConnect(networkInformationAccess$300);
            }
        }
