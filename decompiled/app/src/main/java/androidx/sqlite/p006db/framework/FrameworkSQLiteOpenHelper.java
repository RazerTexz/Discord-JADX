...
public class FrameworkSQLiteOpenHelper implements SupportSQLiteOpenHelper {
    ...
    public static class OpenHelper extends SQLiteOpenHelper {
        ...
        public class C06191 implements DatabaseErrorHandler {
            ...
            public C06191(SupportSQLiteOpenHelper.Callback callback, FrameworkSQLiteDatabase[] frameworkSQLiteDatabaseArr) {
        ...
        public OpenHelper(Context context, String str, FrameworkSQLiteDatabase[] frameworkSQLiteDatabaseArr, SupportSQLiteOpenHelper.Callback callback) {
            super(context, str, null, callback.version, new C06191(callback, frameworkSQLiteDatabaseArr));
