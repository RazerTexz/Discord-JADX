...
public interface SupportSQLiteOpenHelper extends Closeable {
    ...
    public static abstract class Callback {
        ...
        public void onCorruption(@NonNull SupportSQLiteDatabase supportSQLiteDatabase) {
            StringBuilder sbM833U = outline.m833U("Corruption reported by sqlite on database: ");
            sbM833U.append(supportSQLiteDatabase.getPath());
        ...
        public void onDowngrade(@NonNull SupportSQLiteDatabase supportSQLiteDatabase, int i, int i2) {
            throw new SQLiteException(outline.m875s("Can't downgrade database from version ", i, " to ", i2));
        }
