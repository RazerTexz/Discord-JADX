...
public class FrameworkSQLiteDatabase implements SupportSQLiteDatabase {
    ...
    public class C06171 implements SQLiteDatabase.CursorFactory {
        ...
        public C06171(SupportSQLiteQuery supportSQLiteQuery) {
    ...
    public class C06182 implements SQLiteDatabase.CursorFactory {
        ...
        public C06182(SupportSQLiteQuery supportSQLiteQuery) {
            this.val$supportQuery = supportSQLiteQuery;
        }
    ...
    @Override // androidx.sqlite.p006db.SupportSQLiteDatabase
    ...
    public int delete(String str, String str2, Object[] objArr) {
        StringBuilder sbM836X = outline.m836X("DELETE FROM ", str);
        sbM836X.append(TextUtils.isEmpty(str2) ? "" : outline.m883w(" WHERE ", str2));
        SupportSQLiteStatement supportSQLiteStatementCompileStatement = compileStatement(sbM836X.toString());
    ...
    public Cursor query(SupportSQLiteQuery supportSQLiteQuery) {
        return this.mDelegate.rawQueryWithFactory(new C06171(supportSQLiteQuery), supportSQLiteQuery.getSql(), EMPTY_STRING_ARRAY, null);
    }

    @Override // androidx.sqlite.p006db.SupportSQLiteDatabase
    @RequiresApi(api = 16)
    public Cursor query(SupportSQLiteQuery supportSQLiteQuery, CancellationSignal cancellationSignal) {
        return this.mDelegate.rawQueryWithFactory(new C06182(supportSQLiteQuery), supportSQLiteQuery.getSql(), EMPTY_STRING_ARRAY, null, cancellationSignal);
    }
}
