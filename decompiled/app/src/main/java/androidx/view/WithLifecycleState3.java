    ...
    public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
        ...
        if (event != Lifecycle.Event.upTo(this.$state$inlined)) {
            if (event == Lifecycle.Event.ON_DESTROY) {
                ...
                cancellableContinuation.resumeWith(Result2.m11474constructorimpl(Result3.createFailure(withLifecycleState)));
                return;
            }
            return;
        }
        ...
        try {
            ...
            objM11474constructorimpl = Result2.m11474constructorimpl(function0.invoke());
        } catch (Throwable th) {
