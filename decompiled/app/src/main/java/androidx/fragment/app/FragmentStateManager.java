...
public class FragmentStateManager {
    ...
    public class ViewOnAttachStateChangeListenerC03911 implements View.OnAttachStateChangeListener {
        ...
        public ViewOnAttachStateChangeListenerC03911(View view) {
    ...
    public void activityCreated() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbM833U = outline.m833U("moveto ACTIVITY_CREATED: ");
            sbM833U.append(this.mFragment);
            Log.d("FragmentManager", sbM833U.toString());
        }
    ...
    public void attach() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbM833U = outline.m833U("moveto ATTACHED: ");
            sbM833U.append(this.mFragment);
            Log.d("FragmentManager", sbM833U.toString());
        }
        Fragment fragment = this.mFragment;
        ...
        if (fragment2 != null) {
            ...
            if (fragmentStateManager2 == null) {
                StringBuilder sbM833U2 = outline.m833U("Fragment ");
                sbM833U2.append(this.mFragment);
                sbM833U2.append(" declared target fragment ");
                sbM833U2.append(this.mFragment.mTarget);
                sbM833U2.append(" that does not belong to this FragmentManager!");
            ...
            if (str != null && (fragmentStateManager = this.mFragmentStore.getFragmentStateManager(str)) == null) {
                StringBuilder sbM833U3 = outline.m833U("Fragment ");
                sbM833U3.append(this.mFragment);
                sbM833U3.append(" declared target fragment ");
                throw new IllegalStateException(outline.m822J(sbM833U3, this.mFragment.mTargetWho, " that does not belong to this FragmentManager!"));
            }
        }
    ...
    public int computeExpectedState() {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            StringBuilder sbM834V = outline.m834V("computeExpectedState() of ", iMin, " for ");
            sbM834V.append(this.mFragment);
            Log.v("FragmentManager", sbM834V.toString());
        }
        return iMin;
    }
    ...
    public void create() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbM833U = outline.m833U("moveto CREATED: ");
            sbM833U.append(this.mFragment);
            Log.d("FragmentManager", sbM833U.toString());
        }
        Fragment fragment = this.mFragment;
    ...
    public void createView() {
        ...
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbM833U = outline.m833U("moveto CREATE_VIEW: ");
            sbM833U.append(this.mFragment);
            Log.d("FragmentManager", sbM833U.toString());
        }
        Fragment fragment = this.mFragment;
        ...
        if (viewGroup2 != null) {
            ...
            if (i != 0) {
                if (i == -1) {
                    StringBuilder sbM833U2 = outline.m833U("Cannot create fragment ");
                    sbM833U2.append(this.mFragment);
                    sbM833U2.append(" for a container view with no id");
                ...
                if (viewGroup == null) {
                    ...
                    if (!fragment3.mRestored) {
                        ...
                        StringBuilder sbM833U3 = outline.m833U("No view found for id 0x");
                        sbM833U3.append(Integer.toHexString(this.mFragment.mContainerId));
                        sbM833U3.append(" (");
                        sbM833U3.append(resourceName);
                        sbM833U3.append(") for fragment ");
                        sbM833U3.append(this.mFragment);
                        throw new IllegalArgumentException(sbM833U3.toString());
                    }
                }
            }
        }
        ...
        if (view != null) {
            ...
            Fragment fragment5 = this.mFragment;
            fragment5.mView.setTag(C0344R.id.fragment_container_view_tag, fragment5);
            if (viewGroup != null) {
                addViewToContainer();
            }
            ...
            if (ViewCompat.isAttachedToWindow(this.mFragment.mView)) {
                ...
                view2.addOnAttachStateChangeListener(new ViewOnAttachStateChangeListenerC03911(view2));
            }
    ...
    public void destroy() {
        ...
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbM833U = outline.m833U("movefrom CREATED: ");
            sbM833U.append(this.mFragment);
            Log.d("FragmentManager", sbM833U.toString());
        }
        Fragment fragment = this.mFragment;
    ...
    public void destroyFragmentView() {
        View view;
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbM833U = outline.m833U("movefrom CREATE_VIEW: ");
            sbM833U.append(this.mFragment);
            Log.d("FragmentManager", sbM833U.toString());
        }
        Fragment fragment = this.mFragment;
    ...
    public void detach() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbM833U = outline.m833U("movefrom ATTACHED: ");
            sbM833U.append(this.mFragment);
            Log.d("FragmentManager", sbM833U.toString());
        }
        ...
        if (z2 || this.mFragmentStore.getNonConfig().shouldDestroy(this.mFragment)) {
            if (FragmentManager.isLoggingEnabled(3)) {
                StringBuilder sbM833U2 = outline.m833U("initState called for fragment: ");
                sbM833U2.append(this.mFragment);
                Log.d("FragmentManager", sbM833U2.toString());
            }
    ...
    public void ensureInflatedView() {
        ...
        if (fragment.mFromLayout && fragment.mInLayout && !fragment.mPerformedCreateView) {
            ...
            if (view != null) {
                view.setSaveFromParentEnabled(false);
                Fragment fragment3 = this.mFragment;
                fragment3.mView.setTag(C0344R.id.fragment_container_view_tag, fragment3);
                Fragment fragment4 = this.mFragment;
    ...
    public void moveToExpectedState() {
        ...
        if (this.mMovingToState) {
            if (FragmentManager.isLoggingEnabled(2)) {
                StringBuilder sbM833U = outline.m833U("Ignoring re-entrant call to moveToExpectedState() for ");
                sbM833U.append(getFragment());
    ...
    public void pause() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbM833U = outline.m833U("movefrom RESUMED: ");
            sbM833U.append(this.mFragment);
            Log.d("FragmentManager", sbM833U.toString());
        }
    ...
    public void resume() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbM833U = outline.m833U("moveto RESUMED: ");
            sbM833U.append(this.mFragment);
            Log.d("FragmentManager", sbM833U.toString());
        }
    ...
    public void start() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbM833U = outline.m833U("moveto STARTED: ");
            sbM833U.append(this.mFragment);
            Log.d("FragmentManager", sbM833U.toString());
        }
    ...
    public void stop() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbM833U = outline.m833U("movefrom STARTED: ");
            sbM833U.append(this.mFragment);
            Log.d("FragmentManager", sbM833U.toString());
        }
