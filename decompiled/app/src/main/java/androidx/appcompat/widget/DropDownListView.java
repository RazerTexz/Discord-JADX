...
public class DropDownListView extends ListView {
    ...
    public int measureHeightOfChildrenCompat(int i, int i2, int i3, int i4, int i5) {
        ...
        while (i6 < count) {
            ...
            view.measure(i, i9 > 0 ? View.MeasureSpec.makeMeasureSpec(i9, BasicMeasure.EXACTLY) : View.MeasureSpec.makeMeasureSpec(0, 0));
            view.forceLayout();
            if (i6 > 0) {
    ...
    public boolean onForwardedEvent(MotionEvent motionEvent, int i) throws IllegalArgumentException {
        ...
        if (iFindPointerIndex >= 0) {
            ...
            if (iPointToPosition == -1) {
                ...
                setPressedItem(childAt, iPointToPosition, x2, y2);
                if (actionMasked == 1) {
