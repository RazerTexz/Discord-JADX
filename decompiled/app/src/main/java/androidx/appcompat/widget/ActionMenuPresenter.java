...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (z2 || i7 + i6 > i4)) {
            i4--;
        }
        int i9 = i4 - i6;
        ...
        while (i11 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                boolean z4 = (i9 > 0 || z3) && i5 > 0 && (!actionMenuPresenter.mStrictWidthLimit || iMeasureChildForCells > 0);
                boolean z5 = z4;
                i2 = size;
                if (z4) {
                    ...
                    z4 = z6 & (!actionMenuPresenter.mStrictWidthLimit ? i5 + i12 <= 0 : i5 < 0);
                }
                if (z4 && groupId2 != 0) {
