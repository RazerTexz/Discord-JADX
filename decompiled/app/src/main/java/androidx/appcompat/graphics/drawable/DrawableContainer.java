        ...
        if (drawable2 != null) {
            ...
            if (j != 0) {
                if (j <= jUptimeMillis) {
                    ...
                    drawable2.setAlpha(((255 - (((int) ((j - jUptimeMillis) * 255)) / this.mDrawableContainerState.mEnterFadeDuration)) * this.mAlpha) / 255);
                    z3 = true;
                }
            }
            ...
            if (drawable == null) {
                ...
                if (j2 != 0) {
                    if (j2 <= jUptimeMillis) {
                        ...
                        drawable.setAlpha(((((int) ((j2 - jUptimeMillis) * 255)) / this.mDrawableContainerState.mExitFadeDuration) * this.mAlpha) / 255);
                    }
                }
                if (z2 && z4) {
