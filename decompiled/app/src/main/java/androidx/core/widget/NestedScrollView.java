...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            StringBuilder sbM833U = outline.m833U("HorizontalScrollView.SavedState{");
            sbM833U.append(Integer.toHexString(System.identityHashCode(this)));
            sbM833U.append(" scrollPosition=");
            return outline.m814B(sbM833U, this.scrollPosition, "}");
        }
    ...
    */
    private View findFocusableViewInBounds(boolean z2, int i, int i2) {
    ...
    private boolean scrollAndFocus(int i, int i2, int i3) {
        ...
        boolean z2 = false;
        boolean z3 = i == 33;
        View viewFindFocusableViewInBounds = findFocusableViewInBounds(z3, i2, i3);
        if (viewFindFocusableViewInBounds == null) {
            viewFindFocusableViewInBounds = this;
        }
        if (i2 < scrollY || i3 > i4) {
            doScrollY(z3 ? i2 - scrollY : i3 - i4);
            z2 = true;
        }
    ...
    */
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                ...
                if (iFindPointerIndex == -1) {
                    StringBuilder sbM833U = outline.m833U("Invalid pointerId=");
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public boolean overScrollByCompat(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, boolean z2) {
        boolean z3;
        boolean z4;
        int overScrollMode = getOverScrollMode();
    ...
    private void smoothScrollBy(int i, int i2, int i3, boolean z2) {
        if (getChildCount() == 0) {
            return;
        }
    ...
    public void smoothScrollTo(int i, int i2, boolean z2) {
        smoothScrollTo(i, i2, 250, z2);
    }
    ...
    public void smoothScrollTo(int i, int i2, int i3, boolean z2) {
        smoothScrollBy(i - getScrollX(), i2 - getScrollY(), i3, z2);
    }
