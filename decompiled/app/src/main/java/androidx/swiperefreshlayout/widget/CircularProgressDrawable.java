...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    public class C06221 implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            CircularProgressDrawable.this.updateRingColor(fFloatValue, this.val$ring);
            CircularProgressDrawable.this.applyTransformation(fFloatValue, this.val$ring, false);
    ...
    public void applyTransformation(float f, Ring ring, boolean z2) {
        float interpolation;
