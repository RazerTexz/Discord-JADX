...
public class VerticalWidgetRun extends WidgetRun {
    ...
    public String toString() {
        StringBuilder sbM833U = outline.m833U("VerticalRun ");
    ...
    public void update(Dependency dependency) {
        ...
        if (dimensionDependency.readyToSolve && !dimensionDependency.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            } else if (i == 3 && constraintWidget2.horizontalRun.dimension.resolved) {
        ...
        if (dependencyNode.readyToSolve) {
            ...
            if (dependencyNode2.readyToSolve) {
                ...
                if (this.dimension.resolved && this.start.targets.size() > 0 && this.end.targets.size() > 0) {
                    ...
                    int i7 = dependencyNode7.value + this.start.margin;
                    int i8 = dependencyNode8.value + this.end.margin;
                    float verticalBiasPercent = this.widget.getVerticalBiasPercent();
                    if (dependencyNode7 == dependencyNode8) {
                        i7 = dependencyNode7.value;
                        i8 = dependencyNode8.value;
                        verticalBiasPercent = 0.5f;
                    }
                    this.start.resolve((int) ((((i8 - i7) - this.dimension.value) * verticalBiasPercent) + i7 + 0.5f));
