        ...
        while (true) {
            ...
            if (z6) {
                ...
                if (!z2) {
                    ...
                    if (i6 != i3) {
                        int horizontalBiasPercent = (int) ((i8 * (i == 0 ? head.getHorizontalBiasPercent() : head.getVerticalBiasPercent())) + margin + 0.5f);
                        if (i == 0) {
                    ...
                    if (z2) {
                        ...
                        while (!z7) {
                            ...
                            if (constraintWidget5.getVisibility() == 8) {
                                if (i == 0) {
                                    constraintWidget5.setFinalHorizontal(margin3, margin3);
                                    horizontalSolvingPass(constraintWidget5, constraintWidgetContainer.getMeasurer(), zIsRtl);
                                } else {
                                    constraintWidget5.setFinalVertical(margin3, margin3);
                                    verticalSolvingPass(constraintWidget5, constraintWidgetContainer.getMeasurer());
                                }
                                linearSystem2 = linearSystem;
                                z5 = false;
                            } else {
                                int margin4 = constraintWidget5.mListAnchors[i2].getMargin() + margin3;
                                if (i == 0) {
                                    constraintWidget5.setFinalHorizontal(margin4, constraintWidget5.getWidth() + margin4);
                                    horizontalSolvingPass(constraintWidget5, constraintWidgetContainer.getMeasurer(), zIsRtl);
                                    height = constraintWidget5.getWidth();
                                } else {
                                    constraintWidget5.setFinalVertical(margin4, constraintWidget5.getHeight() + margin4);
                                    verticalSolvingPass(constraintWidget5, constraintWidgetContainer.getMeasurer());
                                    height = constraintWidget5.getHeight();
                                }
                                margin3 = constraintWidget5.mListAnchors[i4].getMargin() + height + margin4 + i8;
                                z5 = false;
                                linearSystem2 = linearSystem;
                            }
                            ...
                            if (constraintAnchor5 != null) {
                                ...
                                if (constraintAnchorArr[i2].mTarget == null || constraintAnchorArr[i2].mTarget.mOwner != constraintWidget5) {
                ...
                margin2 = constraintWidget2.mListAnchors[i4].getMargin() + (i == 0 ? constraintWidget2.getWidth() : constraintWidget2.getHeight()) + constraintWidget2.mListAnchors[i2].getMargin() + margin2;
                i7++;
