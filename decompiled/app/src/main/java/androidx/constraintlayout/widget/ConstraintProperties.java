        ...
        switch (i) {
            case 1:
                if (i3 == 1) {
                    ...
                    if (i3 != 2) {
                        throw new IllegalArgumentException(outline.m822J(outline.m833U("Left to "), sideToString(i3), " undefined"));
                    }
            ...
            case 2:
                if (i3 == 1) {
                    ...
                    if (i3 != 2) {
                        throw new IllegalArgumentException(outline.m822J(outline.m833U("right to "), sideToString(i3), " undefined"));
                    }
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(outline.m822J(sb, sideToString(i3), " unknown"));
        }
    }
