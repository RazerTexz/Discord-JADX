            ...
            if (view.getVisibility() == 8) {
                ...
                if (i17 < 0 || mode == 0) {
                    ...
                    if (behavior == null) {
                        ...
                        int iMax2 = Math.max(i11, view.getMeasuredWidth() + i12 + ((ViewGroup.MarginLayoutParams) layoutParams3).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams3).rightMargin);
                        int iMax3 = Math.max(i6, view.getMeasuredHeight() + i13 + ((ViewGroup.MarginLayoutParams) layoutParams3).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams3).bottomMargin);
                    ...
                    int iMax22 = Math.max(i11, view.getMeasuredWidth() + i12 + ((ViewGroup.MarginLayoutParams) layoutParams32).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams32).rightMargin);
                    int iMax32 = Math.max(i6, view.getMeasuredHeight() + i13 + ((ViewGroup.MarginLayoutParams) layoutParams32).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams32).bottomMargin);
                    iCombineMeasuredStates = View.combineMeasuredStates(i9, view.getMeasuredState());
                    i14 = iMax22;
                    i15 = iMax32;
                }
                ...
                if (z3) {
                    ...
                    int iMax222 = Math.max(i11, view.getMeasuredWidth() + i12 + ((ViewGroup.MarginLayoutParams) layoutParams322).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams322).rightMargin);
                    int iMax322 = Math.max(i6, view.getMeasuredHeight() + i13 + ((ViewGroup.MarginLayoutParams) layoutParams322).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams322).bottomMargin);
                    iCombineMeasuredStates = View.combineMeasuredStates(i9, view.getMeasuredState());
                    i14 = iMax222;
                    i15 = iMax322;
                }
