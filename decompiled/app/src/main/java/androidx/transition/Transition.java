...
public abstract class Transition implements Cloneable {
    ...
    private ArrayList<Integer> excludeId(ArrayList<Integer> arrayList, int i, boolean z2) {
        return i > 0 ? z2 ? ArrayListManager.add(arrayList, Integer.valueOf(i)) : ArrayListManager.remove(arrayList, Integer.valueOf(i)) : arrayList;
    }

    private static <T> ArrayList<T> excludeObject(ArrayList<T> arrayList, T t, boolean z2) {
        return t != null ? z2 ? ArrayListManager.add(arrayList, t) : ArrayListManager.remove(arrayList, t) : arrayList;
    }
