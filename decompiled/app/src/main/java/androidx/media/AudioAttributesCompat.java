...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    public static int toVolumeStreamType(boolean z2, int i, int i2) {
        if ((i & 1) == 1) {
            return z2 ? 1 : 7;
        }
        if ((i & 4) == 4) {
        ...
        switch (i2) {
            ...
            default:
                if (z2) {
                    throw new IllegalArgumentException(outline.m873r("Unknown usage value ", i2, " in audio attributes"));
                }
                return 3;
        }
    }
    ...
    public static String usageToString(int i) {
        switch (i) {
            ...
            case 15:
            default:
                return outline.m871q("unknown usage ", i);
            case 16:
