...
public class ByteBufferInput extends Input {
    ...
    @Override // com.esotericsoftware.kryo.p502io.Input, java.io.InputStream, java.io.Closeable, java.lang.AutoCloseable
    ...
    @Override // com.esotericsoftware.kryo.p502io.Input, java.io.InputStream
    ...
    public final int require(int i) throws KryoException {
        ...
        if (i > i4) {
            StringBuilder sbM833U = outline.m833U("Buffer too small: capacity: ");
            sbM833U.append(this.capacity);
