...
public class Output extends OutputStream {
    ...
    public boolean require(int i) throws KryoException {
        ...
        if (i > this.maxCapacity) {
            StringBuilder sbM833U = outline.m833U("Buffer overflow. Max capacity: ");
            sbM833U.append(this.maxCapacity);
        ...
        while (true) {
            ...
            if (i2 == i3) {
                StringBuilder sbM833U2 = outline.m833U("Buffer overflow. Available: ");
                sbM833U2.append(this.capacity - this.position);
                sbM833U2.append(", required: ");
                sbM833U2.append(i);
                throw new KryoException(sbM833U2.toString());
            }
            if (i2 == 0) {
                this.capacity = 1;
            }
    ...
    public void setBuffer(byte[] bArr, int i) {
        ...
        if (bArr.length > i && i != -1) {
            StringBuilder sbM833U = outline.m833U("buffer has length: ");
            sbM833U.append(bArr.length);
            sbM833U.append(" cannot be greater than maxBufferSize: ");
            sbM833U.append(i);
            throw new IllegalArgumentException(sbM833U.toString());
        }
        if (i < -1) {
            throw new IllegalArgumentException(outline.m871q("maxBufferSize cannot be < -1: ", i));
        }
        this.buffer = bArr;
        if (i == -1) {
    ...
    public Output(int i, int i2) {
        if (i > i2 && i2 != -1) {
            throw new IllegalArgumentException(outline.m875s("bufferSize: ", i, " cannot be greater than maxBufferSize: ", i2));
        }
        if (i2 >= -1) {
            this.capacity = i;
        ...
        throw new IllegalArgumentException(outline.m871q("maxBufferSize cannot be < -1: ", i2));
    }
