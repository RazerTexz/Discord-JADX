...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public class ViewOnClickListenerC10847a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (BottomNavigationMenuView.access$100(BottomNavigationMenuView.this).performItemAction(itemData, BottomNavigationMenuView.access$000(BottomNavigationMenuView.this), 0)) {
                return;
            }
