...
public abstract class StickerCategoryItem implements DiffKeyProvider {
    ...
    public static final /* data */ class GuildItem extends StickerCategoryItem {
        ...
        public boolean equals(Object other) {
            ...
            return m.areEqual(this.guild, guildItem.guild) && m.areEqual(this.stickers, guildItem.stickers) && m.areEqual(getCategoryRange(), guildItem.getCategoryRange()) && getIsSelected() == guildItem.getIsSelected();
        }
    ...
    public static final /* data */ class PackItem extends StickerCategoryItem {
        ...
        public boolean equals(Object other) {
            ...
            return m.areEqual(this.pack, packItem.pack) && m.areEqual(getCategoryRange(), packItem.getCategoryRange()) && getIsSelected() == packItem.getIsSelected();
        }
    ...
    public static final /* data */ class RecentItem extends StickerCategoryItem {
        ...
        public boolean equals(Object other) {
            ...
            return getIsSelected() == recentItem.getIsSelected() && m.areEqual(getCategoryRange(), recentItem.getCategoryRange());
        }
