...
public abstract class WidgetMobileReports2 implements Parcelable {
    ...
    public static final /* data */ class DirectoryServer extends WidgetMobileReports2 {
        ...
        public int hashCode() {
            return C0002b.m3a(getChannelId()) + ((C0002b.m3a(this.hubId) + (C0002b.m3a(this.guildId) * 31)) * 31);
        }

        public String toString() {
            StringBuilder sbM833U = outline.m833U("DirectoryServer(guildId=");
    ...
    public static final /* data */ class GuildScheduledEvent extends WidgetMobileReports2 {
        ...
        public int hashCode() {
            return C0002b.m3a(this.eventId) + (C0002b.m3a(this.guildId) * 31);
        }

        public String toString() {
            StringBuilder sbM833U = outline.m833U("GuildScheduledEvent(guildId=");
            sbM833U.append(this.guildId);
            sbM833U.append(", eventId=");
            return outline.m815C(sbM833U, this.eventId, ")");
        }
    ...
    public static final /* data */ class Message extends WidgetMobileReports2 {
        ...
        public int hashCode() {
            return C0002b.m3a(getChannelId()) + (C0002b.m3a(this.messageId) * 31);
        }

        public String toString() {
            StringBuilder sbM833U = outline.m833U("Message(messageId=");
    ...
    public static final /* data */ class StageChannel extends WidgetMobileReports2 {
        ...
        public int hashCode() {
            return C0002b.m3a(getChannelId());
        }

        public String toString() {
            StringBuilder sbM833U = outline.m833U("StageChannel(channelId=");
            sbM833U.append(getChannelId());
            sbM833U.append(")");
            return sbM833U.toString();
        }
