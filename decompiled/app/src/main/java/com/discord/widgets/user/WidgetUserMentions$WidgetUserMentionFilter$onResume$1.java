...
public final class WidgetUserMentions$WidgetUserMentionFilter$onResume$1<T> implements Action1<Boolean> {
    ...
    public final void call2(Boolean bool) {
        ...
        Intrinsics3.checkNotNullExpressionValue(WidgetUserMentions.WidgetUserMentionFilter.access$getBinding$p(this.this$0).d, "binding.userMentionsFilterThisServer");
