...
public final class WidgetAuthRegisterAccountInformation$validationManager$2 extends o implements Function0<ValidationManager> {
    ...
    public static final class AnonymousClass1 implements InputValidator<CheckBox> {
        ...
        public CharSequence getErrorMessage2(CheckBox view) {
            ...
            if ((WidgetAuthRegisterAccountInformation.access$isConsentRequired$p(WidgetAuthRegisterAccountInformation$validationManager$2.this.this$0) && view.isChecked()) || !WidgetAuthRegisterAccountInformation.access$isConsentRequired$p(WidgetAuthRegisterAccountInformation$validationManager$2.this.this$0)) {
                return null;
            }
