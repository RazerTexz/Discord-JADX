...
public final class StickerPickerViewModel$Companion$observeStoreState$1<T, R> implements b<StoreChannelsSelected.ResolvedSelectedChannel, Observable<? extends StickerPickerViewModel.StoreState>> {
    ...
    public static final class AnonymousClass1<T, R> implements b<LinkedHashMap<Long, Guild>, LinkedHashMap<Long, Guild>> {
        ...
        public final LinkedHashMap<Long, Guild> call2(LinkedHashMap<Long, Guild> linkedHashMap) {
            ...
            for (Map.Entry<Long, Guild> entry : linkedHashMap.entrySet()) {
                ...
                if (!m.areEqual(key, this.$currentGuild != null ? Long.valueOf(r4.getId()) : null)) {
