...
public final class WidgetEmojiPickerSheet extends WidgetExpressionPickerSheet implements EmojiPickerListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        fragmentTransactionBeginTransaction.replace(C5419R.id.emoji_sheet_emoji_picker_content, widgetEmojiPicker3, widgetEmojiPicker4.getClass().getSimpleName()).runOnCommit(new RunnableC78402()).commit();
    }
