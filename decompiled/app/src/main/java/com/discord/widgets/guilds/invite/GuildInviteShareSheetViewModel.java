...
public final class GuildInviteShareSheetViewModel extends AppViewModel<ViewState> {
    ...
    public static final class Companion {
        ...
        private final Observable<StoreState> observeStoreState(long guildId, InviteSuggestionsManager inviteSuggestionsManager, StoreInviteSettings storeInviteSettings, StoreUser storeUser, StoreChannels storeChannels, StoreGuilds storeGuilds, StoreStageInstances storeStageInstances) {
            ...
            Intrinsics3.checkNotNullExpressionValue(observableM11069e, "Observable.combineLatest…      )\n        }\n      }");
    ...
    public static abstract class StoreState {
        ...
        public static final /* data */ class Valid extends StoreState {
            ...
            public String toString() {
                StringBuilder sbM833U = outline.m833U("Valid(inviteSettings=");
                ...
                return outline.m825M(sbM833U, this.guildStageInstances, ")");
            }
        }
    ...
    public static final class C86241 extends Lambda implements Function1<MessageQueue4, Unit> {
        ...
        public final void invoke2(MessageQueue4 messageQueue4) {
            ...
            if (messageQueue4 instanceof MessageQueue4.Success) {
                ...
                GuildInviteShareSheetViewModel.access$updateSentInvites(GuildInviteShareSheetViewModel.this, Maps6.plus(sentInvites, MapsJVM.mapOf(Tuples.m10073to(this.$inviteLink, _Sets.plus(setEmptySet, Long.valueOf(success.getMessage().getChannelId()))))));
            }
        }
    }
    ...
    private final ViewState createViewState(String searchQuery, Map<String, ? extends Set<Long>> sentInvites, StoreState.Valid storeState, GuildInvite generatedInvite) {
        ...
        if (!StringsJVM.isBlank(searchQuery)) {
            ...
            for (Object obj : inviteSuggestions) {
                ...
                if (inviteSuggestion instanceof InviteSuggestion.ChannelItem) {
                    zContains = Strings4.contains((CharSequence) ChannelUtils.m7679c(((InviteSuggestion.ChannelItem) inviteSuggestion).getChannel()), (CharSequence) searchQuery, true);
                } else {
        ...
        while (true) {
            ...
            arrayList3.add(Tuples.m10073to(lValueOf, Long.valueOf(channel.getId())));
        }
    ...
    */
    private final void handleStoreState(StoreState storeState) {
        ...
        if (Intrinsics3.areEqual(storeState, StoreState.Invalid.INSTANCE)) {
            ...
            StringBuilder sbM833U = outline.m833U("invalid StoreState in ");
    ...
    public static final /* data */ class ViewState {
        ...
        public String toString() {
            StringBuilder sbM833U = outline.m833U("ViewState(invite=");
    ...
    public GuildInviteShareSheetViewModel(Long l, long j, StoreInviteSettings storeInviteSettings, StoreAnalytics storeAnalytics, StoreMessages storeMessages, TargetChannelSelector targetChannelSelector, Logger logger, Observable<StoreState> observable) {
        ...
        ObservableExtensionsKt.appSubscribe$default(ObservableExtensionsKt.ui$default(ObservableExtensionsKt.computationLatest(observable), this, null, 2, null), GuildInviteShareSheetViewModel.class, (Context) null, (Function1) null, (Function1) null, (Function0) null, (Function0) null, new C86201(), 62, (Object) null);
        Observable<String> observableM11110p = this.searchQuerySubject.m11110p(250L, TimeUnit.MILLISECONDS);
        Intrinsics3.checkNotNullExpressionValue(observableM11110p, "searchQuerySubject\n     …0, TimeUnit.MILLISECONDS)");
        ObservableExtensionsKt.appSubscribe$default(ObservableExtensionsKt.ui$default(observableM11110p, this, null, 2, null), GuildInviteShareSheetViewModel.class, (Context) null, (Function1) null, (Function1) null, (Function0) null, (Function0) null, new C86212(), 62, (Object) null);
    }
}
