...
public final class WidgetServerSettingsEmojis$Model$Companion$get$1<T, R> implements b<WidgetServerSettingsEmojis.Model.Permission, Observable<? extends WidgetServerSettingsEmojis.Model>> {
    ...
    public final Observable<? extends WidgetServerSettingsEmojis.Model> call2(WidgetServerSettingsEmojis.Model.Permission permission) {
        return (permission == null || !permission.getCanManage()) ? new k(null) : WidgetServerSettingsEmojis.Model.Companion.access$getGuildEmojis(WidgetServerSettingsEmojis.Model.INSTANCE, permission.getGuild());
    }
}
