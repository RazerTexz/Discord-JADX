...
public final class WidgetBanUser extends AppDialog {
    ...
    public static final class ViewOnClickListenerC101863 implements View.OnClickListener {
        ...
        public static final class AnonymousClass1 extends Lambda implements Function1<Void, Unit> {
            ...
            public final void invoke2(Void r7) {
                ...
                AppToast.m170h(context, context2 != null ? FormatUtils.m216h(context2, C5419R.string.ban_user_confirmed, new Object[]{ViewOnClickListenerC101863.this.$userName}, null, 4) : null, 0, null, 12);
                WidgetBanUser.this.dismiss();
            }
        }

        public ViewOnClickListenerC101863(long j, long j2, String str) {
            this.$guildId = j;
            this.$userId = j2;
            this.$userName = str;
        }
        ...
        public final void onClick(View view) {
            ...
            switch (((CheckedSetting) listAccess$getHistoryRadios$p.get(radioManagerAccess$getDeleteHistoryRadioManager$p != null ? radioManagerAccess$getDeleteHistoryRadioManager$p.m8551b() : 0)).getId()) {
            ...
            TextInputLayout textInputLayout = WidgetBanUser.access$getBinding$p(WidgetBanUser.this).f15730h;
    ...
    public void onViewBound(View view) {
        ...
        for (CheckedSetting checkedSetting : getHistoryRadios()) {
            checkedSetting.m8527e(new WidgetBanUser3(checkedSetting, this));
        }
        ...
        FormatUtils.m222n(textView, C5419R.string.ban_user_title, new Object[]{string}, null, 4);
        TextView textView2 = getBinding().f15724b;
        Intrinsics3.checkNotNullExpressionValue(textView2, "binding.banUserBody");
        FormatUtils.m222n(textView2, C5419R.string.ban_user_body, new Object[]{string}, null, 4);
        getBinding().f15725c.setOnClickListener(new ViewOnClickListenerC101852());
        getBinding().f15726d.setOnClickListener(new ViewOnClickListenerC101863(j, j2, string));
    }
}
