...
public final class WidgetServerSettingsAuditLog2<T1, T2, T3, T4, T5, T6, R> implements Func6<StoreAuditLog.AuditLogState, Guild, Map<Long, ? extends Channel>, Map<Long, ? extends User>, Map<Long, ? extends GuildRole>, Map<Long, ? extends GuildMember>, WidgetServerSettingsAuditLog.Model> {
    ...
    public WidgetServerSettingsAuditLog2(long j, Context context) {
        this.$guildId = j;
            ...
            if (targetType2 != null) {
                switch (targetType2) {
                    ...
                    case USER:
                        ...
                        charSequenceAccess$resolveChannelName = user != null ? UserUtils.getUserNameWithDiscriminator$default(UserUtils.INSTANCE, user, null, null, 3, null) : null;
                        break;
                    case ROLE:
        ...
        while (true) {
            if (!it.hasNext()) {
                ...
                if (user4 == null || (string = UserUtils.getUserNameWithDiscriminator$default(UserUtils.INSTANCE, user4, null, null, 3, null)) == null) {
                    string = this.$context.getString(C5419R.string.guild_settings_filter_all_users);
            ...
            if (map14 != null) {
                ...
                StringBuilder sbM833U = outline.m833U(str2);
