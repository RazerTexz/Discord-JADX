...
public final class WidgetCreateChannel$RolesAdapter$RoleListItem$onConfigure$1 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        Intrinsics3.checkNotNullExpressionValue(WidgetCreateChannel.RolesAdapter.RoleListItem.access$getBinding$p(this.this$0).f15400b, "binding.roleItemCheckedSetting");
