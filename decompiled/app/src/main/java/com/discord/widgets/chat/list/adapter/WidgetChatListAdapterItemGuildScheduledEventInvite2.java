...
public final class WidgetChatListAdapterItemGuildScheduledEventInvite2 extends Lambda implements Function0<WidgetChatListAdapterItemGuildScheduledEventInvite.Model> {
    ...
    public final WidgetChatListAdapterItemGuildScheduledEventInvite.Model invoke() {
        ...
        if (channel != null) {
            ...
            channelM7629a = Channel.m7629a(channel, null, 0, guild2 != null ? guild2.getId() : 0L, null, 0L, 0L, 0L, null, null, 0, null, 0, 0, null, 0L, 0L, null, false, 0L, null, 0, null, null, null, null, null, null, null, null, null, null, null, -5);
        } else {
            channelM7629a = null;
        }
        ...
        Channel channel2 = channelM7629a != null ? this.$channelStore.getChannel(channelM7629a.getId()) : null;
        ...
        return new WidgetChatListAdapterItemGuildScheduledEventInvite.Model(invite, z2, zIsMeRsvpedToEvent, guildScheduledEvent, channel2, guild, creatorUserGuildMember$default, Long.valueOf(this.$voiceChannelSelectedStore.getSelectedVoiceChannelId()), channelM7629a != null ? PermissionUtils.can(Permission.CONNECT, this.$permissionStore.getPermissionsByChannel().get(Long.valueOf(channelM7629a.getId()))) : false, GuildScheduledEventUtilities.Companion.canShareEvent$default(GuildScheduledEventUtilities.INSTANCE, this.$item.getGuildScheduledEvent().getChannelId(), this.$item.getGuildScheduledEvent().getGuildId(), this.$channelStore, this.$guildStore, null, null, 48, null));
    }
}
