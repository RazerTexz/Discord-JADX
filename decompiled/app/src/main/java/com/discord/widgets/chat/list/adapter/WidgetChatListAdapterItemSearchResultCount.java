...
public final class WidgetChatListAdapterItemSearchResultCount extends WidgetChatListItem {
    ...
    public void onConfigure(int position, ChatListEntry data) {
        ...
        textView.setText(StringResourceUtils.getQuantityString(resources, outline.m821I(this.binding.f16273b, "binding.resultCount", "binding.resultCount.context"), C5419R.plurals.total_results_count, totalResults, Integer.valueOf(totalResults)));
    }
}
