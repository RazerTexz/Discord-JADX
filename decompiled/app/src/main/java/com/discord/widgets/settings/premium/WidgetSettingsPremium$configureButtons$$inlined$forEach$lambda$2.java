...
public final class WidgetSettingsPremium$configureButtons$$inlined$forEach$lambda$2 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        WidgetChoosePlan.ViewType viewType = m.areEqual(this.$button, WidgetSettingsPremium.access$getBinding$p(this.this$0).t.f76b) ? WidgetChoosePlan.ViewType.BUY_PREMIUM_TIER_1 : WidgetChoosePlan.ViewType.BUY_PREMIUM_TIER_2;
        ModelSubscription modelSubscription = this.$premiumSubscription$inlined;
        WidgetChoosePlan.Companion.launch$default(companion, contextRequireContext, null, viewType, modelSubscription != null ? modelSubscription.getPaymentGatewayPlanId() : null, new Traits.Location(Traits.Location.Page.USER_SETTINGS, WidgetSettingsPremium.access$getAnalyticsLocationSection$p(this.this$0), Traits.Location.Obj.BUTTON_CTA, Traits.Location.ObjType.BUY, null, 16, null), Traits.Subscription.INSTANCE.withGatewayPlanId(m.areEqual(this.$button, WidgetSettingsPremium.access$getBinding$p(this.this$0).t.f76b) ? GooglePlaySku.PREMIUM_TIER_1_MONTHLY.getSkuName() : GooglePlaySku.PREMIUM_TIER_2_MONTHLY.getSkuName()), 2, null);
    }
}
