...
public final class SettingsUserProfileViewModel extends d0<ViewState> {
    ...
    public static final class AnonymousClass1 extends o implements Function1<MeUser, Unit> {
        ...
        public final void invoke2(MeUser meUser) {
            StoreUserProfile.fetchProfile$default(SettingsUserProfileViewModel.access$getStoreUserProfile$p(SettingsUserProfileViewModel.this), meUser.getId(), SettingsUserProfileViewModel.access$getGuildId$p(SettingsUserProfileViewModel.this), false, null, 12, null);
        }
    }
    ...
    public static final class AnonymousClass2 extends o implements Function1<StoreState, Unit> {
        ...
        public final void invoke2(StoreState storeState) {
            ...
            SettingsUserProfileViewModel.access$handleStoreState(settingsUserProfileViewModel, storeState);
        }
    }
            ...
            public Loaded(MeUser meUser, Guild guild, GuildMember guildMember, UserProfile userProfile, NullSerializable<String> nullSerializable, NullSerializable<String> nullSerializable2, NullSerializable<String> nullSerializable3, String str, String str2, List<Node<MessageRenderContext>> list, boolean z2, boolean z3) {
                ...
                if (nullSerializable != null || nullSerializable2 != null || nullSerializable3 != null) {
                    ...
                    if (!(!m.areEqual(str2, bio))) {
                        if (guildMember != null) {
                            if (!m.areEqual(guildMember.getNick() == null ? "" : r13, str == null ? "" : str)) {
                            }
                        }
                        z4 = false;
                    }
    ...
    public static final class AnonymousClass1<T, R> implements b<ViewState, UserProfileHeaderViewModel.ViewState> {
    ...
    public static final class AnonymousClass1 extends o implements Function1<Error, Unit> {
        ...
        public final void invoke2(Error error) {
            ...
            PublishSubject publishSubjectAccess$getEventSubject$p = SettingsUserProfileViewModel.access$getEventSubject$p(SettingsUserProfileViewModel.this);
    ...
    public static final class AnonymousClass2 extends o implements Function1<com.discord.api.guildmember.GuildMember, Unit> {
        ...
        public final void invoke2(com.discord.api.guildmember.GuildMember guildMember) {
            ...
            SettingsUserProfileViewModel.access$getStoreGuilds$p(SettingsUserProfileViewModel.this).handleGuildMember(com.discord.api.guildmember.GuildMember.a(guildMember, SettingsUserProfileViewModel.access$getGuildId$p(SettingsUserProfileViewModel.this).longValue(), null, null, null, null, null, false, null, null, null, null, null, null, 8190), SettingsUserProfileViewModel.access$getGuildId$p(SettingsUserProfileViewModel.this).longValue(), true);
            SettingsUserProfileViewModel.access$updateViewState(SettingsUserProfileViewModel.this, ViewState.Loaded.copy$default(this.$viewState, null, null, GuildMember.Companion.from$default(GuildMember.INSTANCE, guildMember, SettingsUserProfileViewModel.access$getGuildId$p(SettingsUserProfileViewModel.this).longValue(), null, SettingsUserProfileViewModel.access$getStoreGuilds$p(SettingsUserProfileViewModel.this), 4, null), null, null, null, null, null, null, null, false, false, 3979, null));
            PublishSubject publishSubjectAccess$getEventSubject$p = SettingsUserProfileViewModel.access$getEventSubject$p(SettingsUserProfileViewModel.this);
            publishSubjectAccess$getEventSubject$p.k.onNext(Event.UserUpdateRequestCompleted.INSTANCE);
        }
    }
    ...
    public static final class AnonymousClass2 extends o implements Function1<User, Unit> {
        ...
        public final void invoke2(User user) {
            ...
            SettingsUserProfileViewModel.access$getStoreUserProfile$p(SettingsUserProfileViewModel.this).updateUser(user);
            SettingsUserProfileViewModel.access$updateViewState(SettingsUserProfileViewModel.this, ViewState.Loaded.copy$default(this.$viewState, MeUser.INSTANCE.merge(this.$meUser, user), null, null, null, null, null, null, null, null, null, false, false, 3982, null));
            PublishSubject publishSubjectAccess$getEventSubject$p = SettingsUserProfileViewModel.access$getEventSubject$p(SettingsUserProfileViewModel.this);
            publishSubjectAccess$getEventSubject$p.k.onNext(Event.UserUpdateRequestCompleted.INSTANCE);
        }
    }
    ...
    public static final /* synthetic */ void access$handleStoreState(SettingsUserProfileViewModel settingsUserProfileViewModel, StoreState storeState) {
        settingsUserProfileViewModel.handleStoreState(storeState);
    }

    public static final /* synthetic */ void access$updateViewState(SettingsUserProfileViewModel settingsUserProfileViewModel, ViewState viewState) {
        settingsUserProfileViewModel.updateViewState(viewState);
    }
    ...
    public SettingsUserProfileViewModel(Long l, StoreUser storeUser, StoreUserProfile storeUserProfile, StoreGuilds storeGuilds, RestAPI restAPI, Parser<MessageRenderContext, Node<MessageRenderContext>, MessageParseState> parser, Observable<StoreState> observable) {
        ...
        ObservableExtensionsKt.appSubscribe$default(ObservableExtensionsKt.ui$default(observableZ, this, null, 2, null), SettingsUserProfileViewModel.class, (Context) null, (Function1) null, (Function1) null, (Function0) null, (Function0) null, new AnonymousClass1(), 62, (Object) null);
        Observable<StoreState> observableR = observable.r();
        m.checkNotNullExpressionValue(observableR, "storeStateObservable\n   …  .distinctUntilChanged()");
        ObservableExtensionsKt.appSubscribe$default(ObservableExtensionsKt.ui$default(ObservableExtensionsKt.computationLatest(observableR), this, null, 2, null), SettingsUserProfileViewModel.class, (Context) null, (Function1) null, (Function1) null, (Function0) null, (Function0) null, new AnonymousClass2(), 62, (Object) null);
