...
public final class WidgetModeratorStartStage$guildId$2 extends o implements Function0<Long> {
    public final /* synthetic */ WidgetModeratorStartStage this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetModeratorStartStage$guildId$2(WidgetModeratorStartStage widgetModeratorStartStage) {
        super(0);
