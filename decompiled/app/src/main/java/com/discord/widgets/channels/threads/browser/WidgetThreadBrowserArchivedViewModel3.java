...
public final class WidgetThreadBrowserArchivedViewModel3<T, R> implements Func1<Tuples2<? extends ArchivedThreadsStore.ThreadListingState, ? extends Channel>, Observable<? extends WidgetThreadBrowserArchivedViewModel.StoreState>> {
    ...
    public final Observable<? extends WidgetThreadBrowserArchivedViewModel.StoreState> call2(Tuples2<? extends ArchivedThreadsStore.ThreadListingState, Channel> tuples2) {
        ...
        Observable<R> observableM11083G = this.$storeGuilds.observeComputed().m11083G(new AnonymousClass1());
        Intrinsics3.checkNotNullExpressionValue(observableM11083G, "storeGuilds\n            …[guildId] ?: emptyMap() }");
        Observable<T> observableM11112r = ObservableExtensionsKt.leadingEdgeThrottle(observableM11083G, 1L, TimeUnit.SECONDS).m11112r();
        ...
        return Observable.m11073h(observableM11112r, observableObserveGuild, scalarSynchronousObservable, storePermissions.observePermissionsForChannel(lValueOf.longValue()), new AnonymousClass2(threadListingStateComponent1, channelComponent2));
    }
}
