...
public final class WidgetSettingsDeveloper extends AppFragment {
    ...
    public static final class AnonymousClass1<T, R> implements b<Map<String, ? extends Integer>, List<? extends 1.1>> {
    ...
    public static final class AnonymousClass2 extends d0.z.d.o implements Function1<List<? extends AnonymousClass1.1.1>, Unit> {
        public AnonymousClass2() {
            super(1);
        }
    ...
    public static final class AnonymousClass1 extends d0.z.d.o implements Function0<ItemTouchHelper> {
        ...
        public static final class C04571 extends SwipeableItemTouchHelper {
            public final /* synthetic */ SwipeableItemTouchHelper.SwipeRevealConfiguration $deleteConfig;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C04571(SwipeableItemTouchHelper.SwipeRevealConfiguration swipeRevealConfiguration, SwipeableItemTouchHelper.SwipeRevealConfiguration swipeRevealConfiguration2, SwipeableItemTouchHelper.SwipeRevealConfiguration swipeRevealConfiguration3) {
        ...
        public final ItemTouchHelper invoke() {
            ...
            return new ItemTouchHelper(new C04571(swipeRevealConfiguration, swipeRevealConfiguration, swipeRevealConfiguration));
        }
    }
    ...
    public static final class AnonymousClass2<T, R> implements b<HashMap<String, Long>, List<? extends Pair<? extends String, ? extends Long>>> {
    ...
    public static final class AnonymousClass3 extends d0.z.d.o implements Function1<List<? extends Pair<? extends String, ? extends Long>>, Unit> {
