...
public final class WidgetChatListAdapterEventsHandler$UserReactionHandler$commitReactionRemove$1 extends o implements Function1<MessageReactionUpdate, Unit> {
    public final /* synthetic */ WidgetChatListAdapterEventsHandler.UserReactionHandler this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetChatListAdapterEventsHandler$UserReactionHandler$commitReactionRemove$1(WidgetChatListAdapterEventsHandler.UserReactionHandler userReactionHandler) {
        super(1);
    ...
    public final void invoke2(MessageReactionUpdate messageReactionUpdate) {
        ...
        WidgetChatListAdapterEventsHandler.UserReactionHandler.access$getStoreMessages$p(this.this$0).handleReactionUpdate(d0.t.m.listOf(messageReactionUpdate), false);
    }
}
