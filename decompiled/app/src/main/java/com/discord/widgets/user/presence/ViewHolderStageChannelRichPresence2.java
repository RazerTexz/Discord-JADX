...
public final class ViewHolderStageChannelRichPresence2 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        StageChannelJoinHelper.lurkAndJoinStage$default(StageChannelJoinHelper.INSTANCE, outline.m885x(view, "it", "it.context"), this.$fragmentManager$inlined, ViewCoroutineScope.getCoroutineScope(this.$this_apply), this.$partyDerivedData$inlined.getGuildId(), this.$partyDerivedData$inlined.getChannelId(), true, null, null, null, 448, null);
    }
}
