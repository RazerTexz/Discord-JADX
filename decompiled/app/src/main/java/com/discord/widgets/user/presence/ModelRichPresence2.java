...
public final class ModelRichPresence2<T, R> implements Func1<Presence, Observable<? extends ModelRichPresence>> {
    ...
    public final Observable<? extends ModelRichPresence> call2(Presence presence) {
        ...
        return (primaryActivity == null || (applicationId = primaryActivity.getApplicationId()) == null) ? new ScalarSynchronousObservable(new ModelRichPresence(presence, null, 2, null)) : StoreStream.INSTANCE.getApplication().observeApplication(Long.valueOf(applicationId.longValue())).m11083G(new ModelRichPresence3(presence));
    }
}
