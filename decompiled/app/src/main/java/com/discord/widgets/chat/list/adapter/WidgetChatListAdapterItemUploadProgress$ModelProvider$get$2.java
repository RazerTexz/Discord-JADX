...
public final class WidgetChatListAdapterItemUploadProgress$ModelProvider$get$2<T, R> implements b<StoreMessageUploads.MessageUploadState, Observable<? extends WidgetChatListAdapterItemUploadProgress.Model>> {
    ...
    public final Observable<? extends WidgetChatListAdapterItemUploadProgress.Model> call2(StoreMessageUploads.MessageUploadState messageUploadState) {
        ...
        return uploads.size() == 1 ? WidgetChatListAdapterItemUploadProgress.ModelProvider.access$getSingleUploadObservable(WidgetChatListAdapterItemUploadProgress.ModelProvider.INSTANCE, (SendUtils.FileUpload) u.first((List) uploads), this.$throttleIntervalMs) : uploads.size() <= 3 ? WidgetChatListAdapterItemUploadProgress.ModelProvider.access$getFewUploadsObservable(WidgetChatListAdapterItemUploadProgress.ModelProvider.INSTANCE, uploads, this.$throttleIntervalMs) : WidgetChatListAdapterItemUploadProgress.ModelProvider.access$getManyUploadsObservable(WidgetChatListAdapterItemUploadProgress.ModelProvider.INSTANCE, uploads, this.$throttleIntervalMs);
    }
}
