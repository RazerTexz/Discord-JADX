    ...
    public final WidgetChatListAdapterItemStageInvite.Model invoke() {
        ...
        if (channelRoles == null || listAccess$speakersFromLocalStore == null) {
            if ((stageInstanceState != null ? stageInstanceState.getStageInstance() : null) == null) {
                num = null;
                return new WidgetChatListAdapterItemStageInvite.Model(this.$item.getInvite(), id2, user, channel3, !reducedMotionEnabled, stageInstance2, listAccess$speakersFromLocalStore == null ? listAccess$speakersFromLocalStore : n.emptyList(), num);
            }
