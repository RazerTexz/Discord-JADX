...
/* JADX INFO: renamed from: com.discord.widgets.settings.account.WidgetSettingsAccountBackupCodes$showPasswordModal$$inlined$let$lambda$2, reason: use source file name */
