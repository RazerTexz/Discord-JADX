...
public final class GifSearchViewModel$Companion$observeQueryState$2<T, R> implements b<String, Observable<? extends GifSearchViewModel.StoreState>> {
    ...
    public static final class AnonymousClass2<T1, T2, R> implements Func2<List<? extends ModelGif>, List<? extends String>, GifSearchViewModel.StoreState.SearchResults> {
        ...
        public final GifSearchViewModel.StoreState.SearchResults call2(List<ModelGif> list, List<String> list2) {
            ...
            return new GifSearchViewModel.StoreState.SearchResults(list, list2, GifSearchViewModel$Companion$observeQueryState$2.this.$trendingSearchTerms, this.$query);
        }
    }
    ...
    public final Observable<? extends GifSearchViewModel.StoreState> call2(String str) {
        ...
        return str.length() == 0 ? new k(new GifSearchViewModel.StoreState.TrendingSearchTermsResults(this.$trendingSearchTerms)) : Observable.j(this.$storeGifPicker.observeGifsForSearchQuery(str).y(AnonymousClass1.INSTANCE), this.$storeGifPicker.observeSuggestedSearchTerms(str), new AnonymousClass2(str));
    }
}
