...
/* JADX INFO: renamed from: com.discord.widgets.channels.list.WidgetChannelListModel$Companion$guildListBuilder$$inlined$forEach$lambda$3 */
/* JADX INFO: compiled from: WidgetChannelListModel.kt */
/* JADX INFO: loaded from: classes2.dex */
public final class C7415x4d8eedc3 extends Lambda implements Function0<ChannelListItemTextChannel> {
    ...
    public final ChannelListItemTextChannel invoke() {
        boolean z2 = this.$canSeeGuildRoleSubscriptions$inlined && ChannelUtils.m7696t(this.$channel, this.$guild$inlined.getGuild(), this.$guild$inlined.getEveryoneRole(), this.$guild$inlined.getGuildRoles());
        boolean zHasAccess = PermissionUtils.INSTANCE.hasAccess(this.$channel, this.$permissions);
        if (!zHasAccess && !z2) {
            return null;
        }
        WidgetChannelListModel.Companion.TextLikeChannelData textLikeChannelDataInvoke$default = C7413x4d8eedc1.invoke$default(this.$getTextLikeChannelData$1, this.$channel, this.$muted, null, 4, null);
