...
public final class WidgetChatListAdapterItemEmbed8 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        if (externalOpenUrl != null) {
            UriHandler.handleOrUntrusted(outline.m885x(view, "view", "view.context"), externalOpenUrl, this.$embed$inlined.getTitle());
        } else {
            WidgetMedia.INSTANCE.launch(outline.m885x(view, "view", "view.context"), this.$embed$inlined);
        }
    }
}
