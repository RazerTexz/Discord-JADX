...
public final class WidgetServerSettingsOverview extends AppFragment {
    ...
    public static final class AfkBottomSheet extends AppBottomSheet {
        public static final /* synthetic */ KProperty[] $$delegatedProperties = {a.d0(AfkBottomSheet.class, "binding", "getBinding()Lcom/discord/databinding/WidgetServerSettingsOverviewAfkTimeoutBinding;", 0)};
    ...
    public static final class Model {
        ...
        public static final class Companion {
            ...
            public final Observable<Model> get(long guildId) {
                Observable<R> observableY = StoreStream.INSTANCE.getGuilds().observeGuild(guildId).Y(new WidgetServerSettingsOverview$Model$Companion$get$1(guildId));
    ...
    public static final class AnonymousClass1 implements View.OnClickListener {
        ...
        public final void onClick(View view) {
            WidgetGuildBoost.INSTANCE.create(a.x(view, "it", "it.context"), this.$guild.getId());
        }
    }
    ...
    public static final class AnonymousClass1 implements View.OnClickListener {
        ...
        public static final class C04311<T> implements Action1<String> {
            public C04311() {
            }
        ...
        @Override // android.view.View.OnClickListener
        public final void onClick(View view) {
            WidgetServerSettingsOverview.access$setImageSelectedResult$p(WidgetServerSettingsOverview.this, new C04311());
    ...
    public static final class AnonymousClass1 extends o implements Function1<RenderContext, Unit> {
        ...
        public static final class C04321 extends o implements Function1<View, Unit> {
            public C04321() {
                super(1);
            }
        ...
        public final void invoke2(RenderContext renderContext) {
            ...
            renderContext.b("tierStatus", new C04321());
        }
    }
    ...
    public static final class AnonymousClass1 implements View.OnClickListener {
        ...
        public static final class C04331<T> implements Action1<String> {
            public C04331() {
            }
        ...
        @Override // android.view.View.OnClickListener
        public final void onClick(View view) {
            WidgetServerSettingsOverview.access$setImageSelectedResult$p(WidgetServerSettingsOverview.this, new C04331());
            WidgetServerSettingsOverview.this.openMediaChooser();
        }
    }
    ...
    public static final class AnonymousClass1 extends o implements Function1<RenderContext, Unit> {
        ...
        public static final class C04341 extends o implements Function1<View, Unit> {
            public C04341() {
                super(1);
            }
        ...
        public final void invoke2(RenderContext renderContext) {
            m.checkNotNullParameter(renderContext, "$receiver");
            renderContext.b("tierInfo", new C04341());
        }
    }
    ...
    public static final class AnonymousClass2 implements View.OnClickListener {
        ...
        public final void onClick(View view) {
            ...
            afkBottomSheet.show(childFragmentManager, a0.getOrCreateKotlinClass(AfkBottomSheet.class).toString());
        }
    }
    ...
    public static final class AnonymousClass4 implements View.OnClickListener {
        ...
        public final void onClick(View view) {
            ...
            m.checkNotNullExpressionValue(WidgetServerSettingsOverview.access$getBinding$p(WidgetServerSettingsOverview.this).g.d, "binding.systemChannel.systemChannelJoin");
    ...
    public static final class AnonymousClass5 implements View.OnClickListener {
        ...
        public final void onClick(View view) {
            ...
            m.checkNotNullExpressionValue(WidgetServerSettingsOverview.access$getBinding$p(WidgetServerSettingsOverview.this).g.c, "binding.systemChannel.systemChannelBoost");
            checkedSetting.setChecked(!r1.isChecked());
            StatefulViews statefulViewsAccess$getState$p = WidgetServerSettingsOverview.access$getState$p(WidgetServerSettingsOverview.this);
    ...
    public static final class AnonymousClass6 implements View.OnClickListener {
        ...
        public final void onClick(View view) {
            ...
            m.checkNotNullExpressionValue(WidgetServerSettingsOverview.access$getBinding$p(WidgetServerSettingsOverview.this).g.e, "binding.systemChannel.systemChannelJoinReplies");
            checkedSetting.setChecked(!r1.isChecked());
            StatefulViews statefulViewsAccess$getState$p = WidgetServerSettingsOverview.access$getState$p(WidgetServerSettingsOverview.this);
    ...
    public static final class AnonymousClass7 implements View.OnClickListener {
        ...
        public static final class AnonymousClass1<T, R> implements b<com.discord.api.guild.Guild, Observable<? extends Guild>> {
        ...
        public static final class AnonymousClass2<T, R> implements b<Guild, Observable<? extends Model>> {
        ...
        public final void onClick(View view) {
            ...
            ObservableExtensionsKt.ui$default(ObservableExtensionsKt.takeSingleUntilTimeout$default(observableY, 0L, false, 3, null), WidgetServerSettingsOverview.this, null, 2, null).k(b.a.d.o.i(new AnonymousClass3(), WidgetServerSettingsOverview.this));
        }
    }
    ...
    private final void configureAnimatedBannerUpsellSection(Guild guild) {
        ...
        b.a.k.b.n(textView, zCanHaveAnimatedBanner ? R.string.guild_settings_animated_banner_try_it : R.string.guild_settings_animated_banner_upsell, new Object[0], null, 4);
    ...
    private final void configureBannerSection(Guild guild) throws Resources.NotFoundException {
        ...
        if (!guild.canHaveBanner()) {
            ...
            b.a.k.b.m(textView, R.string.guild_settings_overview_tier_info, new Object[]{ExifInterface.GPS_MEASUREMENT_2D, "tierStatus"}, new AnonymousClass1(guild));
            ...
            ViewExtensions.setTextAndVisibilityBy(textView3, b.a.k.b.k(this, R.string.guild_settings_overview_boost_unlock, new Object[]{quantityString}, null, 4));
        ...
        b.a.k.b.n(textView6, R.string.guild_settings_overview_boost_unlocked, new Object[]{ExifInterface.GPS_MEASUREMENT_2D}, null, 4);
    ...
    private final void configureChannel(TextView textView, Channel channel, @StringRes int i, @DrawableRes int i2) {
        ...
        if (channel != null) {
            ...
            charSequenceH = b.a.k.b.h(context, i, new Object[0], null, 4);
        }
    ...
    private final void configureRadios(int stateId, int activeRadioIndex, boolean isAboveNotifyAllSize, boolean stateShouldUpdate) {
        ...
        for (Object obj : n.listOf((Object[]) new CheckedSetting[]{getBinding().d.f147b, getBinding().d.c})) {
            ...
            if (isAboveNotifyAllSize && checkedSetting.getId() == R.id.server_settings_overview_notification_all) {
                checkedSetting.h(b.a.k.b.k(this, R.string.guild_settings_default_notifications_large_guild_notify_all, new Object[0], null, 4), false);
            } else {
    ...
    private final void configureSplashSection(Guild guild) throws Resources.NotFoundException {
        ...
        if (!guild.canHaveSplash()) {
            ...
            b.a.k.b.m(textView, R.string.guild_settings_overview_tier_info, new Object[]{"1", "tierInfo"}, new AnonymousClass1(guild));
        ...
        b.a.k.b.n(textView6, R.string.guild_settings_overview_boost_unlocked, new Object[]{"1"}, null, 4);
    ...
    private final void configureUI(Model model) throws Resources.NotFoundException {
        ...
        textView2.setText((CharSequence) statefulViews3.get(textView3.getId(), Model.INSTANCE.getAfkTimeout(a.I(getBinding().f2582b.d, "binding.afk.afkTimeout", "binding.afk.afkTimeout.context"), model.getGuild().getAfkTimeout())));
    ...
    public void onViewBound(View view) {
        ...
        b.a.k.b.n(textView4, R.string.minimum_size, new Object[]{"128", "128"}, null, 4);
        ...
        f fVar = f.a;
        b.a.k.b.n(linkifiedTextView, R.string.guild_settings_splash_recommend, new Object[]{fVar.a(4415841146391L, null)}, null, 4);
        ...
        b.a.k.b.n(linkifiedTextView2, R.string.guild_settings_banner_recommend, new Object[]{fVar.a(360028716472L, null)}, null, 4);
        getBinding().e.hide();
