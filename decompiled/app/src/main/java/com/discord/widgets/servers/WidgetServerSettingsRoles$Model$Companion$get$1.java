...
public final class WidgetServerSettingsRoles$Model$Companion$get$1<T, R> implements b<MeUser, Observable<? extends WidgetServerSettingsRoles.Model>> {
    ...
    public static final class AnonymousClass2<T1, T2, T3, T4, R> implements Func4<Guild, GuildMember, Long, Map<Long, ? extends GuildRole>, WidgetServerSettingsRoles.Model> {
        ...
        public final WidgetServerSettingsRoles.Model call2(Guild guild, GuildMember guildMember, Long l, Map<Long, GuildRole> map) {
            ...
            arrayList2.add(new WidgetServerSettingsRolesAdapter.HelpItem(WidgetServerSettingsRoles$Model$Companion$get$1.this.$guildId));
            for (GuildRole guildRole : arrayList) {
                arrayList2.add(new WidgetServerSettingsRolesAdapter.RoleItem(guildRole, WidgetServerSettingsRoles$Model$Companion$get$1.this.$guildId == guildRole.getId(), (guild.getOwnerId() == this.$meUser.getId() || RoleUtils.rankIsHigher(highestRole, guildRole)) ? false : true, zCan, zIsElevated, WidgetServerSettingsRoles$Model$Companion$get$1.this.$guildId));
            }
            return new WidgetServerSettingsRoles.Model(WidgetServerSettingsRoles$Model$Companion$get$1.this.$guildId, guild.getName(), zCan, zIsElevated, arrayList2);
        }
    }
