...
public final class WidgetServerSettingsCreatorMonetizationOnboarding extends AppFragment {
    ...
    public static final class AnonymousClass4 extends o implements Function1<RenderContext, Unit> {
        ...
        public static final class AnonymousClass1 extends o implements Function1<Hook, Unit> {
            ...
            public final void invoke2(Hook hook) {
                ...
                hook.styles.add(new FontColorSpan(ColorCompatKt.getColor(WidgetServerSettingsCreatorMonetizationOnboarding.this, R.color.status_red_500)));
            }
    ...
    public static final class AnonymousClass1 extends o implements Function1<ServerSettingsCreatorMonetizationOnboardingViewModel.ViewState, Unit> {
        public AnonymousClass1() {
            super(1);
        }
    ...
    public static final class AnonymousClass2 extends o implements Function1<ServerSettingsCreatorMonetizationOnboardingViewModel.Event, Unit> {
    ...
    */
    private final void configureCreateRequestState(ServerSettingsCreatorMonetizationOnboardingViewModel.ViewState.CreateRequest viewState) {
        ...
        if (rejectionCooldown$default != null) {
            b.m(textView, R.string.guild_role_subscription_settings_enable_request_rejected, new Object[0], new WidgetServerSettingsCreatorMonetizationOnboarding$configureCreateRequestState$2$1(rejectionCooldown$default));
        }
        ...
        b.m(linkifiedTextView, R.string.guild_role_subscription_settings_enable_requirements_description, new Object[0], AnonymousClass3.INSTANCE);
        ...
        if (viewState.getRequirements().getSufficient()) {
            ...
            b.n(textView2, R.string.guild_role_subscription_settings_eligible_message, new Object[0], null, 4);
        } else {
            ...
            b.m(textView3, R.string.guild_role_subscription_settings_not_eligible_message, new Object[0], new AnonymousClass4());
        }
    ...
    private final List<EligibilityChecklistView.Requirement> toChecklistRequirements(CreatorMonetizationEligibilityRequirements creatorMonetizationEligibilityRequirements) {
        ...
        requirementArr[0] = new EligibilityChecklistView.Requirement(string, b.e(this, R.string.guild_role_subscription_settings_eligibility_requirement_members_description, new Object[0], new AnonymousClass1(creatorMonetizationEligibilityRequirements)), creatorMonetizationEligibilityRequirements.getSize());
        ...
        requirementArr[1] = new EligibilityChecklistView.Requirement(string2, b.e(this, R.string.guild_role_subscription_settings_eligibility_requirement_age_description, new Object[0], new AnonymousClass2(creatorMonetizationEligibilityRequirements)), creatorMonetizationEligibilityRequirements.getAge());
        ...
        requirementArr[2] = new EligibilityChecklistView.Requirement(string3, b.e(this, R.string.guild_role_subscription_settings_eligibility_requirement_violations_description, new Object[0], AnonymousClass3.INSTANCE), creatorMonetizationEligibilityRequirements.getSafeEnvironment());
        ...
        return n.listOf((Object[]) requirementArr);
    }
