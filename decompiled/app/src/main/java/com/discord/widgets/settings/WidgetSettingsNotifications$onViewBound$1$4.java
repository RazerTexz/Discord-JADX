...
public final class WidgetSettingsNotifications$onViewBound$1$4<T> implements Action1<Boolean> {
    public final /* synthetic */ StoreNotifications $this_apply;

    public WidgetSettingsNotifications$onViewBound$1$4(StoreNotifications storeNotifications) {
