...
public final class C7413x4d8eedc1 extends Lambda implements Function3<Channel, Boolean, Boolean, WidgetChannelListModel.Companion.TextLikeChannelData> {
    ...
    public static final class AnonymousClass1 extends Lambda implements Function0<Boolean> {
        ...
        public final boolean invoke2() {
            ...
            Channel channel2 = C7413x4d8eedc1.this.$selectedChannel$inlined;
            boolean z2 = (channel2 != null && (id2 > channel2.getId() ? 1 : (id2 == channel2.getId() ? 0 : -1)) == 0) || C7413x4d8eedc1.this.$areAnyChildThreadsSelected$5$inlined.invoke(channel.getId());
            boolean zContains = C7413x4d8eedc1.this.$collapsedCategories$inlined.contains(Long.valueOf(channel.getParentId()));
            return C7413x4d8eedc1.this.$hiddenChannelsIds$inlined.contains(Long.valueOf(this.$textChannel.getParentId())) || (!z2 && !C7413x4d8eedc1.this.$isThreadUnread$3$inlined.invoke2(this.$textChannel) && (zContains || Intrinsics3.areEqual(this.$isParentMuted, Boolean.TRUE)));
        }
    }
    ...
    public static final class AnonymousClass2 extends Lambda implements Function0<Boolean> {
        ...
        public final boolean invoke2() {
            ...
            boolean z3 = !(this.$channelSelected || C7413x4d8eedc1.this.$areAnyChildThreadsSelected$5$inlined.invoke(this.$textChannel.getId())) && C7413x4d8eedc1.this.$areAllChildThreadsRead$4$inlined.invoke(this.$textChannel.getId()) && ((zContains && z2 && (C7413x4d8eedc1.this.$isCategoryMuted || this.$isMuted || !this.$unread)) || (this.$isMuted && C7413x4d8eedc1.this.$guild$inlined.getHideMutedChannels()));
            if (z3) {
                C7413x4d8eedc1.this.$hiddenChannelsIds$inlined.add(Long.valueOf(this.$textChannelId));
            }
            return z3;
        }
    }
    ...
    public static /* synthetic */ WidgetChannelListModel.Companion.TextLikeChannelData invoke$default(C7413x4d8eedc1 c7413x4d8eedc1, Channel channel, boolean z2, Boolean bool, int i, Object obj) {
        if ((i & 2) != 0) {
            z2 = false;
        }
        if ((i & 4) != 0) {
        ...
        return c7413x4d8eedc1.invoke(channel, z2, bool);
    }
    ...
    public final WidgetChannelListModel.Companion.TextLikeChannelData invoke(Channel channel, boolean z2, Boolean bool) {
        ...
        if (listM7655v != null) {
            ...
            while (true) {
                ...
                next = it.next();
                if (((PermissionOverwrite) next).m8131e() == this.$selectedGuildId$inlined) {
                    break;
                }
            }
        ...
        return new WidgetChannelListModel.Companion.TextLikeChannelData(z4, iIntValue, zContains, z3, ChannelUtils.m7673H(channel) ? new AnonymousClass1(channel, bool).invoke2() : new AnonymousClass2(iIntValue, channel, z4, z2, zContains, id2).invoke2());
    }
}
