...
public final class WidgetGuildScheduledEventDetailsExtrasBottomSheet extends AppBottomSheet {
    ...
    public static final class Companion {
        ...
        public final void show(FragmentManager fragmentManager, WidgetGuildScheduledEventDetailsBottomSheet2 args) {
            ...
            widgetGuildScheduledEventDetailsExtrasBottomSheet.setArguments(AnimatableValueParser.m514e2(args));
    ...
    public static final class ViewOnClickListenerC88772 implements View.OnClickListener {
        ...
        public ViewOnClickListenerC88772(GuildScheduledEventDetailsViewModel.ViewState viewState) {
    ...
    public static final class ViewOnClickListenerC88783 implements View.OnClickListener {
        ...
        public ViewOnClickListenerC88783(GuildScheduledEventDetailsViewModel.ViewState viewState) {
            this.$viewState = viewState;
        }
    ...
    public static final class ViewOnClickListenerC88794 implements View.OnClickListener {
        ...
        public ViewOnClickListenerC88794() {
        }
    ...
    public static final class ViewOnClickListenerC88805 implements View.OnClickListener {
        ...
        public static final class AnonymousClass1 extends Lambda implements Function1<View, Unit> {
            ...
            public final void invoke2(View view) {
                ...
                Context contextRequireContext = WidgetGuildScheduledEventDetailsExtrasBottomSheet.this.requireContext();
                Intrinsics3.checkNotNullExpressionValue(contextRequireContext, "requireContext()");
                guildScheduledEventDetailsViewModelAccess$getViewModel$p.onDeleteButtonClicked(contextRequireContext, new C132861());
            }
        }
        ...
        public final void onClick(View view) {
            ...
            Context contextRequireContext = WidgetGuildScheduledEventDetailsExtrasBottomSheet.this.requireContext();
            Intrinsics3.checkNotNullExpressionValue(contextRequireContext, "requireContext()");
            WidgetNoticeDialog.Companion.show$default(companion, childFragmentManager, string, FormatUtils.m216h(contextRequireContext, C5419R.string.delete_stage_event_confirmation_description, new Object[]{((GuildScheduledEventDetailsViewModel.ViewState.Initialized) this.$viewState).getGuildScheduledEvent().getName()}, null, 4), WidgetGuildScheduledEventDetailsExtrasBottomSheet.this.requireContext().getString(C5419R.string.delete_event), WidgetGuildScheduledEventDetailsExtrasBottomSheet.this.requireContext().getString(C5419R.string.back), MapsJVM.mapOf(Tuples.m10073to(Integer.valueOf(C5419R.id.notice_ok), new AnonymousClass1())), null, null, null, null, null, null, 0, null, 16320, null);
        }
    }
    ...
    public static final class ViewOnClickListenerC88816 implements View.OnClickListener {
        ...
        public ViewOnClickListenerC88816(GuildScheduledEventDetailsViewModel.ViewState viewState) {
            this.$viewState = viewState;
        }
    ...
    public static final class ViewOnClickListenerC88827 implements View.OnClickListener {
        ...
        public ViewOnClickListenerC88827(GuildScheduledEventDetailsViewModel.ViewState viewState) {
            this.$viewState = viewState;
        }
        ...
        public final void onClick(View view) {
            ...
            Context contextRequireContext = WidgetGuildScheduledEventDetailsExtrasBottomSheet.this.requireContext();
            Intrinsics3.checkNotNullExpressionValue(contextRequireContext, "requireContext()");
            AppToast.m165c(contextRequireContext, String.valueOf(((GuildScheduledEventDetailsViewModel.ViewState.Initialized) this.$viewState).getGuildScheduledEvent().getId()), 0, 4);
        }
    }
    ...
    public WidgetGuildScheduledEventDetailsExtrasBottomSheet() {
        ...
        this.args = LazyJVM.lazy(new C8874x86406bd1(this, "intent_args_key"));
        ...
        this.viewModel = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection2.getOrCreateKotlinClass(GuildScheduledEventDetailsViewModel.class), new C8875xf108016c(appViewModelDelegates3), new AppViewModelDelegates5(widgetGuildScheduledEventDetailsExtrasBottomSheet5));
    ...
    private final void configureUi(GuildScheduledEventDetailsViewModel.ViewState viewState) {
        ...
        getBinding().f17008h.setOnClickListener(new ViewOnClickListenerC88772(viewState));
        ...
        getBinding().f17004d.setOnClickListener(new ViewOnClickListenerC88783(viewState));
        ...
        getBinding().f17005e.setOnClickListener(new ViewOnClickListenerC88794());
        ...
        getBinding().f17007g.setOnClickListener(new ViewOnClickListenerC88816(viewState));
        ...
        getBinding().f17003c.setOnClickListener(new ViewOnClickListenerC88827(viewState));
    }
