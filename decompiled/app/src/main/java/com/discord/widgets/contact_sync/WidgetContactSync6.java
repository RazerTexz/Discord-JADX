...
public final class WidgetContactSync6 extends Lambda implements Function0<AnalyticsSchema> {
    ...
    public final AnalyticsSchema invoke() {
        ...
        if (iAccess$getDisplayedChildIndex$p == WidgetContactSyncViewModel.Views.VIEW_LANDING.ordinal()) {
            ...
            trackImpressionContactSyncStart.m7518e(WidgetContactSync.access$getContactSyncFlowMetadata$p(this.this$0));
        ...
        if (iAccess$getDisplayedChildIndex$p == WidgetContactSyncViewModel.Views.VIEW_ADD_PHONE.ordinal()) {
            ...
            trackImpressionUserAddPhone.m7525e(WidgetContactSync.access$getContactSyncFlowMetadata$p(this.this$0));
        ...
        if (iAccess$getDisplayedChildIndex$p == WidgetContactSyncViewModel.Views.VIEW_NAME_INPUT.ordinal()) {
            ...
            trackImpressionContactSyncInputName.m7517e(WidgetContactSync.access$getContactSyncFlowMetadata$p(this.this$0));
        ...
        if (iAccess$getDisplayedChildIndex$p == WidgetContactSyncViewModel.Views.VIEW_SUGGESTIONS.ordinal()) {
            ...
            trackImpressionContactSyncSuggestions.m7519e(WidgetContactSync.access$getContactSyncFlowMetadata$p(this.this$0));
        ...
        trackImpressionContactSyncSuggestions2.m7519e(WidgetContactSync.access$getContactSyncFlowMetadata$p(this.this$0));
