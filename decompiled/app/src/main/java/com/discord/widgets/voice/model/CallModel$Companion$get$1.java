...
public final class CallModel$Companion$get$1<T, R> implements b<Channel, Observable<? extends CallModel>> {
    ...
    public static final class AnonymousClass1<T, R> implements b<Map<Long, ? extends EmbeddedActivity>, Observable<? extends CallModel>> {
        ...
        public static final class C04861<T, R> implements b<Experiment, Integer> {
        ...
        public static final class AnonymousClass3 extends o implements Function10<CallModel.Companion.Chunk, StoreApplicationStreaming.ActiveApplicationStream, RtcConnection.Metadata, Integer, Integer, VoiceChannelJoinability, Guild, Long, List<? extends GuildScheduledEvent>, Map<Long, ? extends Application>, CallModel> {
            ...
            */
            public final CallModel invoke(CallModel.Companion.Chunk chunk, StoreApplicationStreaming.ActiveApplicationStream activeApplicationStream, RtcConnection.Metadata metadata, Integer num, Integer num2, VoiceChannelJoinability voiceChannelJoinability, Guild guild, long j, List<GuildScheduledEvent> list, Map<Long, Application> map) {
                ...
                return CallModel.Companion.access$create(companion, channel, guild, myUserId, timeConnectedMs, voiceConfig, voiceParticipants, channelPermissions, videoDevices, z3, selectedVideoDevice, activeApplicationStream, metadata, iIntValue, iIntValue2, audioManagerState, voiceChannelJoinability, arrayList, map2, map);
            }
        }
        ...
        public final Observable<? extends CallModel> call2(Map<Long, EmbeddedActivity> map) {
            ...
            Observable<R> observableG = companion.getExperiments().observeUserExperiment("2019-12_android_call_feedback_sheet_sample_rate_denominator", true).G(C04861.INSTANCE);
            ...
            return ObservableCombineLatestOverloadsKt.combineLatest(observableAccess$observeChunk, observableObserveActiveStream, observableObserveRtcConnectionMetadata, observableG, observableG2, VoiceChannelJoinabilityUtils.observeJoinability$default(VoiceChannelJoinabilityUtils.INSTANCE, CallModel$Companion$get$1.this.$channelId, null, null, null, null, null, null, 126, null), companion.getGuilds().observeFromChannelId(CallModel$Companion$get$1.this.$channelId), companion.getVoiceChannelSelected().observeSelectedVoiceChannelId(), StoreGuildScheduledEvents.observeGuildScheduledEvents$default(companion.getGuildScheduledEvents(), this.$channel.getGuildId(), false, 2, null), companion.getApplication().observeApplications(setKeySet), new AnonymousClass3(map));
        }
    }
    ...
    public final Observable<? extends CallModel> call2(Channel channel) {
        return channel == null ? new k(null) : StoreStream.INSTANCE.getEmbeddedActivities().observeEmbeddedActivitiesForChannel(this.$channelId).Y(new AnonymousClass1(channel));
    }
