    ...
    public final List<RestAPIParams.CreateGuildChannel> getChannels(Resources resources) {
        ...
        switch (this) {
            ...
            case STUDY_GROUP:
                ...
                return _Collections.plus((Collection) listPlus, (Iterable) StockGuildTemplate3.access$createCategorySection(string16, 300L, 2, new StockGuildTemplate2.NormalChannel(string17), new StockGuildTemplate2.NormalChannel(FormatUtils.m217i(resources, C5419R.string.guild_template_name_voice_study_room, new Object[]{"1"}, null, 4).toString()), new StockGuildTemplate2.NormalChannel(FormatUtils.m217i(resources, C5419R.string.guild_template_name_voice_study_room, new Object[]{ExifInterface.GPS_MEASUREMENT_2D}, null, 4).toString())));
            case GAMING_GROUP:
