...
public final class WidgetChatListAdapterItemMessage2 extends Lambda implements Function1<RenderContext, Unit> {
    ...
    public static final class AnonymousClass1 extends Lambda implements Function1<Hook, Unit> {
        ...
        public final void invoke2(Hook hook) {
            ...
            hook.styles.add(new ClickableSpan(Integer.valueOf(ColorCompat.getThemedColor(WidgetChatListAdapterItemMessage.access$getReplyText$p(WidgetChatListAdapterItemMessage2.this.this$0), C5419R.attr.colorTextLink)), false, null, new C132791(), 4, null));
        }
