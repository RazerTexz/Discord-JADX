...
public final class WidgetGuildBoostConfirmation$slotId$2 extends o implements Function0<Long> {
    public final /* synthetic */ WidgetGuildBoostConfirmation this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetGuildBoostConfirmation$slotId$2(WidgetGuildBoostConfirmation widgetGuildBoostConfirmation) {
        super(0);
