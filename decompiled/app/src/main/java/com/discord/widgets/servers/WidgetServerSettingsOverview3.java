...
public final class WidgetServerSettingsOverview3 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        TextView textView = WidgetServerSettingsOverview.access$getBinding$p(widgetServerSettingsOverview).f17731b.f1452d;
        ...
        LinearLayout linearLayout = WidgetServerSettingsOverview.access$getBinding$p(widgetServerSettingsOverview).f17731b.f1453e;
        ...
        TextView textView2 = WidgetServerSettingsOverview.access$getBinding$p(widgetServerSettingsOverview).f17731b.f1452d;
        Intrinsics3.checkNotNullExpressionValue(textView2, "binding.afk.afkTimeout");
        textView2.setText(this.$afkTimeoutString);
        LinearLayout linearLayout2 = WidgetServerSettingsOverview.access$getBinding$p(widgetServerSettingsOverview).f17731b.f1453e;
