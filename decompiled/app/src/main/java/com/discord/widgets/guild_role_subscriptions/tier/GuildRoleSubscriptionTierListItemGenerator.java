    ...
    public static final List<GuildRoleSubscriptionTierAdapterItem> generateGuildRoleSubscriptionReviewListItems(GuildRoleSubscriptionTier guildRoleSubscriptionTier, Boolean bool, Integer num, String str, String str2) {
        ...
        if (guildRoleSubscriptionTier != null) {
            ...
            if (guildRoleSubscriptionTier.canAccessAllChannelsOrDefault(bool)) {
                if (num == null) {
                    arrayList.add(new GuildRoleSubscriptionTierAdapterItem.SectionHeader(Integer.valueOf(C5419R.string.guild_role_subscription_setup_channel_benefits_channels_title), null, null));
                } else {
                    arrayList.add(new GuildRoleSubscriptionTierAdapterItem.SectionHeader(null, Integer.valueOf(C5419R.plurals.guild_role_subscription_tier_review_exclusive_channel_header_count), num));
                }
                ...
                arrayList.add(new GuildRoleSubscriptionTierAdapterItem.SectionHeader(null, Integer.valueOf(C5419R.plurals.guild_role_subscription_tier_review_exclusive_channel_header_count), Integer.valueOf(guildRoleSubscriptionTier.getChannelBenefits().size())));
                int i2 = 0;
            ...
            if (!guildRoleSubscriptionTier.getIntangibleBenefits().isEmpty()) {
                arrayList.add(new GuildRoleSubscriptionTierAdapterItem.SectionHeader(null, Integer.valueOf(C5419R.plurals.guild_role_subscription_tier_review_intangible_benefits_header_count), Integer.valueOf(guildRoleSubscriptionTier.getIntangibleBenefits().size())));
