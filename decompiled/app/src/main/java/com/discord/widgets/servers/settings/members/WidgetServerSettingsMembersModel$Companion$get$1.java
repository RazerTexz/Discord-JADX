        ...
        */
        public final WidgetServerSettingsMembersModel call2(Guild guild, Long l, MeUser meUser, Map<Long, ? extends User> map, Map<Long, GuildRole> map2, String str, Long l2) {
            ...
            for (User user : map.values()) {
                GuildMember guildMember2 = (GuildMember) a.f(user, anonymousClass1.$members);
                if (guildMember2 != null) {
                    ...
                    if ((l3 != null && l2.longValue() == id2) || guildMember2.getRoles().contains(l3)) {
                        ...
                        if ((longOrNull != null && id3 == longOrNull.longValue()) || w.contains((CharSequence) user.getUsername(), (CharSequence) str2, true) || ((nick = guildMember2.getNick()) != null && w.contains((CharSequence) nick, (CharSequence) str2, true))) {
                            ...
                            treeSet = treeSet2;
                            ManageUserContext manageUserContextFrom = companion.from(guild, meUser, user, roles, roles2, l, map2);
