...
public final class WidgetHubDomainSearch2 extends Lambda implements Function2<LayoutInflater, ViewGroup, WidgetHubDomains4> {
    ...
    /* JADX INFO: renamed from: com.discord.widgets.hubs.WidgetHubDomainSearch$adapter$1$1 */
    /* JADX INFO: compiled from: WidgetHubDomainSearch.kt */
    public static final /* synthetic */ class C90171 extends FunctionReferenceImpl implements Function1<WidgetHubDomains2, Unit> {
        public C90171(WidgetHubDomainSearch widgetHubDomainSearch) {
    ...
    public final WidgetHubDomains4 invoke2(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        ...
        return new WidgetHubDomains4(discordHubAddServerListItemBindingM8382a, new C90171(this.this$0));
    }
}
