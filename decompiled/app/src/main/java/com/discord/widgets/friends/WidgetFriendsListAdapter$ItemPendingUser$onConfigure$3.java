...
public final class WidgetFriendsListAdapter$ItemPendingUser$onConfigure$3 implements View.OnClickListener {
    ...
    public WidgetFriendsListAdapter$ItemPendingUser$onConfigure$3(WidgetFriendsListAdapter.ItemPendingUser itemPendingUser, FriendsListViewModel.Item.PendingFriendRequest pendingFriendRequest) {
