...
public final class WidgetChannelsListAdapter$ItemChannelCategory$onConfigure$4 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        WidgetCreateChannel.INSTANCE.show(outline.m885x(this.this$0.itemView, "itemView", "itemView.context"), this.$item.getChannel().getGuildId(), 0, Long.valueOf(this.$item.getChannel().getId()));
    }
}
