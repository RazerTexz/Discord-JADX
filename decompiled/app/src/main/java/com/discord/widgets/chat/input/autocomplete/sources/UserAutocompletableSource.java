...
public final class UserAutocompletableSource {
    ...
    public static final class AnonymousClass1<T, R> implements b<Guild, Long> {
    ...
    public static final class AnonymousClass3<T, R> implements b<User, Long> {
    ...
    public static final class AnonymousClass5<T, R> implements b<List<Long>, Observable<? extends Map<LeadingIdentifier, ? extends TreeSet<Autocompletable>>>> {
        public final /* synthetic */ Channel $channel;
        ...
        public static final class AnonymousClass1<T1, T2, R> implements Func2<Map<Long, ? extends User>, Map<Long, ? extends Presence>, Map<LeadingIdentifier, ? extends TreeSet<Autocompletable>>> {
            ...
            public final Map<LeadingIdentifier, TreeSet<Autocompletable>> call2(Map<Long, ? extends User> map, Map<Long, Presence> map2) {
                ...
                return UserAutocompletableSource.access$createAutocompletablesForDmUsers(userAutocompletableSource, map, map2, AnonymousClass5.this.$channel.q());
            }
        }
        ...
        public final Observable<? extends Map<LeadingIdentifier, TreeSet<Autocompletable>>> call2(List<Long> list) {
            ...
            return Observable.j(storeUsers.observeUsers(list), UserAutocompletableSource.this.getStorePresences().observePresencesForUsers(list), new AnonymousClass1()).r();
        }
    }
    ...
    private final Map<LeadingIdentifier, TreeSet<Autocompletable>> createAutocompletablesForUsers(long myId, Channel channel, Channel parentChannel, long guildOwnerId, Map<Long, GuildRole> roles, Map<Long, GuildMember> members, Map<Long, ? extends User> users, Map<Long, Presence> presences, Long permissions) {
        ...
        if (members.size() > 3000) {
            ...
            arrayList = ShallowPartitionCollection.INSTANCE.withArrayListPartions(size, new UserAutocompletableSource$createAutocompletablesForUsers$mentions$1(size));
        } else {
    ...
    public final Observable<Map<LeadingIdentifier, TreeSet<Autocompletable>>> observeUserAutocompletables(Channel channel) {
        ...
        if (UserMentionableSourceKt.access$isTextOrVoiceChannel(channel)) {
            ...
            observableY = UserMentionableSourceKt.access$isDmOrGroupDm(channel) ? Observable.j(Observable.B(ChannelUtils.g(channel)).G(AnonymousClass3.INSTANCE).f0(), this.storeUsers.observeMeId(), AnonymousClass4.INSTANCE).Y(new AnonymousClass5(channel)) : new k(h0.emptyMap());
        }
