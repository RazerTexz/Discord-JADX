...
public final class WidgetGuildsListViewModel$handleStoreState$lurkerGuildItems$2 extends o implements Function1<StoreGuildsSorted.Entry.SingletonGuild, GuildListItem.GuildItem> {
    ...
    public WidgetGuildsListViewModel$handleStoreState$lurkerGuildItems$2(WidgetGuildsListViewModel widgetGuildsListViewModel, WidgetGuildsListViewModel.StoreState storeState, HashMap map) {
        super(1);
