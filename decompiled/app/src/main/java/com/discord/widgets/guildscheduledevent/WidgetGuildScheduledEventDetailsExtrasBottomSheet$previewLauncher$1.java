...
public final class WidgetGuildScheduledEventDetailsExtrasBottomSheet$previewLauncher$1 extends o implements Function0<Unit> {
    public final /* synthetic */ WidgetGuildScheduledEventDetailsExtrasBottomSheet this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetGuildScheduledEventDetailsExtrasBottomSheet$previewLauncher$1(WidgetGuildScheduledEventDetailsExtrasBottomSheet widgetGuildScheduledEventDetailsExtrasBottomSheet) {
        super(0);
