    ...
    */
    private final CharSequence getIntroText(ModelInvite modelInvite) {
        ...
        if (modelInvite.getChannel() == null && modelInvite.guild == null && z2) {
            ...
            return FormatUtils.m216h(context, C5419R.string.instant_invite_you_have_been_invited_to_chat_with, new Object[0], null, 4);
        }
        ...
        if (channel == null || !ChannelUtils.m7702z(channel)) {
            if (modelInvite.getApproximateMemberCount() >= 200 || !z2) {
                ...
                return FormatUtils.m216h(context2, C5419R.string.instant_invite_you_have_been_invited_to_join, new Object[0], null, 4);
            }
            Context context3 = getContext();
            Intrinsics3.checkNotNullExpressionValue(context3, "context");
            return FormatUtils.m216h(context3, C5419R.string.auth_message_invited_by, new Object[]{username}, null, 4);
        }
        ...
        if (channel2 != null) {
            ...
            return FormatUtils.m216h(context4, C5419R.string.auth_message_invited_by, objArr, null, 4);
        }
        Context context5 = getContext();
        Intrinsics3.checkNotNullExpressionValue(context5, "context");
        return FormatUtils.m216h(context5, C5419R.string.instant_invite_you_have_been_invited_to_join_group_dm, new Object[0], null, 4);
    }
    ...
    public final void configureGuildTemplate(ModelGuildTemplate guildTemplate) {
        ...
        FormatUtils.m222n(textView, C5419R.string.guild_template_modal_title, new Object[0], null, 4);
    ...
    public final void configureInvite(ModelInvite invite) {
        ...
        if ((numValueOf != null && numValueOf.intValue() == 5) || ((numValueOf != null && numValueOf.intValue() == 0) || ((numValueOf != null && numValueOf.intValue() == 2) || (numValueOf != null && numValueOf.intValue() == 13)))) {
            ...
            if (guild != null) {
                ...
                TextView textView = this.binding.f15377d;
                Intrinsics3.checkNotNullExpressionValue(textView, "binding.authInviteInfoInvitedText");
                textView.setText(FormatUtils.m220l(getIntroText(invite), new Object[0], null, 2));
                TextView textView2 = this.binding.f15376c;
                Intrinsics3.checkNotNullExpressionValue(textView2, "binding.authInviteInfoGuildName");
        ...
        if (numValueOf != null && numValueOf.intValue() == 3) {
            ...
            textView3.setText(FormatUtils.m220l(getIntroText(invite), new Object[0], null, 2));
        ...
        if (numValueOf == null) {
            ...
            StringBuilder sbM836X = outline.m836X(username, "#");
            ...
            textView5.setText(FormatUtils.m220l(getIntroText(invite), new Object[0], null, 2));
