...
public final class WidgetHubEmailFlow$$special$$inlined$args$1 extends Lambda implements Function0<WidgetHubEmailViewModel2> {
    ...
    public final WidgetHubEmailViewModel2 invoke() {
        ...
        WidgetHubEmailViewModel2 parcelableExtra = widgetHubEmailViewModel2;
        ...
        outline.m862l0(WidgetHubEmailViewModel2.class, sbM833U, " + key ");
    ...
    @Override // kotlin.jvm.functions.Function0
    public /* bridge */ /* synthetic */ WidgetHubEmailViewModel2 invoke() {
        return invoke();
    }
}
