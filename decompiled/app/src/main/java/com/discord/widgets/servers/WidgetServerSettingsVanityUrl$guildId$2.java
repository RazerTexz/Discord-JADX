...
public final class WidgetServerSettingsVanityUrl$guildId$2 extends o implements Function0<Long> {
    public final /* synthetic */ WidgetServerSettingsVanityUrl this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetServerSettingsVanityUrl$guildId$2(WidgetServerSettingsVanityUrl widgetServerSettingsVanityUrl) {
        super(0);
