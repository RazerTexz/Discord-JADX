...
public final class AutocompleteModelUtils {
            ...
            default:
                if (selectedCommandOption.getAutocomplete()) {
                    ...
                    for (Object obj10 : listPlus) {
                        ...
                        if (autocompletable2 instanceof ChannelAutocompletable ? ChannelUtils.m7698v(((ChannelAutocompletable) autocompletable2).getChannel()) : autocompletable2 instanceof UserAutocompletable ? ((UserAutocompletable) autocompletable2).getCanUserReadChannel() : !(autocompletable2 instanceof ApplicationCommandAutocompletable)) {
    ...
    public final List<Autocompletable> filterAutocompletablesForMessageContext(List<? extends Autocompletable> autocompletables) {
        ...
        for (Object obj : autocompletables) {
            ...
            if (autocompletable instanceof ChannelAutocompletable ? ChannelUtils.m7698v(((ChannelAutocompletable) autocompletable).getChannel()) : autocompletable instanceof UserAutocompletable ? ((UserAutocompletable) autocompletable).getCanUserReadChannel() : autocompletable instanceof RoleAutocompletable ? ((RoleAutocompletable) autocompletable).getCanMention() : true) {
                arrayList.add(obj);
            }
        }
        return arrayList;
