...
public final class WidgetChatListAdapterItemGuildWelcome extends WidgetChatListItem {
    ...
    public static final class AnonymousClass1 implements View.OnClickListener {
        ...
        public final void onClick(View view) {
            WidgetServerSettingsOverview.INSTANCE.create(a.x(view, "view", "view.context"), ((GuildWelcomeEntry) this.$data).getGuildId(), true);
        }
    }
    ...
    public static final class AnonymousClass2 implements View.OnClickListener {
        ...
        @Override // android.view.View.OnClickListener
        public final void onClick(View view) {
            WidgetGuildInviteShare.Companion.launch$default(WidgetGuildInviteShare.INSTANCE, a.x(view, "view", "view.context"), WidgetChatListAdapterItemGuildWelcome.access$getAdapter$p(WidgetChatListAdapterItemGuildWelcome.this).getFragmentManager(), ((GuildWelcomeEntry) this.$data).getGuildId(), null, false, null, null, "Welcome Message", 120, null);
        }
    }
    ...
    public void onConfigure(int position, ChatListEntry data) {
        ...
        if (data instanceof GuildWelcomeEntry) {
            ...
            b.n(textView, R.string.welcome_cta_title_mobile, new Object[]{guildWelcomeEntry.getGuildName()}, null, 4);
            ...
            b.n(linkifiedTextView, R.string.welcome_cta_subtitle_action_with_guide, new Object[]{strJ}, null, 4);
            ...
            b.n(linkifiedTextView3, z3 ? R.string.welcome_cta_subtitle_existing_server : guildWelcomeEntry.isOwner() ? R.string.welcome_cta_subtitle_owner : R.string.welcome_cta_subtitle_member, new Object[0], null, 4);
        }
    }
}
