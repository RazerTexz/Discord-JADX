...
public final class WidgetChatInput$flexInputViewModel$2 extends o implements Function0<AppFlexInputViewModel> {
    public final /* synthetic */ WidgetChatInput this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetChatInput$flexInputViewModel$2(WidgetChatInput widgetChatInput) {
        super(0);
