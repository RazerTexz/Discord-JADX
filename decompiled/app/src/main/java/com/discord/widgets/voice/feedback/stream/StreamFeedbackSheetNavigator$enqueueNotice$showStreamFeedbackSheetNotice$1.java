...
public final class StreamFeedbackSheetNavigator$enqueueNotice$showStreamFeedbackSheetNotice$1 extends o implements Function1<FragmentActivity, Boolean> {
    ...
    public StreamFeedbackSheetNavigator$enqueueNotice$showStreamFeedbackSheetNotice$1(long j, String str, String str2, StoreNotices storeNotices, String str3) {
        super(1);
