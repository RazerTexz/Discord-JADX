...
/* JADX INFO: renamed from: com.discord.widgets.channels.list.WidgetChannelListModel$Companion$guildListBuilder$$inlined$forEach$lambda$6 */
/* JADX INFO: compiled from: WidgetChannelListModel.kt */
/* JADX INFO: loaded from: classes2.dex */
public final class C7418x4d8eedc6 extends Lambda implements Function0<ChannelListItemStageVoiceChannel> {
    ...
    public final /* synthetic */ C7414x4d8eedc2 $getVocalChannelData$2;
    ...
    public final ChannelListItemStageVoiceChannel invoke() {
        ...
        StageInstance stageInstance = (StageInstance) outline.m845d(this.$channel, this.$stageInstances$inlined);
        StageChannel stageChannel = (StageChannel) outline.m845d(this.$channel, this.$stageChannels$inlined);
