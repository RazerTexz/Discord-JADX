            ...
            if (channelId != null) {
                ...
                if (guildScheduledEventsForChannel == null || (listInvoke = guildScheduledEventsForChannel.invoke()) == null) {
                    ...
                    while (true) {
                        ...
                        next = it.next();
                        if (((DirectoryEntryEvent) next).getGuildScheduledEvent().getId() == this.$args.getEventId()) {
                            break;
                        }
                    }
                ...
                UserGuildMember creatorUserGuildMember$default = z2 ? GuildScheduledEventUtilitiesKt.getCreatorUserGuildMember$default(guildScheduledEvent, (StoreGuilds) null, (StoreUser) null, 3, (Object) null) : null;
