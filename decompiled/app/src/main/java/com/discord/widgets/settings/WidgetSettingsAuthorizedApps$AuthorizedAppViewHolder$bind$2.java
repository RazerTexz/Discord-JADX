...
public final class WidgetSettingsAuthorizedApps$AuthorizedAppViewHolder$bind$2 implements View.OnClickListener {
    ...
    public WidgetSettingsAuthorizedApps$AuthorizedAppViewHolder$bind$2(WidgetSettingsAuthorizedApps.AuthorizedAppViewHolder authorizedAppViewHolder, ModelOAuth2Token modelOAuth2Token) {
