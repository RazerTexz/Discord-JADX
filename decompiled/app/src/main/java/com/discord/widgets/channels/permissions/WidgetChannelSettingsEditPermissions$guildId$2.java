...
public final class WidgetChannelSettingsEditPermissions$guildId$2 extends o implements Function0<Long> {
    public final /* synthetic */ WidgetChannelSettingsEditPermissions this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetChannelSettingsEditPermissions$guildId$2(WidgetChannelSettingsEditPermissions widgetChannelSettingsEditPermissions) {
        super(0);
