...
public final class WidgetChannelSidebarActionsViewModel$Companion$observeStoreState$1<T, R> implements b<PanelState, Observable<? extends WidgetChannelSidebarActionsViewModel.StoreState>> {
    ...
    public static final class AnonymousClass1<T, R> implements b<Channel, Observable<? extends WidgetChannelSidebarActionsViewModel.StoreState>> {
        ...
        public final Observable<? extends WidgetChannelSidebarActionsViewModel.StoreState> call2(Channel channel) {
            Observable<? extends WidgetChannelSidebarActionsViewModel.StoreState> kVar = channel == null ? new k<>(WidgetChannelSidebarActionsViewModel.StoreState.ChannelNotFound.INSTANCE) : Observable.i(WidgetChannelSidebarActionsViewModel$Companion$observeStoreState$1.this.$storeUserGuildSettings.observeGuildSettings(), StoreUser.observeMe$default(WidgetChannelSidebarActionsViewModel$Companion$observeStoreState$1.this.$storeUser, false, 1, null), WidgetChannelSidebarActionsViewModel$Companion$observeStoreState$1.this.$storeChannels.observeChannel(channel.getParentId()), new WidgetChannelSidebarActionsViewModel$Companion$observeStoreState$1$1$storeState$1(this, channel));
