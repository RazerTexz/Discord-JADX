...
public final class WidgetChatList$flexInputViewModel$2 extends o implements Function0<AppFlexInputViewModel> {
    public final /* synthetic */ WidgetChatList this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WidgetChatList$flexInputViewModel$2(WidgetChatList widgetChatList) {
        super(0);
