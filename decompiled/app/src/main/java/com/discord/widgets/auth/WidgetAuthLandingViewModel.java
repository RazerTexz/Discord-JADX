...
public final class WidgetAuthLandingViewModel extends AppViewModel<ViewState> {
    ...
    public static final class C71802 extends Lambda implements Function1<GoogleSmartLockManager.SmartLockCredentials, Unit> {
        ...
        public final void invoke2(GoogleSmartLockManager.SmartLockCredentials smartLockCredentials) {
            ...
            publishSubjectAccess$getEventSubject$p.f27650k.onNext(new Event.SmartLockLogin(smartLockCredentials));
        }
    }
    ...
    public static final class Companion {
        ...
        private final Observable<StoreState> observeStoreState(StoreInviteSettings storeInviteSettings, StoreGuildTemplates storeGuildTemplates, StoreAuthentication storeAuthentication) {
            Observable<StoreState> observableM11073h = Observable.m11073h(storeInviteSettings.getInviteCode(), storeInviteSettings.getInvite(), storeGuildTemplates.observeDynamicLinkGuildTemplateCode().m11099Y(new WidgetAuthLandingViewModel2(storeGuildTemplates)), storeAuthentication.getAgeGateError(), WidgetAuthLandingViewModel3.INSTANCE);
            Intrinsics3.checkNotNullExpressionValue(observableM11073h, "Observable.combineLatest…eError,\n        )\n      }");
    ...
    public static abstract class Event {
        ...
        public static final /* data */ class SmartLockLogin extends Event {
            ...
            public String toString() {
                StringBuilder sbM833U = outline.m833U("SmartLockLogin(smartLockCredentials=");
    ...
    public static final /* data */ class StoreState {
        ...
        public String toString() {
            StringBuilder sbM833U = outline.m833U("StoreState(inviteCode=");
            ...
            return outline.m822J(sbM833U, this.ageGateError, ")");
        }
    }
    ...
    public static abstract class ViewState {
        ...
        public static final /* data */ class Empty extends ViewState {
            ...
            public String toString() {
                StringBuilder sbM833U = outline.m833U("Empty(ageGateError=");
        ...
        public static final /* data */ class GuildTemplate extends ViewState {
            ...
            public String toString() {
                StringBuilder sbM833U = outline.m833U("GuildTemplate(guildTemplate=");
        ...
        public static final /* data */ class Invite extends ViewState {
            ...
            public String toString() {
                StringBuilder sbM833U = outline.m833U("Invite(invite=");
                sbM833U.append(this.invite);
                sbM833U.append(", ageGateError=");
                sbM833U.append(getAgeGateError());
                sbM833U.append(")");
    ...
    public WidgetAuthLandingViewModel(Context context, StoreAuthentication storeAuthentication, StoreAnalytics storeAnalytics, Observable<StoreState> observable, StoreInstantInvites storeInstantInvites, GoogleSmartLockManager googleSmartLockManager) {
        ...
        ObservableExtensionsKt.appSubscribe$default(ObservableExtensionsKt.ui$default(observable, this, null, 2, null), WidgetAuthLandingViewModel.class, (Context) null, (Function1) null, (Function1) null, (Function0) null, (Function0) null, new C71791(), 62, (Object) null);
        ObservableExtensionsKt.appSubscribe$default(ObservableExtensionsKt.ui$default(googleSmartLockManager.getSmartLockRepo().getSmartLockLoginObservable(), this, null, 2, null), WidgetAuthLandingViewModel.class, (Context) null, (Function1) null, (Function1) null, (Function0) null, (Function0) null, new C71802(), 62, (Object) null);
