...
public final class StoreStageChannels extends StoreV2 {
    ...
    public static final /* data */ class StageEventActivationState {
        ...
        public String toString() {
            return outline.m826N(outline.m833U("StageEventActivationState(moderators="), this.moderators, ")");
        }
    ...
    public static final class C64131 extends Lambda implements Function0<StageRoles> {
        ...
        public final StageRoles invoke() {
            Channel channel = StoreStageChannels.access$getChannelsStore$p(StoreStageChannels.this).getChannel(this.$channelId);
            if (channel != null) {
                return StoreStageChannels.this.m11392getMyRolesvisDeB4(channel.getId());
            }
            return null;
        }
    }
    ...
    public static final class C64181 extends Lambda implements Function0<StageRoles> {
        ...
        public final StageRoles invoke() {
            Channel channel = StoreStageChannels.access$getChannelsStore$p(StoreStageChannels.this).getChannel(this.$channelId);
            if (channel != null) {
                return StoreStageChannels.this.m11394getUserRolesuOBN1zc(this.$userId, channel.getId());
            }
            return null;
        }
    }
    ...
    private final int m11386computeUserRolesInDispatcht27eFtU(long userId, Channel channel, Map<Long, VoiceState> voiceStates, Map<Long, GuildRole> roles) {
        ...
        if (guild == null) {
            return StageRoles.INSTANCE.m11414getAUDIENCE1LxfuJo();
        }
        Map map = (Map) outline.m843c(channel, this.guildsStore.getGuildMembersComputedInternal$app_productionGoogleRelease());
        if (map == null) {
            return StageRoles.INSTANCE.m11414getAUDIENCE1LxfuJo();
        }
        ...
        if (roles == null) {
            roles = (Map) outline.m843c(channel, this.guildsStore.getGuildRolesInternal$app_productionGoogleRelease());
        }
        if (voiceStates == null) {
            voiceStates = (Map) outline.m843c(channel, this.voiceStatesStore.getInternal$app_productionGoogleRelease());
        }
        if (voiceStates == null) {
            return StageRoles.INSTANCE.m11414getAUDIENCE1LxfuJo();
        }
    ...
    private final Guild getGuild(Channel channel) {
        return (Guild) outline.m843c(channel, this.guildsStore.getGuilds());
    }
    ...
    private final Map<Long, GuildRole> getRolesMap(Guild guild) {
        Map<Long, GuildRole> map = (Map) outline.m847e(guild, this.guildsStore.getRoles());
        return map != null ? map : Maps6.emptyMap();
    }
    ...
    private final void m11388handleUserJoinedStageOrGainedRoleoRmTEFA(Channel channel, long userId, int roles) {
        if (StageRoles.m11409isModeratorimpl(roles) || StageRoles.m11410isSpeakerimpl(roles)) {
            ...
            StageEventActivationState stageEventActivationState = (StageEventActivationState) outline.m845d(channel, linkedHashMap);
            ...
            boolean z2 = StageRoles.m11409isModeratorimpl(roles) && !stageEventActivationState.getModerators().contains(Long.valueOf(userId));
            if (z2) {
    ...
    private final void m11389handleUserLeftStageOrLostRolesGM3QuyE(Channel channel, long userId, int oldRoles, int newRoles) {
        ...
        if ((!StageRoles.m11409isModeratorimpl(oldRoles) && !StageRoles.m11410isSpeakerimpl(oldRoles)) || (map = (Map) outline.m843c(channel, this.stageEventStates)) == null || (stageEventActivationState = (StageEventActivationState) outline.m845d(channel, map)) == null) {
            return;
        }
        boolean z2 = !StageRoles.m11409isModeratorimpl(newRoles) && StageRoles.m11409isModeratorimpl(oldRoles) && stageEventActivationState.getModerators().contains(Long.valueOf(userId));
        if (z2) {
    ...
    private final void m11391handleUserRoleChangeuOJZ9lM(Channel channel, long userId, StageRoles oldRole, int newRole) {
        ...
        if ((oldRole != null && StageRoles.m11409isModeratorimpl(oldRole.m11412unboximpl()) && !StageRoles.m11409isModeratorimpl(newRole)) || (oldRole != null && StageRoles.m11410isSpeakerimpl(oldRole.m11412unboximpl()) && !StageRoles.m11410isSpeakerimpl(newRole))) {
            m11389handleUserLeftStageOrLostRolesGM3QuyE(channel, userId, oldRole.m11412unboximpl(), newRole);
        }
        if (userId == this.userStore.getMeSnapshot().getId()) {
            if (oldRole != null && !StageRoles.m11408isInvitedToSpeakimpl(oldRole.m11412unboximpl()) && StageRoles.m11408isInvitedToSpeakimpl(newRole)) {
    ...
    private final Sequence<Long> stageChannelIdsInGuildForDispatch(long guildId) {
        ...
        return (channelsForGuildInternal$app_productionGoogleRelease == null || (collectionValues = channelsForGuildInternal$app_productionGoogleRelease.values()) == null || (sequenceAsSequence = _Collections.asSequence(collectionValues)) == null || (sequenceMapNotNull = _Sequences2.mapNotNull(sequenceAsSequence, C64191.INSTANCE)) == null) ? C12075n.emptySequence() : sequenceMapNotNull;
    }
    ...
    public final int getOtherModeratorsCountInChannel(Channel channel, long myId) {
        StageEventActivationState stageEventActivationState;
        Intrinsics3.checkNotNullParameter(channel, "channel");
        Map map = (Map) outline.m843c(channel, this.stageEventStates);
        if (map == null || (stageEventActivationState = (StageEventActivationState) outline.m845d(channel, map)) == null) {
            return 0;
        }
    ...
    public final Map<Long, StageChannel> getStageChannelsInGuild(long guildId, Map<Long, Channel> channelsInGuild, long myId, Map<Long, ? extends User> users, Map<Long, VoiceState> voiceStates) {
        ...
        for (Object obj : collectionValues) {
            if (ChannelUtils.m7669D((Channel) obj)) {
                arrayList.add(obj);
            }
        }
        int i = 10;
        ...
        while (it.hasNext()) {
            ...
            Map mapEmptyMap = (Map) outline.m845d(channel, storeStageChannels.stageRolesByChannelSnapshot);
            if (mapEmptyMap == null) {
                mapEmptyMap = Maps6.emptyMap();
            }
            ...
            for (Object obj2 : arrayList3) {
                StageRoles stageRolesM11394getUserRolesuOBN1zc = storeStageChannels.m11394getUserRolesuOBN1zc(((User) obj2).getId(), channel.getId());
                if (stageRolesM11394getUserRolesuOBN1zc != null && StageRoles.m11410isSpeakerimpl(stageRolesM11394getUserRolesuOBN1zc.m11412unboximpl())) {
                    arrayList4.add(obj2);
                }
            }
            ...
            Long l = (Long) outline.m845d(channel, storeStageChannels.permissionsStore.getPermissionsByChannel());
            ...
            for (User user2 : arrayList6) {
                arrayList7.add(new UserGuildMember(user2, map2 != null ? (GuildMember) outline.m849f(user2, map2) : null));
            }
            ArrayList arrayList8 = arrayList2;
            Iterator it4 = it;
            StageRoles stageRolesM11392getMyRolesvisDeB4 = storeStageChannels.m11392getMyRolesvisDeB4(channel.getId());
            ...
            arrayList8.add(new StageChannel(channel, arrayList3, stageRolesM11392getMyRolesvisDeB4, set, arrayList7, size, stageInstanceForChannel, z2, channelId != null && channelId.longValue() == channel.getId(), null));
            i = 10;
            map = users;
        ...
        if (user == null || !user.getIsBot()) {
            ...
            while (it.hasNext()) {
                ...
                if (map != null && (stageRoles = map.get(Long.valueOf(member.getUser().getId()))) != null) {
                    int iM11412unboximpl = stageRoles.m11412unboximpl();
                    Channel channel = this.channelsStore.getChannelsByIdInternal$app_productionGoogleRelease().get(Long.valueOf(jLongValue));
                    if (channel != null) {
                        int iM11387computeUserRolesInDispatcht27eFtU$default = m11387computeUserRolesInDispatcht27eFtU$default(this, member.getUser().getId(), channel, null, null, 12, null);
                        if (!StageRoles.m11405equalsimpl0(iM11387computeUserRolesInDispatcht27eFtU$default, iM11412unboximpl)) {
                            map.put(Long.valueOf(member.getUser().getId()), StageRoles.m11402boximpl(iM11387computeUserRolesInDispatcht27eFtU$default));
                            m11391handleUserRoleChangeuOJZ9lM(channel, member.getUser().getId(), StageRoles.m11402boximpl(iM11412unboximpl), iM11387computeUserRolesInDispatcht27eFtU$default);
        ...
        if (user == null || !user.getIsBot()) {
            ...
            while (it.hasNext()) {
                ...
                if (map != null && (stageRoles = map.get(Long.valueOf(userId))) != null && (channel = this.channelsStore.getChannelsByIdInternal$app_productionGoogleRelease().get(Long.valueOf(jLongValue))) != null) {
                    m11390handleUserLeftStageOrLostRolesGM3QuyE$default(this, channel, userId, stageRoles.m11412unboximpl(), 0, 8, null);
                    this.dirtyChannelIds.add(Long.valueOf(jLongValue));
                    markChanged();
                }
            }
    ...
    */
    public final void handleVoiceStatesUpdated(long guildId, long fromChannelId, long userId) {
        ...
        if (channelInternal$app_productionGoogleRelease2 != null && ChannelUtils.m7669D(channelInternal$app_productionGoogleRelease2) && (voiceState == null || (channelId = voiceState.getChannelId()) == null || channelId.longValue() != fromChannelId)) {
            ...
            if (stageRolesRemove != null) {
                z2 = true;
                m11390handleUserLeftStageOrLostRolesGM3QuyE$default(this, channelInternal$app_productionGoogleRelease2, userId, stageRolesRemove.m11412unboximpl(), 0, 8, null);
        ...
        if (voiceState == null || channelInternal$app_productionGoogleRelease == null || ChannelUtils.m7669D(channelInternal$app_productionGoogleRelease) != z2) {
            return;
        }
        ...
        int iM11387computeUserRolesInDispatcht27eFtU$default = m11387computeUserRolesInDispatcht27eFtU$default(this, userId, channelInternal$app_productionGoogleRelease, map, null, 8, null);
        if (StageRoles.m11404equalsimpl(iM11387computeUserRolesInDispatcht27eFtU$default, stageRoles) ^ z2) {
            m11391handleUserRoleChangeuOJZ9lM(channelInternal$app_productionGoogleRelease, userId, stageRoles, iM11387computeUserRolesInDispatcht27eFtU$default);
            map3.put(Long.valueOf(userId), StageRoles.m11402boximpl(iM11387computeUserRolesInDispatcht27eFtU$default));
            this.dirtyChannelIds.add(Long.valueOf(jLongValue));
            markChanged();
        }
    }
    ...
    public final Observable<Map<Long, StageChannel>> observeGuildStageChannels(long guildId) {
        Observable<Map<Long, StageChannel>> observableM11112r = ObservationDeck.connectRx$default(this.observationDeck, new ObservationDeck.UpdateSource[]{this, this.channelsStore, this.userStore, this.voiceStatesStore, this.stageInstancesStore}, false, null, null, new C64111(guildId), 14, null).m11112r();
    ...
    public final Observable<StageRequestToSpeakState> observeMyRequestToSpeakState(long channelId) {
        return ObservationDeck.connectRx$default(this.observationDeck, new ObservationDeck.UpdateSource[]{this, this.channelsStore, this.guildsStore, this.userStore, this.voiceStatesStore}, false, null, null, new C64121(channelId), 14, null);
    }

    public final Observable<StageRoles> observeMyRoles(long channelId) {
        return ObservationDeck.connectRx$default(this.observationDeck, new ObservationDeck.UpdateSource[]{this, this.channelsStore}, false, null, null, new C64131(channelId), 14, null);
    }

    public final Observable<Map<Long, Map<Long, StageRoles>>> observeRoles() {
        return ObservationDeck.connectRx$default(this.observationDeck, new ObservationDeck.UpdateSource[]{this}, false, null, null, new C64141(), 14, null);
    }

    public final Observable<Map<Long, StageChannel>> observeStageChannels() {
        Observable<Map<Long, StageChannel>> observableM11112r = ObservationDeck.connectRx$default(this.observationDeck, new ObservationDeck.UpdateSource[]{this, this.channelsStore, this.guildsStore, this.userStore, this.voiceStatesStore, this.stageInstancesStore}, false, null, null, new C64151(), 14, null).m11112r();
        Intrinsics3.checkNotNullExpressionValue(observableM11112r, "observationDeck.connectR… }.distinctUntilChanged()");
        return observableM11112r;
    }

    public final Observable<Map<Long, StageRoles>> observeStageRolesByChannel(long channelId) {
        return ObservationDeck.connectRx$default(this.observationDeck, new ObservationDeck.UpdateSource[]{this}, false, null, null, new C64161(channelId), 14, null);
    }

    public final Observable<StageRequestToSpeakState> observeUserRequestToSpeakState(long userId, long channelId) {
        return ObservationDeck.connectRx$default(this.observationDeck, new ObservationDeck.UpdateSource[]{this, this.channelsStore, this.guildsStore, this.voiceStatesStore}, false, null, null, new C64171(channelId, userId), 14, null);
    }

    public final Observable<StageRoles> observeUserRoles(long userId, long channelId) {
        return ObservationDeck.connectRx$default(this.observationDeck, new ObservationDeck.UpdateSource[]{this, this.channelsStore}, false, null, null, new C64181(channelId, userId), 14, null);
    }
