...
public final class StoreVoiceChannelSelected extends StoreV2 implements Store2 {
    ...
    private final VoiceChannelJoinabilityUtils2 getJoinability(long channelId) {
        ...
        Map mapEmptyMap = (Map) outline.m843c(channelFindChannelByIdInternal$app_productionGoogleRelease, voiceStates.get());
        if (mapEmptyMap == null) {
            mapEmptyMap = Maps6.emptyMap();
        }
        Long l = permissions.getPermissionsByChannel().get(Long.valueOf(channelId));
        Guild guild = (Guild) outline.m843c(channelFindChannelByIdInternal$app_productionGoogleRelease, guilds.getGuilds());
    ...
    private final GuildVerificationLevel getVerificationLevelTriggered(Guild guild) {
        ...
        Map map = (Map) outline.m847e(guild, guilds.getMembers());
        ...
        Long l = (Long) outline.m847e(guild, guilds.getGuildsJoinedAt());
    ...
    public final Observable<JoinVoiceChannelResult> selectVoiceChannel(long channelId) {
        ...
        Intrinsics3.checkNotNullExpressionValue(publishSubjectM11133k0, "resultSubject");
