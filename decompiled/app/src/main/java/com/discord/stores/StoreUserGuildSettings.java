...
public final class StoreUserGuildSettings extends StoreV2 {
    ...
    public static abstract class Event {
        ...
        public static final /* data */ class SettingsUpdated extends Event {
            ...
            public String toString() {
                StringBuilder sbM833U = outline.m833U("SettingsUpdated(type=");
    ...
    public static final class C65761 extends Lambda implements Function0<Unit> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C65761(long j, Context context, boolean z2, ModelMuteConfig modelMuteConfig) {
            super(0);
            this.$channelId = j;
        ...
        public final void invoke2() {
            ...
            if (channelFindChannelByIdInternal$app_productionGoogleRelease != null) {
                ...
                if (!ChannelUtils.m7673H(channelFindChannelByIdInternal$app_productionGoogleRelease)) {
    ...
    public static final class C65771 extends Lambda implements Function0<Unit> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C65771(boolean z2, long j) {
            super(0);
    ...
    public static final class C65781 extends Lambda implements Function1<ThreadMember, Unit> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C65781(long j, long j2, int i) {
            super(1);
            this.$channelId = j;
        ...
        public final void invoke2(ThreadMember threadMember) {
            ...
            publishSubjectAccess$getEventSubject$p.f27650k.onNext(new Event.SettingsUpdated(SettingsUpdateType.THREAD));
        }
    }
    ...
    public static final class C65791 extends Lambda implements Function1<ModelNotificationSettings, Unit> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C65791(Long l, SettingsUpdateType settingsUpdateType) {
            super(1);
            this.$channelId = l;
        ...
        public final void invoke2(ModelNotificationSettings modelNotificationSettings) {
            ...
            PublishSubject publishSubjectAccess$getEventSubject$p = StoreUserGuildSettings.access$getEventSubject$p(StoreUserGuildSettings.this);
            publishSubjectAccess$getEventSubject$p.f27650k.onNext(new Event.SettingsUpdated(this.$settingsUpdateType));
        }
    }
    ...
    private final SettingsUpdateType getSettingsUpdateType(Channel channel) {
        return ChannelUtils.m7673H(channel) ? SettingsUpdateType.THREAD : ChannelUtils.m7671F(channel) ? SettingsUpdateType.CHANNEL : SettingsUpdateType.CATEGORY;
    }
    ...
    private final void handleGuildSettings(List<? extends ModelNotificationSettings> guildSettingsList) {
        ...
        if (jMin < RecyclerView.FOREVER_NS) {
            Observable<Long> observableM11070e0 = Observable.m11070e0(jMin - this.clock.currentTimeMillis(), TimeUnit.MILLISECONDS, this.dispatcher.getScheduler());
            Intrinsics3.checkNotNullExpressionValue(observableM11070e0, "Observable.timer(\n      …patcher.scheduler\n      )");
            ObservableExtensionsKt.appSubscribe$default(observableM11070e0, StoreUserGuildSettings.class, (Context) null, new C65691(), (Function1) null, (Function0) null, (Function0) null, new C65702(), 58, (Object) null);
        }
    }
    ...
    private final void updateThreadMemberSettings(Context context, long channelId, long parentChannelId, RestAPIParams.ThreadMemberSettings threadMemberSettings, int oldFlags) {
        ObservableExtensionsKt.appSubscribe$default(ObservableExtensionsKt.m8518ui(ObservableExtensionsKt.restSubscribeOn$default(this.restApi.updateThreadMemberSettings(channelId, threadMemberSettings), false, 1, null)), StoreUserGuildSettings.class, context, (Function1) null, (Function1) null, (Function0) null, (Function0) null, new C65781(channelId, parentChannelId, oldFlags), 60, (Object) null);
    }
    ...
    private final void updateUserGuildSettings(Context context, long guildId, RestAPIParams.UserGuildSettings userGuildSettings, SettingsUpdateType settingsUpdateType) {
        ...
        ObservableExtensionsKt.appSubscribe$default(ObservableExtensionsKt.m8518ui(ObservableExtensionsKt.restSubscribeOn$default(this.restApi.updateUserGuildSettings(guildId, userGuildSettings), false, 1, null)), StoreUserGuildSettings.class, context, (Function1) null, (Function1) null, (Function0) null, (Function0) null, new C65791((channelOverrides == null || (setKeySet = channelOverrides.keySet()) == null) ? null : (Long) _Collections.firstOrNull(setKeySet), settingsUpdateType), 60, (Object) null);
    }
    ...
    public final Observable<Map<Long, ModelNotificationSettings>> observeGuildSettings() {
        return ObservationDeck.connectRx$default(this.observationDeck, new ObservationDeck.UpdateSource[]{this}, false, null, null, new C65711(), 14, null);
    }

    public final Observable<Boolean> observeHideMutedChannels(long guildId) {
        Observable<Boolean> observableM11112r = ObservationDeck.connectRx$default(this.observationDeck, new ObservationDeck.UpdateSource[]{this}, false, null, null, new C65731(), 14, null).m11083G(new C65742(guildId)).m11112r();
    ...
    public final Observable<List<Long>> observeMutedGuildIds() {
        Observable<List<Long>> observableM11112r = observeGuildSettings().m11083G(C65751.INSTANCE).m11112r();
        Intrinsics3.checkNotNullExpressionValue(observableM11112r, "observeGuildSettings()\n …  .distinctUntilChanged()");
        return observableM11112r;
    }
    ...
    public final void setChannelMuted(Context context, long channelId, boolean muted, ModelMuteConfig muteConfig) {
        Intrinsics3.checkNotNullParameter(context, "context");
        this.dispatcher.schedule(new C65761(channelId, context, muted, muteConfig));
    }

    public final void setChannelNotificationFlags(Context context, Channel channel, int flags) {
        Intrinsics3.checkNotNullParameter(context, "context");
        Intrinsics3.checkNotNullParameter(channel, "channel");
        if (ChannelUtils.m7693q(channel) && ForumUtils.canAccessRedesignedForumChannels$default(ForumUtils.INSTANCE, channel.getGuildId(), null, 2, null)) {
    ...
    public final void setHideMutedChannels(long guildId, boolean hideChannels) {
        this.dispatcher.schedule(new C65771(hideChannels, guildId));
    }
    ...
    public final Observable<ModelNotificationSettings> observeGuildSettings(long guildId) {
        Observable<ModelNotificationSettings> observableM11112r = observeGuildSettings().m11083G(new C65722(guildId)).m11112r();
        Intrinsics3.checkNotNullExpressionValue(observableM11112r, "observeGuildSettings()\n …  .distinctUntilChanged()");
        return observableM11112r;
    }
