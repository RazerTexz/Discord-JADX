...
public final class VoiceConfigurationCache {
    ...
    public static final class AnonymousClass1 extends o implements Function2<String, String, Pair<? extends Long, ? extends Boolean>> {
    ...
    public static final class AnonymousClass2 extends o implements Function2<String, String, Pair<? extends Long, ? extends Float>> {
