...
/* JADX INFO: renamed from: com.discord.stores.StoreGuilds$Actions$requestMembers$3, reason: use source file name */
...
public final class StoreGuilds4<T, R> implements Func1<String, Observable<? extends Long>> {
    ...
    /* JADX INFO: renamed from: com.discord.stores.StoreGuilds$Actions$requestMembers$3$1 */
    /* JADX INFO: compiled from: StoreGuilds.kt */
