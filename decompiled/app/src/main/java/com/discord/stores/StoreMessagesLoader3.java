...
public final class StoreMessagesLoader3 extends Lambda implements Function1<List<? extends Message>, Unit> {
    ...
    public StoreMessagesLoader3(boolean z2, boolean z3, StoreMessagesLoader storeMessagesLoader, StoreMessagesLoader.ChannelLoadedState channelLoadedState, long j, StoreMessagesLoader.C62694 c62694) {
        super(1);
