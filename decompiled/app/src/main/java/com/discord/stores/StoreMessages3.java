...
public final class StoreMessages3 extends Lambda implements Function1<Emitter<MessageQueue4>, MessageQueue3.Send> {
    ...
    public static final class C62451 extends Lambda implements Function2<MessageQueue4, Boolean, Unit> {
        ...
        public static final class AnonymousClass1 extends Lambda implements Function0<Unit> {
            ...
            public AnonymousClass1(boolean z2, MessageQueue4 messageQueue4) {
                super(0);
        ...
        public final void invoke(MessageQueue4 messageQueue4, boolean z2) {
            ...
            StoreMessages.access$getDispatcher$p(StoreMessages3.this.this$0).schedule(new AnonymousClass1(z2, messageQueue4));
        }
    }
    ...
    public final MessageQueue3.Send invoke2(Emitter<MessageQueue4> emitter) {
        ...
        return new MessageQueue3.Send(message, this.$activity, list, new C62451(emitter), new C62462(), new C62473(), this.$attemptTimestamp);
    }
}
