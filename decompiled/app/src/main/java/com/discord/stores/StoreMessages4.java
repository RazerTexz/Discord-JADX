...
public final class StoreMessages4 extends Lambda implements Function1<Emitter<MessageQueue4>, MessageQueue3.SendApplicationCommand> {
    ...
    /* compiled from: StoreMessages.kt */
    /* renamed from: com.discord.stores.StoreMessages$sendMessage$createRequest$2$1 */
    public static final class C62481 extends Lambda implements Function2<MessageQueue4, Boolean, Unit> {
        ...
        public final void invoke(MessageQueue4 messageQueue4, boolean z2) {
            ...
            if (z2) {
                StoreMessages.access$getDispatcher$p(StoreMessages4.this.this$0).schedule(new AnonymousClass1());
            }
        }
    }

    /* compiled from: StoreMessages.kt */
    /* renamed from: com.discord.stores.StoreMessages$sendMessage$createRequest$2$2 */
    public static final class C62492 extends Lambda implements Function1<SendUtils.SendPayload.Preprocessing, Unit> {
    ...
    /* compiled from: StoreMessages.kt */
    /* renamed from: com.discord.stores.StoreMessages$sendMessage$createRequest$2$3 */
    public static final class C62503 extends Lambda implements Function1<List<? extends SendUtils.FileUpload>, Unit> {
    ...
    public final MessageQueue3.SendApplicationCommand invoke2(Emitter<MessageQueue4> emitter) {
        ...
        return new MessageQueue3.SendApplicationCommand(messageSynthesizeApiMessage, applicationCommandLocalSendData, this.$attachments, new C62492(), new C62503(), new C62481(emitter), timestamp != null ? timestamp.getDateTimeMillis() : 0L);
    }
}
