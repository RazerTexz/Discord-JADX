...
public final /* data */ class TrackTextAreaCtaClicked implements AnalyticsSchema, TrackBaseReceiver, TrackGuildReceiver, TrackChannelReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackTextAreaCtaClicked) && m.areEqual(this.ctaType, ((TrackTextAreaCtaClicked) other).ctaType);
        }
        return true;
    }
    ...
    public String toString() {
        return a.E(a.U("TrackTextAreaCtaClicked(ctaType="), this.ctaType, ")");
    }
}
