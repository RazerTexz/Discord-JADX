...
public final /* data */ class TrackGuildMembershipGateSettingsUpdated implements AnalyticsSchema, TrackBaseReceiver, TrackGuildReceiver, TrackGuildMembershipGateMetadataReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackGuildMembershipGateSettingsUpdated) && m.areEqual(this.isEnabled, ((TrackGuildMembershipGateSettingsUpdated) other).isEnabled);
        }
        return true;
    }
    ...
    public String toString() {
        return a.D(a.U("TrackGuildMembershipGateSettingsUpdated(isEnabled="), this.isEnabled, ")");
    }
}
