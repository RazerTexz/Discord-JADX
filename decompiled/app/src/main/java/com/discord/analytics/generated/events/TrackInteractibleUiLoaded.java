...
public final /* data */ class TrackInteractibleUiLoaded implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        ...
        return m.areEqual(this.loadId, trackInteractibleUiLoaded.loadId) && m.areEqual(this.type, trackInteractibleUiLoaded.type);
    }
    ...
    public String toString() {
        StringBuilder sbU = a.U("TrackInteractibleUiLoaded(loadId=");
