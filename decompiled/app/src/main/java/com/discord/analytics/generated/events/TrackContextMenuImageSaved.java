...
public final /* data */ class TrackContextMenuImageSaved implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public String toString() {
        StringBuilder sbU = a.U("TrackContextMenuImageSaved(channelId=");
