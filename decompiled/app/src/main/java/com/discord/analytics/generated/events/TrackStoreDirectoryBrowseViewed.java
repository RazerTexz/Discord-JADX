...
public final /* data */ class TrackStoreDirectoryBrowseViewed implements AnalyticsSchema, TrackBaseReceiver, TrackSourceMetadataReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackStoreDirectoryBrowseViewed) && m.areEqual(this.loadId, ((TrackStoreDirectoryBrowseViewed) other).loadId);
        }
        return true;
    }
    ...
    public String toString() {
        return a.E(a.U("TrackStoreDirectoryBrowseViewed(loadId="), this.loadId, ")");
    }
}
