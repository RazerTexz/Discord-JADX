...
public final /* data */ class TrackAppFirstLogin implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackAppFirstLogin) && m.areEqual(this.platform, ((TrackAppFirstLogin) other).platform);
        }
        return true;
    }
    ...
    public String toString() {
        return a.E(a.U("TrackAppFirstLogin(platform="), this.platform, ")");
    }
}
