...
public final /* data */ class TrackRoleSubscriptionListingPublishedV3 implements AnalyticsSchema, TrackBaseReceiver, TrackGuildReceiver {
    ...
    public String toString() {
        StringBuilder sbU = a.U("TrackRoleSubscriptionListingPublishedV3(roleSubscriptionListingId=");
