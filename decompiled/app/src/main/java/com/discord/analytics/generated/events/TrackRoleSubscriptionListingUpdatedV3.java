...
public final /* data */ class TrackRoleSubscriptionListingUpdatedV3 implements AnalyticsSchema, TrackBaseReceiver, TrackGuildReceiver {
    ...
    public String toString() {
        StringBuilder sbU = a.U("TrackRoleSubscriptionListingUpdatedV3(roleSubscriptionListingId=");
