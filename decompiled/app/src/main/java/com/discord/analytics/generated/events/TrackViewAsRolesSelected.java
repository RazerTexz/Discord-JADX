...
public final /* data */ class TrackViewAsRolesSelected implements AnalyticsSchema, TrackBaseReceiver, TrackGuildReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackViewAsRolesSelected) && m.areEqual(this.numRoles, ((TrackViewAsRolesSelected) other).numRoles);
        }
        return true;
    }
    ...
    public String toString() {
        return a.G(a.U("TrackViewAsRolesSelected(numRoles="), this.numRoles, ")");
    }
}
