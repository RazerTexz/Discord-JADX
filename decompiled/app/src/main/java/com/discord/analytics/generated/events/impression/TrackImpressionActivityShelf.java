...
public final /* data */ class TrackImpressionActivityShelf implements AnalyticsSchema, TrackBaseReceiver, TrackGuildReceiver, TrackChannelReceiver, TrackLocationMetadataReceiver, TrackImpressionMetadataReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackImpressionActivityShelf) && m.areEqual(this.sourceSection, ((TrackImpressionActivityShelf) other).sourceSection);
        }
        return true;
    }
    ...
    public String toString() {
        return a.E(a.U("TrackImpressionActivityShelf(sourceSection="), this.sourceSection, ")");
    }
}
