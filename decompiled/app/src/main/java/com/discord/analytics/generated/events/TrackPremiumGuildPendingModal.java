...
public final /* data */ class TrackPremiumGuildPendingModal implements AnalyticsSchema, TrackBaseReceiver {
    ...
    public boolean equals(Object other) {
        if (this != other) {
            return (other instanceof TrackPremiumGuildPendingModal) && m.areEqual(this.guildId, ((TrackPremiumGuildPendingModal) other).guildId);
        }
        return true;
    }
    ...
    public String toString() {
        return a.G(a.U("TrackPremiumGuildPendingModal(guildId="), this.guildId, ")");
    }
}
