...
public final /* data */ class TrackGameNewsViewed implements AnalyticsSchema, TrackBaseReceiver, TrackAfCardReceiver, TrackAfGameReceiver {
    ...
    public boolean equals(Object other) {
        ...
        return m.areEqual(this.newsUrl, trackGameNewsViewed.newsUrl) && m.areEqual(this.newsIndex, trackGameNewsViewed.newsIndex);
    }
    ...
    public String toString() {
        StringBuilder sbU = a.U("TrackGameNewsViewed(newsUrl=");
