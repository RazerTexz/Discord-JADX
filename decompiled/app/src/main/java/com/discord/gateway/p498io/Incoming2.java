...
public final class Incoming2 implements Model {
    ...
    public static final class C55201<T> implements Model.JsonReader.ItemFactory<Presence> {
        ...
        public C55201(Model.JsonReader jsonReader) {
    ...
    public static final class C55212<T> implements Model.JsonReader.ItemFactory<ModelSession> {
        ...
        public C55212(Model.JsonReader jsonReader) {
            this.$reader = jsonReader;
        }
                    ...
                    switch (str.hashCode()) {
                        ...
                        case -2026522382:
                            if (str.equals("SESSIONS_REPLACE")) {
                                this.data = reader.nextList(new C55212(reader));
                            }
                            break;
                        case -2002723137:
                        ...
                        case 77848963:
                            if (str.equals("READY")) {
                                ...
                                StringBuilder sbM833U = outline.m833U("Ready payload deserialized in ");
                                sbM833U.append(ClockFactory.get().currentTimeMillis() - jCurrentTimeMillis);
                                sbM833U.append(" ms.");
                                function1.invoke(sbM833U.toString());
                            }
                            break;
                        case 85547718:
                        ...
                        case 1689894925:
                            if (str.equals("PRESENCES_REPLACE")) {
                                this.data = reader.nextList(new C55201(reader));
                            }
                            break;
                        case 1699412580:
