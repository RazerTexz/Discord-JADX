...
public final /* data */ class ModelSku {
    ...
    public static final /* data */ class ModelPremiumSkuPrice {
        ...
        public String toString() {
            StringBuilder sbM833U = outline.m833U("ModelPremiumSkuPrice(amount=");
            sbM833U.append(this.amount);
            sbM833U.append(", percentage=");
            return outline.m814B(sbM833U, this.percentage, ")");
        }
    }
    ...
    public static final class Parser implements Model.Parser<ModelSku> {
        ...
        public ModelSku parse(Model.JsonReader reader) throws IOException {
            ...
            reader.nextObject(new ModelSku2(ref$ObjectRefM844c0, reader, ref$ObjectRef, ref$ObjectRef2, ref$ObjectRef3, ref$ObjectRef4, ref$ObjectRef5, ref$ObjectRef6, ref$ObjectRef7));
    ...
    public static final /* data */ class Price {
        ...
        public static final class Parser implements Model.Parser<Price> {
            ...
            public Price parse(Model.JsonReader reader) throws IOException {
                ...
                Ref$ObjectRef ref$ObjectRef = new Ref$ObjectRef();
                ref$ObjectRef.element = null;
                reader.nextObject(new ModelSku3(ref$ObjectRefM844c0, reader, ref$ObjectRef));
        ...
        public String toString() {
            StringBuilder sbM833U = outline.m833U("Price(amount=");
            sbM833U.append(this.amount);
            sbM833U.append(", currency=");
            sbM833U.append(this.currency);
            sbM833U.append(", premium=");
            return outline.m825M(sbM833U, this.premium, ")");
        }
    ...
    public String toString() {
        StringBuilder sbM833U = outline.m833U("ModelSku(applicationId=");
        ...
        return outline.m825M(sbM833U, this.externalSkuStrategies, ")");
    }
}
