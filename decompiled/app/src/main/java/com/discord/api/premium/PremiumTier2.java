...
public final class PremiumTier2 extends TypeAdapter<PremiumTier> {
    ...
    public PremiumTier read(JsonReader jsonReader) throws IOException {
        ...
        return (numM549n1 != null && numM549n1.intValue() == 0) ? PremiumTier.PREMIUM_GUILD_SUBSCRIPTION_ONLY : (numM549n1 != null && numM549n1.intValue() == 1) ? PremiumTier.TIER_1 : (numM549n1 != null && numM549n1.intValue() == 2) ? PremiumTier.TIER_2 : (numM549n1 != null && numM549n1.intValue() == 3) ? PremiumTier.TIER_0 : PremiumTier.NONE;
    }
