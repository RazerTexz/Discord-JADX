...
public final class ButtonComponent3 extends TypeAdapter<ButtonComponent2> {
    ...
    public ButtonComponent2 read(JsonReader jsonReader) throws IOException {
        ...
        return (numM549n1 != null && numM549n1.intValue() == 1) ? ButtonComponent2.PRIMARY : (numM549n1 != null && numM549n1.intValue() == 2) ? ButtonComponent2.SECONDARY : (numM549n1 != null && numM549n1.intValue() == 3) ? ButtonComponent2.SUCCESS : (numM549n1 != null && numM549n1.intValue() == 4) ? ButtonComponent2.DANGER : (numM549n1 != null && numM549n1.intValue() == 5) ? ButtonComponent2.LINK : ButtonComponent2.UNKNOWN;
    }
