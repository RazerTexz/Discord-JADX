    ...
    */
    public ListenableWorker.Result doWork() {
        ...
        try {
            ...
            ModelNotificationSettings modelNotificationSettings = (ModelNotificationSettings) new BlockingObservable(observableUpdateUserGuildSettings).m10860b();
            ...
            try {
                ...
                try {
                    ...
                    appLog2.mo8369w(simpleName4, "Mute failure: " + j2 + '-' + j + " until " + str, th);
                ...
                j = j4;
                j2 = j3;
                AppLog appLog22 = AppLog.f14950g;
                ...
                appLog22.mo8369w(simpleName42, "Mute failure: " + j2 + '-' + j + " until " + str, th);
