...
public final class ActivityUtils {
    ...
    public static final Activity createStageChannelListeningActivity() {
        ...
        if (stageInstanceForChannelInternal != null && (guild = companion.getGuilds().getGuild(channel.getGuildId())) != null) {
            ...
            return new Activity(stageInstanceForChannelInternal.getTopic(), ActivityType.LISTENING, null, ClockFactory.get().currentTimeMillis(), new ActivityTimestamps(strValueOf, null), Long.valueOf(STAGE_PRESENCE_APPLICATION_ID), null, null, null, new ActivityParty(strM11398packStageChannelPartyIdhLOU_GE, Collections2.listOf((Object[]) new Long[]{Long.valueOf(size), Long.valueOf(size2)})), new ActivityAssets(null, null, guild.getIcon(), guild.getName()), null, null, null, null, null, null, null);
        }
        return null;
    }
    ...
    private static final String m11398packStageChannelPartyIdhLOU_GE(Channel channel, Guild guild, StageRoles stageRoles, StageInstance stageInstance) {
        ...
        StringBuilder sbM833U = outline.m833U(STAGE_PRESENCE_PARTY_PREFIX);
    ...
    private static final ActivityUtils2 unpackStageChannelParty(Activity activity) {
        ...
        try {
            ...
            Tuples2 tuples2M10073to = (!(listM7559b == null || listM7559b.isEmpty()) && listM7559b.size() == 2) ? Tuples.m10073to(listM7559b.get(0), listM7559b.get(1)) : Tuples.m10073to(0L, 0L);
            long jLongValue = ((Number) tuples2M10073to.component1()).longValue();
            long jCoerceAtLeast = _Ranges.coerceAtLeast(0L, ((Number) tuples2M10073to.component2()).longValue() - jLongValue);
