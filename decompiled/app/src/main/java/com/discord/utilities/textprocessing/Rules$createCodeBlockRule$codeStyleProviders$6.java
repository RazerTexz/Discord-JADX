...
public final class Rules$createCodeBlockRule$codeStyleProviders$6<RC> implements StyleNode.InterfaceC5656a<RC> {
    public static final Rules$createCodeBlockRule$codeStyleProviders$6 INSTANCE = new Rules$createCodeBlockRule$codeStyleProviders$6();
    ...
    public final Iterable get(BasicRenderContext basicRenderContext) {
        ...
        return CollectionsJVM.listOf(new TextAppearanceSpan(basicRenderContext.getContext(), C5419R.style.Code_TextAppearance_Types));
    }
}
