...
public final class StreamContextService {
    ...
    public static final class C69302<T, R> implements Func1<Collection<? extends ModelApplicationStream>, Observable<? extends Map<Long, ? extends StreamContext>>> {
        ...
        public final Observable<? extends Map<Long, StreamContext>> call2(Collection<? extends ModelApplicationStream> collection) {
            ...
            return Observable.m11065b(arrayList, AnonymousClass1.INSTANCE);
        }
    }
    ...
    public static final class C69311<T, R> implements Func1<ModelApplicationStream, Observable<? extends StreamContext>> {
        ...
        public C69311(boolean z2, long j) {
    ...
    public final Observable<StreamContext> getForActiveStream() {
        Observable observableM11099Y = this.applicationStreamingStore.observeActiveStream().m11099Y(new C69281());
        Intrinsics3.checkNotNullExpressionValue(observableM11099Y, "applicationStreamingStor…  )\n          }\n        }");
        return observableM11099Y;
    }

    public final Observable<Map<Long, StreamContext>> getForAllStreamingUsers() {
        Observable<Map<Long, StreamContext>> observableM11099Y = this.applicationStreamingStore.observeStreamsByUser().m11083G(C69291.INSTANCE).m11099Y(new C69302());
        Intrinsics3.checkNotNullExpressionValue(observableM11099Y, "applicationStreamingStor…  }\n          }\n        }");
        return observableM11099Y;
    }

    public final Observable<StreamContext> getForUser(long userId, boolean includePreview) {
        Observable observableM11099Y = this.applicationStreamingStore.observeStreamsForUser(userId).m11099Y(new C69311(includePreview, userId));
        Intrinsics3.checkNotNullExpressionValue(observableM11099Y, "applicationStreamingStor…  }\n          }\n        }");
        return observableM11099Y;
    }
