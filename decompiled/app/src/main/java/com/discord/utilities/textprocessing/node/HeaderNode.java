...
public final class HeaderNode<T extends BasicRenderContext> extends Node<T> {
    ...
    public void render(SpannableStringBuilder builder, T renderContext) {
        ...
        int i2 = i != 1 ? i != 2 ? C5419R.dimen.markdown_messages_header_3_top_padding : C5419R.dimen.markdown_messages_header_2_top_padding : C5419R.dimen.markdown_messages_header_1_top_padding;
        int i3 = i != 1 ? i != 2 ? C5419R.dimen.markdown_messages_header_3_bottom_padding : C5419R.dimen.markdown_messages_header_2_bottom_padding : C5419R.dimen.markdown_messages_header_1_bottom_padding;
