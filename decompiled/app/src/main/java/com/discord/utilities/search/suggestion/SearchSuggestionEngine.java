...
public final class SearchSuggestionEngine {
    ...
    private final List<ChannelSuggestion> getChannelSuggestions(CharSequence rawContent, FilterType currentFilter, Map<Long, Channel> channels, Map<Long, Long> channelPermissions) {
        ...
        for (Object obj : collectionValues) {
            if (PermissionUtils.can(Permission.VIEW_CHANNEL, (Long) outline.m845d((Channel) obj, channelPermissions))) {
                arrayList.add(obj);
            }
        }
        ...
        List<Channel> listSortedWith = _Collections.sortedWith(arrayList2, ChannelUtils.m7684h(Channel.INSTANCE));
    ...
    private final void setupMemberRequestSubscription() {
        Observable<R> observableM11083G = membersRequestSubject.m11090P(750L, TimeUnit.MILLISECONDS).m11083G(C69101.INSTANCE);
        C69112 c69112 = C69112.INSTANCE;
        Object searchSuggestionEngine2 = c69112;
        if (c69112 != null) {
            searchSuggestionEngine2 = new SearchSuggestionEngine2(c69112);
        }
        Observable observableM11112r = observableM11083G.m11118y((Func1) searchSuggestionEngine2).m11112r();
        Intrinsics3.checkNotNullExpressionValue(observableM11112r, "membersRequestSubject\n  …  .distinctUntilChanged()");
        ObservableExtensionsKt.appSubscribe$default(observableM11112r, SearchSuggestionEngine.class, (Context) null, (Function1) null, (Function1) null, (Function0) null, (Function0) null, C69123.INSTANCE, 62, (Object) null);
    }
