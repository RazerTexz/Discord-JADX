...
public final class UserRequestManager {
    ...
    public final synchronized void requestUser(long userId) {
        ...
        Class<?> cls = getClass();
        C69841 c69841 = new C69841();
        ObservableExtensionsKt.appSubscribe$default(observableRestSubscribeOn$default, cls, (Context) null, new C69863(userId), (Function1) null, (Function0) null, new C69852(userId), c69841, 26, (Object) null);
    }
