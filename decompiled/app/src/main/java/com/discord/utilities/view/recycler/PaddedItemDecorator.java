...
public final class PaddedItemDecorator extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (i != 1) {
            throw new Standard2(outline.m883w("An operation is not implemented: ", outline.m814B(outline.m833U("Other("), this.orientation, ") orientation padding for items not supported yet.")));
        }
