...
public final class Backoff$TimerScheduler$schedule$1 extends TimerTask {
    ...
    public void run() {
        ...
        Function0 backoff$sam$java_lang_Runnable$0 = this.$action;
        if (backoff$sam$java_lang_Runnable$0 != null) {
            backoff$sam$java_lang_Runnable$0 = new Backoff$sam$java_lang_Runnable$0(backoff$sam$java_lang_Runnable$0);
        }
