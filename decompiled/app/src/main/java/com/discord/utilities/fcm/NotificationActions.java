...
public final class NotificationActions extends BroadcastReceiver {
    ...
    private final void enqueueAckMessage(Context context, Intent intent) throws Throwable {
        ...
        if (data != null) {
            ...
            Intrinsics3.checkNotNullParameter(context, "context");
            Data dataBuild = new Data.Builder().putAll(Maps6.mapOf(Tuples.m10073to("com.discord.intent.extra.EXTRA_CHANNEL_ID", Long.valueOf(jLongValue)), Tuples.m10073to("com.discord.intent.extra.EXTRA_MESSAGE_ID", Long.valueOf(jLongValue2)))).build();
    ...
    private final void enqueueDirectReply(Context context, Intent intent) throws Throwable {
        ...
        if (resultsFromIntent != null && (charSequence = resultsFromIntent.getCharSequence("discord_notif_text_input")) != null) {
            ...
            if (charSequence != null && (string = charSequence.toString()) != null) {
                ...
                tuples2Arr[0] = Tuples.m10073to("com.discord.intent.extra.EXTRA_CHANNEL_ID", Long.valueOf(jLongValue));
                tuples2Arr[1] = Tuples.m10073to("com.discord.intent.extra.EXTRA_CHANNEL_NAME", charSequenceExtra != null ? charSequenceExtra.toString() : null);
                tuples2Arr[2] = Tuples.m10073to("com.discord.intent.extra.EXTRA_MESSAGE_ID", null);
                tuples2Arr[3] = Tuples.m10073to("MESSAGE_CONTENT", string);
                tuples2Arr[4] = Tuples.m10073to("com.discord.intent.extra.EXTRA_STICKER_ID", null);
    ...
    private final void enqueueTimedMute(Context context, Intent intent) throws Throwable {
        ...
        if (data != null) {
            ...
            Intrinsics3.checkNotNullParameter(context, "context");
            Data dataBuild = new Data.Builder().putAll(Maps6.mapOf(Tuples.m10073to("com.discord.intent.extra.EXTRA_GUILD_ID", Long.valueOf(jLongValue)), Tuples.m10073to("com.discord.intent.extra.EXTRA_CHANNEL_ID", Long.valueOf(jLongValue2)), Tuples.m10073to("com.discord.intent.extra.EXTRA_UNTIL_TIMESTAMP_MS", Long.valueOf(jLongValue3)))).build();
            Intrinsics3.checkNotNullExpressionValue(dataBuild, "Data.Builder()\n         …     )\n          .build()");
    ...
    public final void enqueue(Context context, Intent intent) throws Throwable {
        ...
        if (data != null) {
            ...
            StringBuilder sbM833U = outline.m833U("Unknown work action ");
