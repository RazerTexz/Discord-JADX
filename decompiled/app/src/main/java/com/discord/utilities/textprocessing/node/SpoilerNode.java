...
public final class SpoilerNode<T extends RenderContext> extends Node<T> implements Spoilerable {
    ...
    private final List<Object> createStyles(T renderContext) {
        ...
        objArr[1] = spoilerOnClick != null ? new ClickableSpan(Integer.valueOf(ColorCompat.getColor(context, C5419R.color.transparent)), false, null, new SpoilerNode2(spoilerOnClick, this, context), 4, null) : null;
