...
public final class Rules$createCodeBlockRule$codeStyleProviders$8<RC> implements StyleNode.InterfaceC5656a<RC> {
    ...
    public final Iterable get(BasicRenderContext basicRenderContext) {
        ...
        return CollectionsJVM.listOf(new TextAppearanceSpan(basicRenderContext.getContext(), C5419R.style.Code_TextAppearance_Params));
    }
}
