...
public final class VoiceChannelJoinabilityUtils {
    ...
    public static final class C70481<T, R> implements Func1<Channel, Observable<? extends VoiceChannelJoinabilityUtils2>> {
        ...
        public C70481(StoreVoiceStates storeVoiceStates, long j, StorePermissions storePermissions, StoreGuilds storeGuilds, StoreVoiceChannelSelected storeVoiceChannelSelected, StoreStageInstances storeStageInstances) {
    ...
    public final VoiceChannelJoinabilityUtils2 computeJoinability(Channel channel, Collection<VoiceState> channelVoiceStates, Long channelPermissions, GuildMaxVideoChannelUsers guildMaxVideoChannelUsers, GuildVerificationLevel verificationLevelTriggered, Long selectedVoiceChannelId, StageInstance stageInstance) {
        ...
        if ((verificationLevelTriggered != GuildVerificationLevel.NONE) && (stageInstance == null || !AnimatableValueParser.m484W0(stageInstance))) {
            return VoiceChannelJoinabilityUtils2.PERMISSIONS_MISSING;
        }
    ...
    public final VoiceChannelJoinabilityUtils2 getJoinability(long channelId) {
        ...
        Map mapEmptyMap = (Map) outline.m843c(channel, companion.getVoiceStates().get());
        if (mapEmptyMap == null) {
    ...
    public final Observable<VoiceChannelJoinabilityUtils2> observeJoinability(long channelId, StoreChannels channelsStore, StoreGuilds guildsStore, StorePermissions permissionsStore, StoreVoiceStates voiceStatesStore, StoreVoiceChannelSelected voiceChannelSelectedStore, StoreStageInstances stageInstancesStore) {
        ...
        Observable observableM11099Y = channelsStore.observeChannel(channelId).m11099Y(new C70481(voiceStatesStore, channelId, permissionsStore, guildsStore, voiceChannelSelectedStore, stageInstancesStore));
        Intrinsics3.checkNotNullExpressionValue(observableM11099Y, "channelsStore\n        .o…  }\n          }\n        }");
