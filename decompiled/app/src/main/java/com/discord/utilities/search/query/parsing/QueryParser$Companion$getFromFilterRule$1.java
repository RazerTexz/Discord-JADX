...
public final class QueryParser$Companion$getFromFilterRule$1 extends Rule<Context, QueryNode, Object> {
    public final /* synthetic */ Pattern $fromFilterPattern;
    public final /* synthetic */ CharSequence $localizedFrom;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QueryParser$Companion$getFromFilterRule$1(CharSequence charSequence, Pattern pattern, Pattern pattern2) {
        super(pattern2);
