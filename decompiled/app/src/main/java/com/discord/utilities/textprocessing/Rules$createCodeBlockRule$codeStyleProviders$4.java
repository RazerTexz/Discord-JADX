...
public final class Rules$createCodeBlockRule$codeStyleProviders$4<RC> implements StyleNode.a<RC> {
    ...
    public final Iterable get(BasicRenderContext basicRenderContext) {
        ...
        return d0.t.m.listOf(new TextAppearanceSpan(basicRenderContext.getContext(), R.style.Code_TextAppearance_Keyword));
    }
}
