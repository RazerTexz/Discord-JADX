...
public final class FileType {
    ...
    static {
        ...
        m.checkNotNullExpressionValue(patternCompile4, "java.util.regex.Pattern.compile(this, flags)");
        FileType fileType4 = new FileType("SKETCH", 3, patternCompile4);
        SKETCH = fileType4;
        Pattern patternCompile5 = Pattern.compile("ai$", 0);
        m.checkNotNullExpressionValue(patternCompile5, "java.util.regex.Pattern.compile(this, flags)");
        FileType fileType5 = new FileType("AI", 4, patternCompile5);
        AI = fileType5;
        Pattern patternCompile6 = Pattern.compile("(?:rar|zip|7z|tar|tar\\.gz)$", 0);
        m.checkNotNullExpressionValue(patternCompile6, "java.util.regex.Pattern.compile(this, flags)");
        ...
        m.checkNotNullExpressionValue(patternCompile7, "java.util.regex.Pattern.compile(this, flags)");
        ...
        m.checkNotNullExpressionValue(patternCompile10, "java.util.regex.Pattern.compile(this, flags)");
    ...
    private FileType(String str, int i, Pattern pattern) {
        this.threadLocalMatcher = new FileType$threadLocalMatcher$1(pattern);
    }
